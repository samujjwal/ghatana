...
/**
 * Durable, JDBC-backed implementation of {@link BillingLedgerPlugin}.
 *
 ...
 * {@code transaction_id} unique constraint — duplicate posts are silently
 ...
 * {@link StandardBillingLedgerPlugin} instead.
 *
 * @doc.type class
 * @doc.purpose Durable JDBC-backed billing ledger plugin with idempotent posting
 * @doc.layer platform
 * @doc.pattern Plugin Implementation, Adapter
 * @since 1.1.0
 */
public final class DurableBillingLedgerPlugin implements BillingLedgerPlugin {

    private static final Logger LOG = LoggerFactory.getLogger(DurableBillingLedgerPlugin.class);
    ...
    /**
     * Creates a new durable billing ledger plugin backed by the given data source.
     *
     * @param dataSource the JDBC data source; must not be null
     */
    public DurableBillingLedgerPlugin(DataSource dataSource) {
    ...
    public void ensureSchema() {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            LOG.info("DurableBillingLedgerPlugin: schema ensured");
        } catch (SQLException e) {
            throw new IllegalStateException("Failed to initialise billing ledger schema", e);
        }
    }
    ...
    public Promise<Void> initialize(PluginContext context) {
        ...
        LOG.info("DurableBillingLedgerPlugin initialized");
    ...
    public Promise<Void> start() {
        ...
        LOG.info("DurableBillingLedgerPlugin started");
        return Promise.complete();
    }
    ...
    public Promise<Void> stop() {
        ...
        LOG.info("DurableBillingLedgerPlugin stopped");
        return Promise.complete();
    }
    ...
    public Promise<Void> shutdown() {
        ...
        LOG.info("DurableBillingLedgerPlugin shutdown");
        return Promise.complete();
    }

    // -------------------------------------------------------------------------
    // BillingLedgerPlugin operations
    // -------------------------------------------------------------------------
    ...
    public Promise<String> postTransaction(BillingTransaction transaction) {
        ...
        // Idempotency check — return existing entry ID if already posted

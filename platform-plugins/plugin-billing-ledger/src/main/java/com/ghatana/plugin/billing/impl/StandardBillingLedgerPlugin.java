...
/**
 * Standard implementation of BillingLedgerPlugin.
 *
 ...
 *
 * @doc.type class
 * @doc.purpose Standard billing ledger implementation
 * @doc.layer platform
 * @doc.pattern Plugin Implementation
 * @since 1.0.0
 */
public class StandardBillingLedgerPlugin implements BillingLedgerPlugin {

    private static final Logger LOG = LoggerFactory.getLogger(StandardBillingLedgerPlugin.class);
    ...
    public Promise<Void> initialize(PluginContext context) {
        ...
        LOG.info("BillingLedgerPlugin initialized");
    ...
    public Promise<Void> start() {
        ...
        LOG.info("BillingLedgerPlugin started");
        return Promise.complete();
    }
    ...
    public Promise<Void> stop() {
        ...
        LOG.info("BillingLedgerPlugin stopped");
        return Promise.complete();
    }
    ...
    public String toString() {
        return "StandardBillingLedgerPlugin{entries=" + entries.size() + ", accounts=" + accounts.size() + "}";
    }
}

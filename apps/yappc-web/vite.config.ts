...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: {
      ...
      '@capacitor/haptics': path.resolve(__dirname, '../../products/yappc/frontend/libs/mobile/capacitor-shims.ts'),
      '@capacitor/share': path.resolve(__dirname, '../../products/yappc/frontend/libs/mobile/capacitor-shims.ts'),
      '@capacitor/network': path.resolve(__dirname, '../../products/yappc/frontend/libs/mobile/capacitor-shims.ts'),
      '@capacitor/local-notifications': path.resolve(__dirname, '../../products/yappc/frontend/libs/mobile/capacitor-shims.ts'),
      '@capacitor/camera': path.resolve(__dirname, '../../products/yappc/frontend/libs/mobile/capacitor-shims.ts'),
      '@capacitor/filesystem': path.resolve(__dirname, '../../products/yappc/frontend/libs/mobile/capacitor-shims.ts'),
      '@capacitor/core': path.resolve(__dirname, '../../products/yappc/frontend/libs/mobile/capacitor-shims.ts'),

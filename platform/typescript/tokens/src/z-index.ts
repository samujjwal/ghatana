/**
 * Global Z-Index Tokens for Ghatana Platform
 *
 * Unified z-index layering system
 *
 * @migrated-from @ghatana/yappc-ui/tokens/zIndex
 */
 ...
 * ```
 */
export function getZIndex(layer: ZIndexKey): number {
  return zIndex[layer];
}
 ...
 * ```
 */
export function getRelativeZIndex(layer: ZIndexKey, offset: number): number {

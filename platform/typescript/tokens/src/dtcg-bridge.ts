...
const TypographySchema = z.object({
  ...
  fontWeight: z.record(z.string(), z.number()).passthrough(),
...
export const tokenRegistrySchema = z.object({
  ...
  borderRadius: z.record(z.string(), z.string().or(z.number())).passthrough(),
  borderWidth: z.record(z.string().or(z.number()), z.string().or(z.number())).passthrough(),
  componentRadius: z.record(z.string(), z.string().or(z.number())).passthrough(),
  shapeVariants: z.record(z.string(), z.unknown()),
  transitions: TransitionsSchema,
  zIndex: z.record(z.string(), z.number()).passthrough(),
  semanticZIndex: z.record(z.string(), z.number()).passthrough(),
  componentZIndex: z.record(z.string(), z.number()).passthrough(),

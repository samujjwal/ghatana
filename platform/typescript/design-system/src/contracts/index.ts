...
const BUTTON_CONTRACT: ComponentContract = {
  ...
  metadata: {
    ...
    status: 'stable',
    platforms: ['web'],
    a11y: { role: 'button', ariaSupported: true, ariaRequired: false, keyboardNavigation: true, trapsFocus: false, wcagCriteria: ['2.1.1', '2.4.6'], screenReader: 'supported' },
  },
  props: [
    ...
    { name: 'variant', type: 'enum', typeDetails: ['contained', 'outlined', 'text', 'destructive'],
      description: 'Visual style variant.', defaultValue: 'contained', required: false,
      builderMetadata: { control: 'select', category: 'style', order: 1, bindable: false } },
    { name: 'size', type: 'enum', typeDetails: ['sm', 'md', 'lg'],
      description: 'Button size.', defaultValue: 'md', required: false,
      builderMetadata: { control: 'select', category: 'style', order: 2, bindable: false } },
    { name: 'disabled', type: 'boolean', description: 'Disables the button.', defaultValue: false, required: false,
      builderMetadata: { control: 'toggle', category: 'state', order: 3, bindable: true } },
    { name: 'fullWidth', type: 'boolean', description: 'Stretches to fill its container.', defaultValue: false, required: false,
      builderMetadata: { control: 'toggle', category: 'layout', order: 4, bindable: false } },
    { name: 'loading', type: 'boolean', description: 'Shows a loading spinner.', defaultValue: false, required: false,
      builderMetadata: { control: 'toggle', category: 'state', order: 5, bindable: true } },
  ],
  slots: [
    { name: 'startIcon', description: 'Icon before the label.', isDefault: false, allowsReorder: false, isSingleChild: true,
      builderMetadata: { displayName: 'Start Icon', required: false, dropZoneMode: 'inline' } },
    { name: 'endIcon', description: 'Icon after the label.', isDefault: false, allowsReorder: false, isSingleChild: true,
      builderMetadata: { displayName: 'End Icon', required: false, dropZoneMode: 'inline' } },
  ],
  events: [
...
const BADGE_CONTRACT: ComponentContract = {
  ...
  metadata: {
    ...
    status: 'stable',
    platforms: ['web'],
    a11y: { ariaSupported: true, ariaRequired: false, keyboardNavigation: false, trapsFocus: false, wcagCriteria: [], screenReader: 'supported' },
  },
  props: [
    ...
    { name: 'tone', type: 'enum', typeDetails: ['neutral', 'positive', 'warning', 'critical', 'info', 'ai'],
      description: 'Colour semantic.', defaultValue: 'neutral', required: false,
      builderMetadata: { control: 'select', category: 'style', order: 1, bindable: false } },
    { name: 'size', type: 'enum', typeDetails: ['sm', 'md'],
      description: 'Badge size.', defaultValue: 'md', required: false,
      builderMetadata: { control: 'select', category: 'style', order: 2, bindable: false } },
  ],
  slots: [],
  events: [],
...
const TEXT_FIELD_CONTRACT: ComponentContract = {
  ...
  metadata: {
    ...
    status: 'stable',
    platforms: ['web'],
    a11y: { role: 'textbox', ariaSupported: true, ariaRequired: false, keyboardNavigation: true, trapsFocus: false, wcagCriteria: ['2.4.7', '3.3.2'], screenReader: 'supported' },
  },
  props: [
    ...
    { name: 'helperText', type: 'string', description: 'Helper or error message.', required: false,
      builderMetadata: { control: 'text', category: 'content', order: 3, bindable: true } },
    { name: 'error', type: 'boolean', description: 'Marks the field as invalid.', defaultValue: false, required: false,
      builderMetadata: { control: 'toggle', category: 'state', order: 4, bindable: true } },
    { name: 'disabled', type: 'boolean', description: 'Disables the field.', defaultValue: false, required: false,
      builderMetadata: { control: 'toggle', category: 'state', order: 5, bindable: true } },
    { name: 'required', type: 'boolean', description: 'Marks the field as required.', defaultValue: false, required: false,
      builderMetadata: { control: 'toggle', category: 'validation', order: 6, bindable: false } },
    { name: 'size', type: 'enum', typeDetails: ['sm', 'md', 'lg'], defaultValue: 'md', required: false,
      builderMetadata: { control: 'select', category: 'style', order: 7, bindable: false } },
    { name: 'fullWidth', type: 'boolean', defaultValue: true, required: false,
...
const SPINNER_CONTRACT: ComponentContract = {
  ...
  metadata: {
    ...
    status: 'stable',
    platforms: ['web'],
    a11y: { role: 'status', ariaSupported: true, ariaRequired: false, keyboardNavigation: false, trapsFocus: false, wcagCriteria: [], screenReader: 'supported' },
  },
  props: [
    { name: 'size', type: 'enum', typeDetails: ['sm', 'md', 'lg', 'xl'], defaultValue: 'md', required: false,
      builderMetadata: { control: 'select', category: 'style', order: 0, bindable: false } },
    { name: 'label', type: 'string', description: 'Screen-reader accessible label.', defaultValue: 'Loading…', required: false,
      builderMetadata: { control: 'text', category: 'a11y', order: 1, bindable: true } },
    { name: 'color', type: 'enum', typeDetails: ['primary', 'secondary', 'inherit'], defaultValue: 'primary', required: false,
      builderMetadata: { control: 'select', category: 'style', order: 2, bindable: false } },
  ],
  slots: [],
  events: [],
...
const SELECT_CONTRACT: ComponentContract = {
  ...
  metadata: {
    ...
    status: 'stable',
    platforms: ['web'],
    a11y: { role: 'listbox', ariaSupported: true, ariaRequired: false, keyboardNavigation: true, trapsFocus: false, wcagCriteria: ['2.4.7', '3.3.2'], screenReader: 'supported' },
  },
  props: [
    { name: 'label', type: 'string', description: 'Field label.', required: false,
      builderMetadata: { control: 'text', category: 'content', order: 0, bindable: true } },
    { name: 'value', type: 'string', description: 'Selected value.', required: false,
      builderMetadata: { control: 'text', category: 'data', order: 1, bindable: true } },
    ...
    { name: 'disabled', type: 'boolean', defaultValue: false, required: false,
      builderMetadata: { control: 'toggle', category: 'state', order: 3, bindable: true } },
    { name: 'error', type: 'boolean', defaultValue: false, required: false,
      builderMetadata: { control: 'toggle', category: 'state', order: 4, bindable: true } },
...
const CHECKBOX_CONTRACT: ComponentContract = {
  ...
  metadata: {
    ...
    status: 'stable',
    platforms: ['web'],
    a11y: { role: 'checkbox', ariaSupported: true, ariaRequired: false, keyboardNavigation: true, trapsFocus: false, wcagCriteria: ['2.4.7', '3.3.2'], screenReader: 'supported' },
  },
  props: [
    ...
    { name: 'indeterminate', type: 'boolean', defaultValue: false, required: false,

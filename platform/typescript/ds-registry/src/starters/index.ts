...
export const ButtonContract: ComponentContract = {
  ...
  props: [
    {
      ...
      defaultValue: "solid",
      description:
        "Visual style variant matching the @ghatana/design-system Button variants.",
      builderMetadata: {
        control: "select",
        category: "appearance",
        order: 0,
    ...
    },
    {
      ...
      description:
        "Color palette key (tone) matching the design system Button tone prop.",
      builderMetadata: {
        control: "select",
        category: "appearance",
        order: 1,
  ...
  i18n: {
    namespaces: ["design-system"],
    requiredKeys: [],
    localeSensitiveProps: ["children"],
    textProps: ["children"],
    fallbackBehavior: "use-default-value",
    rtlAware: true,
  },
  configurator: {
    groups: [
...
export const CardContract: ComponentContract = {
  ...
  version: "1.0.0",
  description:
    "A surface element for grouping related content with optional elevation.",
  props: [
    {
      name: "elevation",
      type: "number",
  ...
  i18n: {
    namespaces: ["design-system"],
    requiredKeys: [],
    localeSensitiveProps: ["title", "subtitle"],
    textProps: ["title", "subtitle"],
    fallbackBehavior: "use-default-value",
    rtlAware: true,
  },
  configurator: {
...
export const TextFieldContract: ComponentContract = {
  ...
  props: [
    ...
    },
    {
      ...
      defaultValue: "medium",
      description:
        "Size variant matching the design system TextField size prop.",
      builderMetadata: {
        control: "select",
        category: "appearance",
        order: 0,
  ...
  builderA11y: {
    ...
    wcagLevel: "AA",
    a11yGuidance:
      "Every TextField must have a visible label prop or an aria-label for screen readers.",
  },
  telemetry: {
    emittedEvents: [
      {
  ...
  i18n: {
    namespaces: ["design-system"],
    requiredKeys: [],
    localeSensitiveProps: ["label", "placeholder"],
...
export const TypographyContract: ComponentContract = {
  ...
  version: "1.0.0",
  description:
    "A text rendering component for headings, body copy, and captions.",
  props: [
    {
      name: "variant",
      type: "enum",
      ...
      defaultValue: "body1",
      description:
        "Typography scale variant matching the @ghatana/design-system Typography variant prop.",
      builderMetadata: {
        control: "select",
        category: "styling",
        order: 0,
    ...
    },
    {
      ...
      required: false,
      description:
        "Text color token key matching the design system Typography color prop.",
      builderMetadata: {
        control: "select",
        category: "styling",
        order: 1,

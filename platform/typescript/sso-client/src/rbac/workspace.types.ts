...
export const PERSONA_DEFINITIONS: Record<PersonaType, PersonaMetadata> = {
  ...
  sre: {
    ...
    shortName: 'SRE',
    description:
      'Ensure system reliability, observability, and incident response',
    category: 'execution',
    level: 2,
    primaryFocus: [
      'SLO/SLI Metrics',
  ...
  'program-manager': {
    ...
    shortName: 'PgM',
    description:
      'Coordinate multiple projects, manage dependencies and timelines',
    category: 'strategic',
    level: 4,
    primaryFocus: [
      'Program Timeline',
  ...
  'engineering-manager': {
    ...
    shortName: 'EM',
    description:
      'Manage team health, delivery velocity, and resource allocation',
    category: 'strategic',
    level: 4,
    primaryFocus: [
      'Team Velocity',
  ...
  'release-manager': {
    ...
    shortName: 'RM',
    description:
      'Coordinate release schedules, go/no-go decisions, and rollout',
    category: 'operations',
    level: 3,
    primaryFocus: [
      'Release Schedule',
  ...
  'infrastructure-architect': {
    ...
    shortName: 'Infra',
    description:
      'Design and manage cloud infrastructure, scaling, and environments',
    category: 'operations',
    level: 3,
    primaryFocus: [
  ...
  'customer-success': {
    ...
    shortName: 'CS',
    description:
      'Manage customer readiness, adoption, and post-release feedback',
    category: 'operations',
    level: 2,
    primaryFocus: [
      'Customer Readiness',
  ...
  stakeholder: {
    ...
    shortName: 'View',
    description:
      'Read-only access to approved content, reports, and dashboards',
    category: 'administrative',
    level: 1,
    primaryFocus: [
...
export function canManageRole(
  ...
  if (managerRole === WorkspaceRole.ADMIN) {
    return (
      targetRole === WorkspaceRole.MEMBER || targetRole === WorkspaceRole.VIEWER
    );
  }
...
export function getPersonasWithCapability(
  ...
  return (Object.keys(PERSONA_CAPABILITIES) as PersonaType[]).filter(
    (persona) => PERSONA_CAPABILITIES[persona].includes(capability)
  );
}

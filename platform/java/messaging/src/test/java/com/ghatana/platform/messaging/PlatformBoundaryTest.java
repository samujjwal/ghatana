 ...
 *
 * @doc.type class
 * @doc.purpose Validate messaging does not import product packages
 * @doc.layer platform
 * @doc.pattern Test
 */
@DisplayName("Messaging Platform Boundary Tests")
class PlatformBoundaryTest {
    ...
    void shouldOnlyDependOnPlatformModules() throws Exception {
        ...
        assertThat(content)
            ...
            .contains("project(\":platform:java:http\")")
            .doesNotContain("project(\":products:")
            .as("Messaging should only depend on platform modules");
    }
}

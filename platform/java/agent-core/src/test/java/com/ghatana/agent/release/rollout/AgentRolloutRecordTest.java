 ...
 */
@DisplayName("AgentRolloutRecord and AgentRolloutApprovalState [GH-90000]")
class AgentRolloutRecordTest {
    ...
    private static AgentRolloutRecord pending() { // GH-90000
        return new AgentRolloutRecord( // GH-90000
                ...
                false,
                Instant.parse("2026-04-10T10:00:00Z [GH-90000]"), null,
                Instant.parse("2026-04-11T10:00:00Z [GH-90000]"));
    }
    ...
    @Nested
    @DisplayName("AgentRolloutApprovalState [GH-90000]")
    class ApprovalStateTests {

        @Test
        @DisplayName("PENDING is the only pending state [GH-90000]")
        ...
        @Test
        @DisplayName("terminal states exclude PENDING [GH-90000]")
        ...
        @Test
        @DisplayName("5 canonical states defined [GH-90000]")
    ...
    @Nested
    @DisplayName("construction validation [GH-90000]")
    class ConstructionValidation {

        @Test
        @DisplayName("valid record constructs without error [GH-90000]")
        void validRecordConstructs() { // GH-90000
            AgentRolloutRecord r = pending(); // GH-90000
            assertThat(r.rolloutId()).isEqualTo("rollout-abc [GH-90000]");
            assertThat(r.agentReleaseId()).isEqualTo("release-xyz [GH-90000]");
            assertThat(r.tenantId()).isEqualTo("tenant-1 [GH-90000]");
            assertThat(r.targetEnvironment()).isEqualTo("production [GH-90000]");
        ...
        @Test
        @DisplayName("blank rolloutId is rejected [GH-90000]")
        void blankRolloutIdRejected() { // GH-90000
            assertThatThrownBy(() -> new AgentRolloutRecord( // GH-90000
                    ...
                    .hasMessageContaining("rolloutId [GH-90000]");
        }

        @Test
        @DisplayName("blank agentReleaseId is rejected [GH-90000]")
        ...
        @Test
        @DisplayName("traffic split < 0 is rejected [GH-90000]")
        void negativeSplitRejected() { // GH-90000
            assertThatThrownBy(() -> new AgentRolloutRecord( // GH-90000
                    ...
                    Instant.now(), null, Instant.now().plusSeconds(3600))) // GH-90000
                    .isInstanceOf(IllegalArgumentException.class) // GH-90000
                    .hasMessageContaining("trafficSplitPercent [GH-90000]");
        }

        @Test
        @DisplayName("traffic split > 100 is rejected [GH-90000]")
        ...
        @Test
        @DisplayName("traffic split of 0 and 100 are valid boundaries [GH-90000]")
    ...
    @Nested
    @DisplayName("state transitions on record [GH-90000]")
    class StateTransitions {

        @Test
        @DisplayName("withApproved produces new record in APPROVED state [GH-90000]")
        ...
        @Test
        @DisplayName("withRejected produces new record in REJECTED state with reason [GH-90000]")
        void withRejectedProducesNewRecord() { // GH-90000
            ...
            assertThat(rejected.rejectedReason()).isEqualTo("CVE risk [GH-90000]");
        }

        @Test
        @DisplayName("withRolledBack produces new record in ROLLED_BACK state [GH-90000]")
        ...
        @Test
        @DisplayName("original record is unchanged after state transition [GH-90000]")
    ...
    @Nested
    @DisplayName("isActive [GH-90000]")
    class IsActive {

        @Test
        @DisplayName("APPROVED without kill-switch is active [GH-90000]")
        ...
        @Test
        @DisplayName("PENDING is not active [GH-90000]")
        void pendingIsNotActive() { // GH-90000
            assertThat(pending().isActive()).isFalse(); // GH-90000
        }

        @Test
        @DisplayName("APPROVED with kill-switch is not active [GH-90000]")
        ...
        @Test
        @DisplayName("ROLLED_BACK is not active [GH-90000]")

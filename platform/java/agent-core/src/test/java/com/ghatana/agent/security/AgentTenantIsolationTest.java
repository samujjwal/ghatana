...
class AgentTenantIsolationTest extends EventloopTestBase {
    ...
    class RegistryIsolation {
        ...
        void registryIsGlobalSharedResource() { // GH-90000
            ...
            assertThat(ids).contains("fraud-detector");
        ...
        void multipleAgentResolution() { // GH-90000
            ...
            Optional<TypedAgent<String, String>> resolvedAgent2 = runPromise(() -> registry.resolve("agent-2"));

            assertThat(ids).containsExactlyInAnyOrder("agent-1", "agent-2");

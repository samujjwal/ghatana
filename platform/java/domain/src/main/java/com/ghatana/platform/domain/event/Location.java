 ...
 *
 * @see com.ghatana.platform.domain.event.Event (events may contain location)
 * @see com.ghatana.platform.domain.event.EventContext (enrichment context for location data)
 */

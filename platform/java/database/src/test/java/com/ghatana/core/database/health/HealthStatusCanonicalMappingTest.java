...
@DisplayName("Database HealthStatus canonical mapping [GH-90000]")
class HealthStatusCanonicalMappingTest {

    @Test
    @DisplayName("maps database status to canonical platform health [GH-90000]")
    void shouldMapDatabaseStatusToPlatformHealth() { // GH-90000
        SQLException failure = new SQLException("Connection refused [GH-90000]");
        ...
        assertThat(platformStatus.getMessage()).isEqualTo("Database unavailable [GH-90000]");
    ...
    @Test
    @DisplayName("rebuilds database status from canonical platform health [GH-90000]")
    void shouldMapPlatformHealthToDatabaseStatus() { // GH-90000
        RuntimeException failure = new RuntimeException("Timed out [GH-90000]");
        com.ghatana.platform.health.HealthStatus platformStatus =
            com.ghatana.platform.health.HealthStatus.builder() // GH-90000
                ...
                .withMessage("Database connection validated [GH-90000]")
        ...
        assertThat(databaseStatus.getMessage()).isEqualTo("Database connection validated [GH-90000]");
        ...
        assertThat(databaseStatus.getDetails().getDetail("database [GH-90000]")).isEqualTo("postgres [GH-90000]");

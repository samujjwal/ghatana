 ...
 * @doc.pattern Test
 */
@DisplayName("HealthCheckServlet — standardised health and readiness endpoints [GH-90000]")
class HealthCheckServletTest extends EventloopTestBase {
    ...
    @Test
    @DisplayName("/health returns 200 OK [GH-90000]")
    ...
    @Test
    @DisplayName("/health response body contains status UP [GH-90000]")
    ...
    @Test
    @DisplayName("/health response body contains the service name [GH-90000]")
    ...
    @Test
    @DisplayName("/health response body contains the version [GH-90000]")
    ...
    @Test
    @DisplayName("/health response has application/json content type [GH-90000]")
    ...
    @Test
    @DisplayName("/readiness returns 200 OK [GH-90000]")
    void readinessEndpointReturns200() { // GH-90000
        RoutingServlet servlet = HealthCheckServlet
                .addHealthEndpoints(RoutingServlet.builder(eventloop()), SERVICE, VERSION) // GH-90000
                .build(); // GH-90000

        HttpRequest request = HttpRequest.get("http://localhost/readiness [GH-90000]").build();
        HttpResponse response = runPromise(() -> servlet.serve(request)); // GH-90000
    ...
    @Test
    @DisplayName("/readiness response body contains status READY [GH-90000]")
    ...
    @Test
    @DisplayName("addHealthEndpoints returns builder for further route registration [GH-90000]")
    void addHealthEndpointsReturnsSameBuilder() { // GH-90000
        ...
        HttpRequest pingRequest = HttpRequest.get("http://localhost/ping [GH-90000]").build();
        ...
        HttpRequest healthRequest = HttpRequest.get("http://localhost/health [GH-90000]").build();
    ...
    @Test
    @DisplayName("null serviceName throws NullPointerException [GH-90000]")
    ...
    @Test
    @DisplayName("null version throws NullPointerException [GH-90000]")

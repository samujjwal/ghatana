 ...
 *
 * @doc.type class
 * @doc.purpose Validate workflow does not import product packages
 * @doc.layer platform
 * @doc.pattern Test
 */
@DisplayName("Workflow Platform Boundary Tests")
class PlatformBoundaryTest {
    ...
    void shouldOnlyDependOnPlatformModules() throws Exception {
        ...
        assertThat(content)
            ...
            .contains("project(\":platform:java:agent-core\")")
            .doesNotContain("project(\":products:")
            .as("Workflow should only depend on platform modules");
    }
}

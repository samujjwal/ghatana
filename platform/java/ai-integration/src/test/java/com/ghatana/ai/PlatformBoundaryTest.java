 ...
 *
 * @doc.type class
 * @doc.purpose Validate ai-integration does not import product packages
 * @doc.layer platform
 * @doc.pattern Test
 */
@DisplayName("AI-Integration Platform Boundary Tests")
class PlatformBoundaryTest {
    ...
    void shouldOnlyDependOnPlatformModules() throws Exception {
        ...
        assertThat(content)
            ...
            .as("AI-integration should only depend on platform modules");
    }
}

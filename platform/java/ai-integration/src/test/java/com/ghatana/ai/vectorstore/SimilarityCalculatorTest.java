 ...
 */
@DisplayName("SimilarityCalculator [GH-90000]")
class SimilarityCalculatorTest {
    ...
    @Nested
    @DisplayName("cosineSimilarity [GH-90000]")
    class CosineSimilarity {

        @Test
        @DisplayName("identical vectors return 1.0 [GH-90000]")
        ...
        @Test
        @DisplayName("orthogonal vectors return 0.0 [GH-90000]")
        ...
        @Test
        @DisplayName("opposite vectors return -1.0 [GH-90000]")
        ...
        @Test
        @DisplayName("zero vector returns 0.0 [GH-90000]")
        ...
        @Test
        @DisplayName("different length vectors throw IllegalArgumentException [GH-90000]")
        void differentLengths() { // GH-90000
            float[] v1 = {1.0f, 2.0f};
            float[] v2 = {1.0f, 2.0f, 3.0f};
            assertThatThrownBy(() -> SimilarityCalculator.cosineSimilarity(v1, v2)) // GH-90000
                    .isInstanceOf(IllegalArgumentException.class) // GH-90000
                    .hasMessageContaining("same length [GH-90000]");
        }

        @Test
        @DisplayName("null vector1 throws IllegalArgumentException [GH-90000]")
        ...
        @Test
        @DisplayName("empty vector1 throws IllegalArgumentException [GH-90000]")
    ...
    @Nested
    @DisplayName("normalizedCosineSimilarity [GH-90000]")
    class NormalizedCosineSimilarity {
        ...
        @Test
        @DisplayName("orthogonal vectors return 0.5 [GH-90000]")
        void orthogonalVectors() { // GH-90000
            float[] v1 = {1.0f, 0.0f};
            float[] v2 = {0.0f, 1.0f};
        ...
        @Test
        @DisplayName("opposite vectors return 0.0 [GH-90000]")
        void oppositeVectors() { // GH-90000
            float[] v1 = {1.0f, 0.0f};
            float[] v2 = {-1.0f, 0.0f};
    ...
    @Nested
    @DisplayName("euclideanDistance [GH-90000]")
    class EuclideanDistance {

        @Test
        @DisplayName("same point returns 0.0 [GH-90000]")
        ...
        @Test
        @DisplayName("known distance: (0,0) to (3,4) = 5.0 [GH-90000]")
        ...
        @Test
        @DisplayName("distance is always non-negative [GH-90000]")
        ...
        @Test
        @DisplayName("null vector throws IllegalArgumentException [GH-90000]")
    ...
    @Nested
    @DisplayName("euclideanSimilarity [GH-90000]")
    class EuclideanSimilarity {

        @Test
        @DisplayName("same point returns 1.0 [GH-90000]")
        void samePoint() { // GH-90000
            float[] v = {1.0f, 2.0f};
        ...
        @Test
        @DisplayName("distant points return value closer to 0 [GH-90000]")
        ...
        @Test
        @DisplayName("result is always between 0 and 1 [GH-90000]")
    ...
    @Nested
    @DisplayName("dotProduct [GH-90000]")
    class DotProduct {

        @Test
        @DisplayName("known vectors: [1,2,3]·[4,5,6] = 32 [GH-90000]")
        ...
        @Test
        @DisplayName("orthogonal vectors have zero dot product [GH-90000]")
        void orthogonalVectors() { // GH-90000
    ...
    @Nested
    @DisplayName("magnitude [GH-90000]")
    class Magnitude {

        @Test
        @DisplayName("known vector: |[3,4]| = 5.0 [GH-90000]")
        ...
        @Test
        @DisplayName("unit vector has magnitude 1.0 [GH-90000]")
        ...
        @Test
        @DisplayName("empty vector throws IllegalArgumentException [GH-90000]")
    ...
    @Nested
    @DisplayName("normalize [GH-90000]")
    class Normalize {

        @Test
        @DisplayName("normalized vector has magnitude 1.0 [GH-90000]")
        ...
        @Test
        @DisplayName("normalized [3,4] = [0.6, 0.8] [GH-90000]")
        ...
        @Test
        @DisplayName("does not modify original vector [GH-90000]")
    ...
    @Nested
    @DisplayName("Cross-method consistency [GH-90000]")
    class ConsistencyTests {

        @Test
        @DisplayName("dot product of normalized vectors equals cosine similarity [GH-90000]")
        ...
        @Test
        @DisplayName("euclidean distance zero implies euclidean similarity one [GH-90000]")

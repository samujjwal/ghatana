 ...
 * @doc.type class
 * @doc.layer testing
 * @doc.purpose example demonstrating ActiveJ Promise tests using inheritance with custom thread naming
 * @doc.pattern test-template activej-testing base-class-extension
 */
class ActiveJInheritanceExampleTest extends EventloopTestBase {

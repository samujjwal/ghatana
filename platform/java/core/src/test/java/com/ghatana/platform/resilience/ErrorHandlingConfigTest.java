...
@DisplayName("ErrorHandlingConfig – Pipeline Error Strategy [GH-90000]")
class ErrorHandlingConfigTest {

    @Test
    @Order(1) // GH-90000
    @DisplayName("1. failFast() factory creates correct config [GH-90000]")
    ...
    @Test
    @Order(2) // GH-90000
    @DisplayName("2. retry() factory creates correct config with defaults [GH-90000]")
    ...
    @Test
    @Order(3) // GH-90000
    @DisplayName("3. retry() with custom delay [GH-90000]")
    ...
    @Test
    @Order(4) // GH-90000
    @DisplayName("4. deadLetter() factory creates correct config [GH-90000]")
    void deadLetterFactory() { // GH-90000
        ErrorHandlingConfig config = ErrorHandlingConfig.deadLetter("fraud-dlq [GH-90000]");
        assertThat(config.getStrategy()).isEqualTo(ErrorHandlingConfig.ErrorStrategy.DEAD_LETTER); // GH-90000
        assertThat(config.getDeadLetterQueueId()).isEqualTo("fraud-dlq [GH-90000]");
        assertThat(config.hasDlq()).isTrue(); // GH-90000
    }

    @Test
    @Order(5) // GH-90000
    @DisplayName("5. continueOnError() factory creates correct config [GH-90000]")
    ...
    @Test
    @Order(6) // GH-90000
    @DisplayName("6. Builder with custom timeout [GH-90000]")
    ...
    @Test
    @Order(7) // GH-90000
    @DisplayName("7. hasDlq() returns false for null/empty DLQ ID [GH-90000]")
    ...
    @Test
    @Order(8) // GH-90000
    @DisplayName("8. toString() includes key fields [GH-90000]")
    void toStringFormat() { // GH-90000
        ErrorHandlingConfig config = ErrorHandlingConfig.deadLetter("my-dlq [GH-90000]");
        String str = config.toString(); // GH-90000
        assertThat(str) // GH-90000
                .contains("DEAD_LETTER [GH-90000]")
                .contains("my-dlq [GH-90000]");
    }
}

...
@DisplayName("DeadLetterQueue – Failed Event Storage & Retrieval [GH-90000]")
class DeadLetterQueueTest {

    @Test
    @Order(1) // GH-90000
    @DisplayName("1. Store and retrieve a failed event [GH-90000]")
    void storeAndRetrieve() { // GH-90000
        DeadLetterQueue dlq = DeadLetterQueue.builder().build(); // GH-90000

        String id = dlq.store("event-payload", new RuntimeException("boom [GH-90000]"), "processing-error");
        ...
        assertThat(fe.getOriginalEvent()).isEqualTo("event-payload [GH-90000]");
        assertThat(fe.getErrorMessage()).isEqualTo("boom [GH-90000]");
        assertThat(fe.getErrorType()).isEqualTo("RuntimeException [GH-90000]");
        assertThat(fe.getReason()).isEqualTo("processing-error [GH-90000]");
        assertThat(fe.getFailedAt()).isBeforeOrEqualTo(Instant.now()); // GH-90000
        assertThat(fe.getStackTrace()).contains("RuntimeException [GH-90000]");
    }

    @Test
    @Order(2) // GH-90000
    @DisplayName("2. Enforces max size by evicting oldest [GH-90000]")
    void enforcesMaxSize() { // GH-90000
        DeadLetterQueue dlq = DeadLetterQueue.builder() // GH-90000
                .maxSize(3) // GH-90000
                .build(); // GH-90000

        String id1 = dlq.store("e1", new Exception("err1 [GH-90000]"), "r1");
        String id2 = dlq.store("e2", new Exception("err2 [GH-90000]"), "r2");
        String id3 = dlq.store("e3", new Exception("err3 [GH-90000]"), "r3");
        String id4 = dlq.store("e4", new Exception("err4 [GH-90000]"), "r4");
    ...
    @Test
    @Order(3) // GH-90000
    @DisplayName("3. getAll returns snapshot of all events [GH-90000]")
    void getAllSnapshot() { // GH-90000
        DeadLetterQueue dlq = DeadLetterQueue.builder().build(); // GH-90000
        dlq.store("e1", new Exception("err1 [GH-90000]"), "r1");
        dlq.store("e2", new Exception("err2 [GH-90000]"), "r2");
    ...
    @Test
    @Order(4) // GH-90000
    @DisplayName("4. Filter by error type [GH-90000]")
    void filterByErrorType() { // GH-90000
        DeadLetterQueue dlq = DeadLetterQueue.builder().build(); // GH-90000
        dlq.store("e1", new IllegalArgumentException("bad arg [GH-90000]"), "r1");
        dlq.store("e2", new NullPointerException("null [GH-90000]"), "r2");
        dlq.store("e3", new IllegalArgumentException("another bad [GH-90000]"), "r3");

        List<DeadLetterQueue.FailedEvent> filtered = dlq.getByErrorType("IllegalArgumentException [GH-90000]");
        assertThat(filtered).hasSize(2); // GH-90000
    }

    @Test
    @Order(5) // GH-90000
    @DisplayName("5. Filter by time range [GH-90000]")
    void filterByTimeRange() { // GH-90000
        DeadLetterQueue dlq = DeadLetterQueue.builder().build(); // GH-90000
        Instant before = Instant.now().minusSeconds(1); // GH-90000
        dlq.store("e1", new Exception("err [GH-90000]"), "r1");
    ...
    @Test
    @Order(6) // GH-90000
    @DisplayName("6. Remove individual event [GH-90000]")
    void removeEvent() { // GH-90000
        DeadLetterQueue dlq = DeadLetterQueue.builder().build(); // GH-90000
        String id = dlq.store("e1", new Exception("err [GH-90000]"), "r1");
    ...
    @Test
    @Order(7) // GH-90000
    @DisplayName("7. Clear removes all events [GH-90000]")
    void clearAll() { // GH-90000
        DeadLetterQueue dlq = DeadLetterQueue.builder().build(); // GH-90000
        dlq.store("e1", new Exception("e [GH-90000]"), "r");
        dlq.store("e2", new Exception("e [GH-90000]"), "r");
    ...
    @Test
    @Order(8) // GH-90000
    @DisplayName("8. Builder defaults are sensible [GH-90000]")
    ...
    @Test
    @Order(9) // GH-90000
    @DisplayName("9. Handles null error gracefully [GH-90000]")
    void handlesNullError() { // GH-90000
        ...
        assertThat(fe.getErrorMessage()).isEqualTo("unknown [GH-90000]");
        assertThat(fe.getErrorType()).isEqualTo("Unknown [GH-90000]");
        assertThat(fe.getStackTrace()).isEmpty(); // GH-90000
    }

    @Test
    @Order(10) // GH-90000
    @DisplayName("10. FailedEvent equality based on ID [GH-90000]")
    void failedEventEquality() { // GH-90000
        DeadLetterQueue dlq = DeadLetterQueue.builder().build(); // GH-90000
        String id1 = dlq.store("e1", new Exception("err [GH-90000]"), "r");
        String id2 = dlq.store("e2", new Exception("err [GH-90000]"), "r");
    ...
    @Test
    @Order(11) // GH-90000
    @DisplayName("11. Metrics track stored and evicted counts [GH-90000]")
    void metricsTracking() { // GH-90000
        DeadLetterQueue dlq = DeadLetterQueue.builder().maxSize(2).build(); // GH-90000

        dlq.store("e1", new Exception("e [GH-90000]"), "r");
        dlq.store("e2", new Exception("e [GH-90000]"), "r");
        dlq.store("e3", new Exception("e [GH-90000]"), "r"); // evicts e1

...
class PiiRedactorValidationTest {
    ...
    class EdgeCases {
        ...
        void shouldHandleMixedCaseEmail() {
        ...
        void shouldHandleEmailWithSubdomains() {
        ...
        void shouldHandleEmailWithPlusAddressing() {
        ...
        void shouldHandleCreditCardsWithVaryingSpacing() {
        ...
        void shouldHandlePasswordInURL() {
    ...
    class ComplexScenarios {
        ...
        void shouldRedactMultiplePIIInSingleString() {
    ...
    class PIIDetectionValidation {
        ...
        void shouldDetectEmailInVariousContexts() {
        ...
        void shouldDetectPhoneInVariousFormats() {
    ...
    class SpecificRedactionMethods {
        ...
        void shouldOnlyRedactEmailsWithSpecificMethod() {
        ...
        void shouldOnlyRedactPhonesWithSpecificMethod() {
            String input = "Contact user@example.com at 555-123-4567";
            String result = PiiRedactor.redactPhones(input);
        ...
        void shouldOnlyRedactCreditCardsWithSpecificMethod() {
        ...
        void shouldOnlyRedactSSNsWithSpecificMethod() {
        ...
        void shouldOnlyRedactIPsWithSpecificMethod() {
        ...
        void shouldOnlyRedactAPIKeysWithSpecificMethod() {
        ...
        void shouldOnlyRedactUUIDsWithSpecificMethod() {
    ...
    class NullAndEmptyHandling {
        ...
        void shouldHandleNullForAllMethods() {
            assertThat(PiiRedactor.redact(null)).isNull();
            assertThat(PiiRedactor.redactEmails(null)).isNull();
            assertThat(PiiRedactor.redactPhones(null)).isNull();
            assertThat(PiiRedactor.redactCreditCards(null)).isNull();
            assertThat(PiiRedactor.redactSSNs(null)).isNull();
            assertThat(PiiRedactor.redactIPs(null)).isNull();
            assertThat(PiiRedactor.redactApiKeys(null)).isNull();
            assertThat(PiiRedactor.redactUUIDs(null)).isNull();
        }

        @Test
        @DisplayName("should handle empty string for all methods")
        void shouldHandleEmptyStringForAllMethods() {
            assertThat(PiiRedactor.redact("")).isEmpty();
            assertThat(PiiRedactor.redactEmails("")).isEmpty();
            assertThat(PiiRedactor.redactPhones("")).isEmpty();
        ...
        void shouldHandleStringWithoutPII() {
    ...
    class SpecialCharactersAndUnicode {
        ...
        void shouldHandleEmailsWithSpecialChars() {

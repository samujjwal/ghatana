...
## 1. Executive Summary
- product reviewed: kernel (java/kernel)
- maturity summary: static inspection shows 120 maintained source file(s), 29 test artifact(s), 4 markdown document(s), and 0 stale-file marker(s)
- critical blockers: no single hard blocker from static inspection, but runtime validation is still missing
- key logic risks: Duplicate or overlapping symbol names touch this module, increasing accidental parallel abstractions: Policy.java: java/agent-core/src/main/java/com/ghatana/agent/framework/memory/Policy.java, java/kernel/src/main/java/com/ghatana/kernel/security/Policy.java, java/security/src/main/java/com/ghatana/platform/security/rbac/Policy.java | ResourceRequirements.java: java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/ResourceRequirements.java, java/kernel/src/main/java/com/ghatana/kernel/descriptor/ResourceRequirements.java | BoundaryPolicyResolver.java: java/kernel/src/main/java/com/ghatana/kernel/boundary/BoundaryPolicyResolver.java, java/kernel/src/main/java/com/ghatana/kernel/policy/BoundaryPolicyResolver.java.
...
- purpose: Core kernel contracts and runtime primitives for platform modules that need consistent capability registration, module lifecycle management, context propagation, plugin loading, policy enforcement, and observability hooks.
...
- Local reusable dependencies already in play: :platform:java:core, :platform:java:testing.
- Cross-repo duplicate names touching this module: Policy.java: java/agent-core/src/main/java/com/ghatana/agent/framework/memory/Policy.java, java/kernel/src/main/java/com/ghatana/kernel/security/Policy.java, java/security/src/main/java/com/ghatana/platform/security/rbac/Policy.java | ResourceRequirements.java: java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/ResourceRequirements.java, java/kernel/src/main/java/com/ghatana/kernel/descriptor/ResourceRequirements.java | BoundaryPolicyResolver.java: java/kernel/src/main/java/com/ghatana/kernel/boundary/BoundaryPolicyResolver.java, java/kernel/src/main/java/com/ghatana/kernel/policy/BoundaryPolicyResolver.java | DefaultBoundaryPolicyResolver.java: java/kernel/src/main/java/com/ghatana/kernel/boundary/DefaultBoundaryPolicyResolver.java, java/kernel/src/main/java/com/ghatana/kernel/policy/DefaultBoundaryPolicyResolver.java | ContractValidator.java: java/kernel/src/main/java/com/ghatana/kernel/contracts/ContractValidator.java, java/kernel/src/main/java/com/ghatana/kernel/contracts/validator.disabled/ContractValidator.java | AutonomousContractValidator.java: java/kernel/src/main/java/com/ghatana/kernel/contracts/validator.disabled/AutonomousContractValidator.java, java/kernel/src/main/java/com/ghatana/kernel/contracts/validator/AutonomousContractValidator.java.
- consolidation opportunities:
- Consolidate overlapping symbols touching java/kernel to reduce ambiguous ownership.
...
- ResourceRequirements.java: java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/ResourceRequirements.java, java/kernel/src/main/java/com/ghatana/kernel/descriptor/ResourceRequirements.java
- BoundaryPolicyResolver.java: java/kernel/src/main/java/com/ghatana/kernel/boundary/BoundaryPolicyResolver.java, java/kernel/src/main/java/com/ghatana/kernel/policy/BoundaryPolicyResolver.java
- DefaultBoundaryPolicyResolver.java: java/kernel/src/main/java/com/ghatana/kernel/boundary/DefaultBoundaryPolicyResolver.java, java/kernel/src/main/java/com/ghatana/kernel/policy/DefaultBoundaryPolicyResolver.java
- ContractValidator.java: java/kernel/src/main/java/com/ghatana/kernel/contracts/ContractValidator.java, java/kernel/src/main/java/com/ghatana/kernel/contracts/validator.disabled/ContractValidator.java
- AutonomousContractValidator.java: java/kernel/src/main/java/com/ghatana/kernel/contracts/validator.disabled/AutonomousContractValidator.java, java/kernel/src/main/java/com/ghatana/kernel/contracts/validator/AutonomousContractValidator.java
...
- user goal: integrate and rely on kernel without reimplementing its core behavior
...
- systems involved: java/kernel, :platform:java:core, :platform:java:testing
...
- test coverage status: 29 test artifact(s) found; this is material but not yet enough for production sign-off
- automation opportunities: use anomaly detection and summarization to reduce manual triage load
- duplication or restructuring concerns: Policy.java: java/agent-core/src/main/java/com/ghatana/agent/framework/memory/Policy.java, java/kernel/src/main/java/com/ghatana/kernel/security/Policy.java, java/security/src/main/java/com/ghatana/platform/security/rbac/Policy.java ; ResourceRequirements.java: java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/ResourceRequirements.java, java/kernel/src/main/java/com/ghatana/kernel/descriptor/ResourceRequirements.java

## 5. Feature Completeness Analysis
- The module exposes a visible maintained surface (120 source files), but completeness cannot be declared from static inspection alone.
...
- Reuse candidates already exist through local dependencies (:platform:java:core, :platform:java:testing); prefer composing them over introducing adjacent packages.
...
- ResourceRequirements.java: java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/ResourceRequirements.java, java/kernel/src/main/java/com/ghatana/kernel/descriptor/ResourceRequirements.java Harm: creates ambiguous ownership and increases accidental parallel APIs. Action: merge, relocate, or delete the weaker duplicate after consumer mapping.
- BoundaryPolicyResolver.java: java/kernel/src/main/java/com/ghatana/kernel/boundary/BoundaryPolicyResolver.java, java/kernel/src/main/java/com/ghatana/kernel/policy/BoundaryPolicyResolver.java Harm: creates ambiguous ownership and increases accidental parallel APIs. Action: merge, relocate, or delete the weaker duplicate after consumer mapping.
- DefaultBoundaryPolicyResolver.java: java/kernel/src/main/java/com/ghatana/kernel/boundary/DefaultBoundaryPolicyResolver.java, java/kernel/src/main/java/com/ghatana/kernel/policy/DefaultBoundaryPolicyResolver.java Harm: creates ambiguous ownership and increases accidental parallel APIs. Action: merge, relocate, or delete the weaker duplicate after consumer mapping.
- ContractValidator.java: java/kernel/src/main/java/com/ghatana/kernel/contracts/ContractValidator.java, java/kernel/src/main/java/com/ghatana/kernel/contracts/validator.disabled/ContractValidator.java Harm: creates ambiguous ownership and increases accidental parallel APIs. Action: merge, relocate, or delete the weaker duplicate after consumer mapping.
- AutonomousContractValidator.java: java/kernel/src/main/java/com/ghatana/kernel/contracts/validator.disabled/AutonomousContractValidator.java, java/kernel/src/main/java/com/ghatana/kernel/contracts/validator/AutonomousContractValidator.java Harm: creates ambiguous ownership and increases accidental parallel APIs. Action: merge, relocate, or delete the weaker duplicate after consumer mapping.
...
- Build metadata exists via java/kernel/build.gradle.kts, but runtime readiness was not exercised here.
...
- title: Tighten correctness and ownership for kernel
...
- reuse candidates: :platform:java:core, :platform:java:testing

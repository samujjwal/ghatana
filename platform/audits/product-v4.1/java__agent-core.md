...
## 1. Executive Summary
- product reviewed: agent-core (java/agent-core)
- maturity summary: static inspection shows 166 maintained source file(s), 37 test artifact(s), 1 markdown document(s), and 0 stale-file marker(s)
- critical blockers: no single hard blocker from static inspection, but runtime validation is still missing
- key logic risks: No README or module-level product explanation was found, which weakens product-understanding, onboarding, and auditability. ; The module depends on many local platform packages (:platform:java:core, :platform:java:observability, :platform:java:ai-integration, :platform:java:governance, :platform:java:agent-memory, :platform:java:testing), so ownership and API-surface simplification should be reviewed.
...
- key duplicate/consolidation findings: HealthStatus.java: java/agent-core/src/main/java/com/ghatana/agent/HealthStatus.java, java/core/src/main/java/com/ghatana/platform/health/HealthStatus.java, java/database/src/main/java/com/ghatana/core/database/health/HealthStatus.java, java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/HealthStatus.java ; Policy.java: java/agent-core/src/main/java/com/ghatana/agent/framework/memory/Policy.java, java/kernel/src/main/java/com/ghatana/kernel/security/Policy.java, java/security/src/main/java/com/ghatana/platform/security/rbac/Policy.java ; AgentInfo.java: java/agent-core/src/main/java/com/ghatana/agent/framework/coordination/AgentInfo.java, java/domain/src/main/java/com/ghatana/platform/domain/models/agent/AgentInfo.java
- key restructuring findings: boundary cleanup and ownership clarification are warranted
- key AI/ML automation opportunities to reduce human intervention safely: use anomaly detection and summarization to reduce manual triage load ; add confidence-gated automation with deterministic fallback paths ; measure automation quality, override rates, and rollback behavior before expanding autonomy
...
- purpose: Agent Core - Unified agent contracts, SPI, and coordination framework
- personas: platform engineers, workflow/agent authors, operators
- major workflows: A product or service constructs an agent/workflow/tool/plugin request, the module coordinates execution, and consumers rely on deterministic state, policy, and observability guarantees.
- critical paths: Critical path includes registration, validation, orchestration, retries, idempotency, approval/fallback, and persistence of execution state.
...
- Local reusable dependencies already in play: :platform:java:core, :platform:java:observability, :platform:java:ai-integration, :platform:java:governance, :platform:java:agent-memory, :platform:java:testing.
- Cross-repo duplicate names touching this module: HealthStatus.java: java/agent-core/src/main/java/com/ghatana/agent/HealthStatus.java, java/core/src/main/java/com/ghatana/platform/health/HealthStatus.java, java/database/src/main/java/com/ghatana/core/database/health/HealthStatus.java, java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/HealthStatus.java | Policy.java: java/agent-core/src/main/java/com/ghatana/agent/framework/memory/Policy.java, java/kernel/src/main/java/com/ghatana/kernel/security/Policy.java, java/security/src/main/java/com/ghatana/platform/security/rbac/Policy.java | AgentInfo.java: java/agent-core/src/main/java/com/ghatana/agent/framework/coordination/AgentInfo.java, java/domain/src/main/java/com/ghatana/platform/domain/models/agent/AgentInfo.java | ApprovalRequest.java: java/agent-core/src/main/java/com/ghatana/agent/framework/runtime/ApprovalRequest.java, java/tool-runtime/src/main/java/com/ghatana/platform/toolruntime/approval/ApprovalRequest.java | ApprovalStatus.java: java/agent-core/src/main/java/com/ghatana/agent/framework/runtime/ApprovalStatus.java, java/tool-runtime/src/main/java/com/ghatana/platform/toolruntime/approval/ApprovalStatus.java | AgentSpec.java: java/agent-core/src/main/java/com/ghatana/agent/framework/spec/AgentSpec.java, java/domain/src/main/java/com/ghatana/platform/domain/pipeline/AgentSpec.java.
- Documentation gap means shared capability discovery is weaker than it should be.
- consolidation opportunities:
- Consolidate overlapping symbols touching java/agent-core to reduce ambiguous ownership.
...
- AgentInfo.java: java/agent-core/src/main/java/com/ghatana/agent/framework/coordination/AgentInfo.java, java/domain/src/main/java/com/ghatana/platform/domain/models/agent/AgentInfo.java
- ApprovalRequest.java: java/agent-core/src/main/java/com/ghatana/agent/framework/runtime/ApprovalRequest.java, java/tool-runtime/src/main/java/com/ghatana/platform/toolruntime/approval/ApprovalRequest.java
- ApprovalStatus.java: java/agent-core/src/main/java/com/ghatana/agent/framework/runtime/ApprovalStatus.java, java/tool-runtime/src/main/java/com/ghatana/platform/toolruntime/approval/ApprovalStatus.java
- AgentSpec.java: java/agent-core/src/main/java/com/ghatana/agent/framework/spec/AgentSpec.java, java/domain/src/main/java/com/ghatana/platform/domain/pipeline/AgentSpec.java
...
- The module depends on many local platform packages (:platform:java:core, :platform:java:observability, :platform:java:ai-integration, :platform:java:governance, :platform:java:agent-memory, :platform:java:testing), so ownership and API-surface simplification should be reviewed.
- Duplicate or overlapping symbol names touch this module, increasing accidental parallel abstractions: HealthStatus.java: java/agent-core/src/main/java/com/ghatana/agent/HealthStatus.java, java/core/src/main/java/com/ghatana/platform/health/HealthStatus.java, java/database/src/main/java/com/ghatana/core/database/health/HealthStatus.java, java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/HealthStatus.java | Policy.java: java/agent-core/src/main/java/com/ghatana/agent/framework/memory/Policy.java, java/kernel/src/main/java/com/ghatana/kernel/security/Policy.java, java/security/src/main/java/com/ghatana/platform/security/rbac/Policy.java | AgentInfo.java: java/agent-core/src/main/java/com/ghatana/agent/framework/coordination/AgentInfo.java, java/domain/src/main/java/com/ghatana/platform/domain/models/agent/AgentInfo.java.

## 4. End-to-End Workflow Mapping
- user goal: integrate and rely on agent-core without reimplementing its core behavior
- end-to-end path: A product or service constructs an agent/workflow/tool/plugin request, the module coordinates execution, and consumers rely on deterministic state, policy, and observability guarantees.
- systems involved: java/agent-core, :platform:java:core, :platform:java:observability, :platform:java:ai-integration, :platform:java:governance, :platform:java:agent-memory, :platform:java:testing
...
- missing or broken steps: The module depends on many local platform packages (:platform:java:core, :platform:java:observability, :platform:java:ai-integration, :platform:java:governance, :platform:java:agent-memory, :platform:java:testing), so ownership and API-surface simplification should be reviewed. ; Duplicate or overlapping symbol names touch this module, increasing accidental parallel abstractions: HealthStatus.java: java/agent-core/src/main/java/com/ghatana/agent/HealthStatus.java, java/core/src/main/java/com/ghatana/platform/health/HealthStatus.java, java/database/src/main/java/com/ghatana/core/database/health/HealthStatus.java, java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/HealthStatus.java | Policy.java: java/agent-core/src/main/java/com/ghatana/agent/framework/memory/Policy.java, java/kernel/src/main/java/com/ghatana/kernel/security/Policy.java, java/security/src/main/java/com/ghatana/platform/security/rbac/Policy.java | AgentInfo.java: java/agent-core/src/main/java/com/ghatana/agent/framework/coordination/AgentInfo.java, java/domain/src/main/java/com/ghatana/platform/domain/models/agent/AgentInfo.java.
- test coverage status: 37 test artifact(s) found; this is material but not yet enough for production sign-off
- automation opportunities: use anomaly detection and summarization to reduce manual triage load
- duplication or restructuring concerns: HealthStatus.java: java/agent-core/src/main/java/com/ghatana/agent/HealthStatus.java, java/core/src/main/java/com/ghatana/platform/health/HealthStatus.java, java/database/src/main/java/com/ghatana/core/database/health/HealthStatus.java, java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/HealthStatus.java ; Policy.java: java/agent-core/src/main/java/com/ghatana/agent/framework/memory/Policy.java, java/kernel/src/main/java/com/ghatana/kernel/security/Policy.java, java/security/src/main/java/com/ghatana/platform/security/rbac/Policy.java

## 5. Feature Completeness Analysis
- The module exposes a visible maintained surface (166 source files), but completeness cannot be declared from static inspection alone.
...
- Reuse candidates already exist through local dependencies (:platform:java:core, :platform:java:observability, :platform:java:ai-integration, :platform:java:governance, :platform:java:agent-memory, :platform:java:testing); prefer composing them over introducing adjacent packages.
...
- HealthStatus.java: java/agent-core/src/main/java/com/ghatana/agent/HealthStatus.java, java/core/src/main/java/com/ghatana/platform/health/HealthStatus.java, java/database/src/main/java/com/ghatana/core/database/health/HealthStatus.java, java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/HealthStatus.java Harm: creates ambiguous ownership and increases accidental parallel APIs. Action: merge, relocate, or delete the weaker duplicate after consumer mapping.
...
- AgentInfo.java: java/agent-core/src/main/java/com/ghatana/agent/framework/coordination/AgentInfo.java, java/domain/src/main/java/com/ghatana/platform/domain/models/agent/AgentInfo.java Harm: creates ambiguous ownership and increases accidental parallel APIs. Action: merge, relocate, or delete the weaker duplicate after consumer mapping.
- ApprovalRequest.java: java/agent-core/src/main/java/com/ghatana/agent/framework/runtime/ApprovalRequest.java, java/tool-runtime/src/main/java/com/ghatana/platform/toolruntime/approval/ApprovalRequest.java Harm: creates ambiguous ownership and increases accidental parallel APIs. Action: merge, relocate, or delete the weaker duplicate after consumer mapping.
- ApprovalStatus.java: java/agent-core/src/main/java/com/ghatana/agent/framework/runtime/ApprovalStatus.java, java/tool-runtime/src/main/java/com/ghatana/platform/toolruntime/approval/ApprovalStatus.java Harm: creates ambiguous ownership and increases accidental parallel APIs. Action: merge, relocate, or delete the weaker duplicate after consumer mapping.
- AgentSpec.java: java/agent-core/src/main/java/com/ghatana/agent/framework/spec/AgentSpec.java, java/domain/src/main/java/com/ghatana/platform/domain/pipeline/AgentSpec.java Harm: creates ambiguous ownership and increases accidental parallel APIs. Action: merge, relocate, or delete the weaker duplicate after consumer mapping.
...
- Build metadata exists via java/agent-core/build.gradle.kts, but runtime readiness was not exercised here.
...
- Surface duplication touching this module: HealthStatus.java: java/agent-core/src/main/java/com/ghatana/agent/HealthStatus.java, java/core/src/main/java/com/ghatana/platform/health/HealthStatus.java, java/database/src/main/java/com/ghatana/core/database/health/HealthStatus.java, java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/HealthStatus.java | Policy.java: java/agent-core/src/main/java/com/ghatana/agent/framework/memory/Policy.java, java/kernel/src/main/java/com/ghatana/kernel/security/Policy.java, java/security/src/main/java/com/ghatana/platform/security/rbac/Policy.java | AgentInfo.java: java/agent-core/src/main/java/com/ghatana/agent/framework/coordination/AgentInfo.java, java/domain/src/main/java/com/ghatana/platform/domain/models/agent/AgentInfo.java | ApprovalRequest.java: java/agent-core/src/main/java/com/ghatana/agent/framework/runtime/ApprovalRequest.java, java/tool-runtime/src/main/java/com/ghatana/platform/toolruntime/approval/ApprovalRequest.java | ApprovalStatus.java: java/agent-core/src/main/java/com/ghatana/agent/framework/runtime/ApprovalStatus.java, java/tool-runtime/src/main/java/com/ghatana/platform/toolruntime/approval/ApprovalStatus.java | AgentSpec.java: java/agent-core/src/main/java/com/ghatana/agent/framework/spec/AgentSpec.java, java/domain/src/main/java/com/ghatana/platform/domain/pipeline/AgentSpec.java.

## 24. Boundary and Ownership Findings
- Primary owner boundary should be the automation-platform concern area, not an accidental overlap with neighboring modules.
...
- title: Tighten correctness and ownership for agent-core
...
- duplication issues: HealthStatus.java: java/agent-core/src/main/java/com/ghatana/agent/HealthStatus.java, java/core/src/main/java/com/ghatana/platform/health/HealthStatus.java, java/database/src/main/java/com/ghatana/core/database/health/HealthStatus.java, java/domain/src/main/java/com/ghatana/platform/domain/agent/registry/HealthStatus.java ; Policy.java: java/agent-core/src/main/java/com/ghatana/agent/framework/memory/Policy.java, java/kernel/src/main/java/com/ghatana/kernel/security/Policy.java, java/security/src/main/java/com/ghatana/platform/security/rbac/Policy.java ; AgentInfo.java: java/agent-core/src/main/java/com/ghatana/agent/framework/coordination/AgentInfo.java, java/domain/src/main/java/com/ghatana/platform/domain/models/agent/AgentInfo.java ; ApprovalRequest.java: java/agent-core/src/main/java/com/ghatana/agent/framework/runtime/ApprovalRequest.java, java/tool-runtime/src/main/java/com/ghatana/platform/toolruntime/approval/ApprovalRequest.java ; ApprovalStatus.java: java/agent-core/src/main/java/com/ghatana/agent/framework/runtime/ApprovalStatus.java, java/tool-runtime/src/main/java/com/ghatana/platform/toolruntime/approval/ApprovalStatus.java ; AgentSpec.java: java/agent-core/src/main/java/com/ghatana/agent/framework/spec/AgentSpec.java, java/domain/src/main/java/com/ghatana/platform/domain/pipeline/AgentSpec.java
...
- reuse candidates: :platform:java:core, :platform:java:observability, :platform:java:ai-integration, :platform:java:governance, :platform:java:agent-memory, :platform:java:testing
...
- AI/ML automation tasks that safely reduce human effort: use anomaly detection and summarization to reduce manual triage load ; add confidence-gated automation with deterministic fallback paths ; measure automation quality, override rates, and rollback behavior before expanding autonomy
...
- O11y / operations: 4/5. Rationale: observability hooks are implied by module role and dependencies. Key gaps: signals and operator runbooks were not verified live. Next actions: add metric/trace assertions and operator docs.

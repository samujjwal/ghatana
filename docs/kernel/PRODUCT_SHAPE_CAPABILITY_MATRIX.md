...
| python-fixture | demo/example | shape-only | stable | planned | not-enabled | python-pyproject | demo-fixture-not-workspace-wired, planned-shape-only, python-adapter-validation-pending | Shape-only |
| rust-fixture | demo/example | shape-only | stable | planned | not-enabled | cargo-rust | demo-fixture-not-workspace-wired, planned-shape-only, rust-adapter-validation-pending | Shape-only |
...
| typescript-fixture | demo/example | shape-only | stable | planned | not-enabled | pnpm-node-api | demo-fixture-not-workspace-wired, planned-shape-only, typescript-adapter-validation-pending | Shape-only |

...
| data-cloud | platform-provider | disabled-observed | not-declared | disabled | disabled | None | bootstrap-platform-separation-validated, conformance-gates-incomplete, connector-production-path-incomplete, disabled-observed, first-class-domain-contracts-missing, platform-provider-health-validated, platform-provider-mode-required, runtime-truth-provider-validated | Disabled observed |
...
| digital-marketing | business-product | execution | stable | enabled | executable | compose-local, gradle-java-service, pnpm-vite-react | bridge-compliance-active, execution-ready, marketing-consent-boundary-active, validated-digital-marketing-lifecycle-pilot | Pilot |
...
| phr | business-product | execution | stable | enabled | executable | compose-local, gradle-java-service, pnpm-vite-react | consent-gate-active, execution-ready, fhir-r4-pilot-surfaces-validated, healthcare-pilot-enabled, phr-rollback-after-stable-deploy-verify, pii-classification-active | Pilot |
| polyglot-fixture | demo/example | disabled-observed | not-declared | disabled | disabled | None | demo-example-drift-exemption, disabled-observed, polyglot-fixture-not-workspace-wired | Disabled observed |
| python-fixture | demo/example | shape-only | stable | planned | not-enabled | python-pyproject | opening-pilot-policy-exemption, planned-shape-only, polyglot-fixture-execution-proof, python-adapter-native-tests-pass | Shape-only |
| rust-fixture | demo/example | shape-only | stable | planned | not-enabled | cargo-rust | opening-pilot-policy-exemption, planned-shape-only, polyglot-fixture-execution-proof, rust-adapter-native-tests-pass | Shape-only |

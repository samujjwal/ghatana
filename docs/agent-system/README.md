...
│  └─ Unified_Self_Learning_Agents_Spec_Final.md (Theory)     │
...
| **Architect** | [ADR-001: Typed Agent Framework](/docs/adr/ADR-001-typed-agent-framework.md) | Unified_Self_Learning_Agents_Spec_Final.md |
...
### Core Specifications
- [Unified Self-Learning Agents Spec](./Unified_Self_Learning_Agents_Spec_Final.md) - Theory foundation
...
2. **Architects**: Read [Unified_Self_Learning_Agents_Spec_Final.md](./Unified_Self_Learning_Agents_Spec_Final.md) for theory

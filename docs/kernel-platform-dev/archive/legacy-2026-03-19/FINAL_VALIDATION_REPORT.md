...
> **Status correction (March 19, 2026):** This document is now **historical and non-authoritative** for current platform planning. It overstates present repo readiness in several places. Use `KERNEL_APP_PLATFORM_CONVERGENCE_ADR.md`, `KERNEL_APP_PLATFORM_CONVERGENCE_EXPLORATION_AND_PLAN.md`, `KERNEL_CANONICALIZATION_DECISIONS.md`, and related convergence docs as the current planning authority.

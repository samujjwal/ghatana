...
| Logs                | Structured fields: `timestamp` (UTC ISO-8601), `calendar_date` (CalendarDate, optional K-15 enriched), `trace_id`, `tenant_id`, `user_id`, `jurisdiction`, `operation`, `result`, `duration_ms`, `event_id` |
| Traces              | Key spans with parent-child relationships; sampling strategy; cross-service correlation                                                                                                                     |
| Audit Events        | Event name, actor, resource, action, `before_state`, `after_state`, `timestamp` (UTC), `calendar_date` (CalendarDate, K-15 enriched), `jurisdiction`, immutability guarantee method `[LCA-AUDIT-001]`       |

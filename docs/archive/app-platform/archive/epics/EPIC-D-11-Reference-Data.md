...
4. **FR4 Multi-Calendar Date Fields:** Listing dates, maturity dates, and other temporal attributes must use `CalendarDate` (from K-15).
...
- **New Entities:**
  - `Instrument`: `{ isin: String, scrip_code: String, name: String, type: Enum, listing_date: CalendarDate, attributes: JSON }`
  - `LegalEntity`: `{ entity_id: UUID, name: String, jurisdiction: String, registration_number: String }`
- **Multi-Calendar Fields:** `listing_date`, `maturity_date` use `CalendarDate`.
...
| Payload           | `{ "entity_type": "INSTRUMENT", "entity_id": "...", "change_type": "UPDATE", "timestamp": "2025-03-02T10:30:00Z", "calendar_date": {} }` |

...
```json
{
  ...
  "calendar_date": {
    "primary": "ISO8601-UTC",
    "calendars": { "gregorian": {}, "bs": {} }
  },
  "source_domain_pack_id": "string",
  "producer": "string",
  "data": {}
}
```

> `calendar_date` is optional; populated by K-15 Multi-Calendar Service when a calendar T1 pack is installed. `timestamp` is always required (UTC). `source_domain_pack_id` identifies the publishing domain pack.

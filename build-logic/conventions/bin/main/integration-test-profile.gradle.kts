...
private val integrationProperties = mapOf(
...
tasks.withType(Test::class.java).configureEach {
    if (integrationMode) {
        ...
        // Keep integration tests excluded by default; the base java-module convention
        // already enables JUnit Platform execution.

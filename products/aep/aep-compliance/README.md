...
`products/aep/aep-compliance` enforces data-retention and regulatory compliance policies over AEP event data. It owns:
...
```bash
./gradlew :products:aep:aep-compliance:test
```

...
public class TriggerListener implements Service {
     ...
     */
    public Promise<Void> handlePatternMatch(
            String tenantId, String pipelineId, String patternMatchId, Object matchData) {
        if (!isRunning.get()) {
            return Promise.of(null); // no-op when stopped
        }
        ...
        return executionQueue
                .enqueue(tenantId, pipelineId, matchData, idempotencyKey)
                .whenResult(() -> {

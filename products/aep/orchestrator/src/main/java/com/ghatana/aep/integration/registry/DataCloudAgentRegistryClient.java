...
import com.ghatana.agent.registry.client.AgentRegistryClient;
...
public final class DataCloudAgentRegistryClient implements AgentRegistryClient {
        ...
        return Promise.ofBlocking(executor, () -> {
            try {
                ...
                if (response.statusCode() == 200) {
                    List<Map<String, Object>> rawList = MAPPER.readValue(response.body(), new TypeReference<>() {});
    ...
    public Promise<List<AgentInfo>> listAgentsByType(String agentType) {
        ...
        return listAllAgents().map(agents -> agents.stream()

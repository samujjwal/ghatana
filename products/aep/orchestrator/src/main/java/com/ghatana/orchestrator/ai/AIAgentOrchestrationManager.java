...
public interface AIAgentOrchestrationManager {
     ...
     */
    record AgentCapability(String name, String description, Map<String, Object> parameters) {}

    /**
     * Agent dependency specification
     */
    record AgentDependency(String agentId, String versionConstraint, boolean required) {}
    ...
    record ScheduleDefinition(
            String cronExpression, Map<String, Object> parameters, boolean enabled, long startTime, Long endTime) {}

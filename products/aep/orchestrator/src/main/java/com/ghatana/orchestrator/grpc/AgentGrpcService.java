...
public class AgentGrpcService {
    ...
    public static class ManagementService extends AgentManagementServiceProtoGrpc.AgentManagementServiceProtoImplBase {
        ...
        @Override
        public void createAgent(CreateAgentRequestProto request, StreamObserver<AgentManifestProto> responseObserver) {
            try {
                AgentManifestProto agent = request.getAgent();
                if (agent == null
                        || !agent.hasMetadata()
                        || agent.getMetadata().getId().isEmpty()) {
        ...
        @Override
        public void getAgent(GetAgentRequestProto request, StreamObserver<AgentManifestProto> responseObserver) {
            try {
        ...
        public void listAgents(
                ListAgentsRequestProto request, StreamObserver<ListAgentsResponseProto> responseObserver) {
            try {
                log.debug("Listing agents: pageSize={}, filter={}", request.getPageSize(), request.getFilter());
        ...
        public void updateAgent(
                UpdateAgentRequestProto request, StreamObserver<UpdateAgentResponseProto> responseObserver) {
            try {
                AgentManifestProto agent = request.getAgent();
                if (agent == null
                        || !agent.hasMetadata()
        ...
        @Override
        public void deleteAgent(DeleteAgentRequestProto request, StreamObserver<Empty> responseObserver) {
            try {
                String id = request.getId();
                if (id == null || id.isEmpty()) {
                    responseObserver.onError(Status.INVALID_ARGUMENT
        ...
        @Override
        public void startAgent(StartAgentRequestProto request, StreamObserver<AgentManifestProto> responseObserver) {
            try {
                String id = request.getId();
                if (id == null || id.isEmpty()) {
                    responseObserver.onError(Status.INVALID_ARGUMENT
        ...
        @Override
        public void stopAgent(StopAgentRequestProto request, StreamObserver<AgentManifestProto> responseObserver) {
            try {
                String id = request.getId();
                if (id == null || id.isEmpty()) {
                    responseObserver.onError(Status.INVALID_ARGUMENT
        ...
        public void restartAgent(
                RestartAgentRequestProto request, StreamObserver<AgentManifestProto> responseObserver) {
            try {
                String id = request.getId();
                if (id == null || id.isEmpty()) {
                    responseObserver.onError(Status.INVALID_ARGUMENT
        ...
        public void getAgentStatus(
                GetAgentStatusRequestProto request, StreamObserver<AgentManifestProto> responseObserver) {
            try {
                String id = request.getId();
                if (id == null || id.isEmpty()) {
                    responseObserver.onError(Status.INVALID_ARGUMENT
                ...
                registry.healthCheck(id)
                        .whenResult(health -> {
                            ...
                            AgentManifestProto manifest = AgentManifestProto.newBuilder()
                                    .setMetadata(
                                            MetadataProto.newBuilder().setId(id).build())
                                    .setStatus(AgentStatusProto.newBuilder()
                                            .setState(state)
    ...
    public static class ExecutionService extends AgentExecutionServiceProtoGrpc.AgentExecutionServiceProtoImplBase {
        ...
        public void registerAgent(
                RegisterAgentRequestProto request, StreamObserver<RegisterAgentResponseProto> responseObserver) {
            try {
        ...
        @Override
        public void executeAgent(AgentExecuteRequestProto request, StreamObserver<AgentResultProto> responseObserver) {
            try {
                ...
                log.info("Executing agent: id={}, correlationId={}", agentId, request.getCorrelationId());
        ...
        public void streamAgentEvents(
                AgentEventRequestProto request, StreamObserver<AgentEventProto> responseObserver) {
            try {
                String agentId = request.getAgentId();
                if (agentId == null || agentId.isEmpty()) {
                    responseObserver.onError(Status.INVALID_ARGUMENT

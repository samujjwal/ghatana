...
public class EventCloudRegistryEventPublisher implements RegistryEventPublisher {
    ...
    @Override
    public Promise<Void> publishPipelineRegistered(PipelineRegistration pipeline, String userId) {
        // GIVEN: PipelineRegistration with metadata
    ...
    @Override
    public Promise<Void> publishPipelineActivated(PipelineRegistration pipeline, String userId) {
        // GIVEN: PipelineRegistration with activation status
    ...
    @Override
    public Promise<Void> publishPipelineDeactivated(PipelineRegistration pipeline, String userId) {
        // GIVEN: PipelineRegistration with deactivation status
    ...
    private Map<String, Object> buildPipelineEventData(
            PipelineRegistration pipeline, String eventType, String userId) {
        Map<String, Object> eventData = new HashMap<>();
        eventData.put("type", eventType);

...
public interface RegistryEventPublisher {
     ...
     * @return Promise that completes when event is published
     */
    Promise<Void> publishPipelineRegistered(PipelineRegistration pipeline, String userId);
     ...
     * @return Promise that completes when event is published
     */
    Promise<Void> publishPipelineActivated(PipelineRegistration pipeline, String userId);
     ...
     * @return Promise that completes when event is published
     */
    Promise<Void> publishPipelineDeactivated(PipelineRegistration pipeline, String userId);
}

 ...
 * @doc.pattern Test
 */
@DisplayName("AepHttpServer – Agent Endpoints [GH-90000]")
class AepHttpServerAgentTest {
    ...
    void setUp() throws Exception { // GH-90000
        ...
        System.clearProperty("AEP_JWT_SECRET [GH-90000]");
    ...
    void tearDown() { // GH-90000
        ...
        System.clearProperty("AEP_ENV [GH-90000]");
        System.clearProperty("AEP_AUTH_DISABLED [GH-90000]");
        System.clearProperty("AEP_JWT_SECRET [GH-90000]");
    }
    ...
    @Test
    @DisplayName("listAgents: no DataCloudClient → 200 truthful unconfigured response [GH-90000]")
    void listAgents_whenDcNull_returnsTruthfulUnconfiguredResponse() throws Exception { // GH-90000
        ...
        assertThat(body.get("message [GH-90000]").toString()).contains("Agent registry not available [GH-90000]");
        assertThat(body.get("tenantId [GH-90000]")).isNotNull();
    }

    @Test
    @DisplayName("listAgents: DC returns 2 entities → 200 with agent summaries [GH-90000]")
    void listAgents_withDcReturningEntities_returns200WithCount() throws Exception { // GH-90000
        List<EntityStore.Entity> entities = List.of( // GH-90000
            EntityStore.Entity.builder().id("agent-alpha [GH-90000]").collection("aep_agents [GH-90000]")
                .data(Map.of("name", "Alpha", "type", "LLM", "status", "ACTIVE")).build(), // GH-90000
            EntityStore.Entity.builder().id("agent-beta [GH-90000]").collection("aep_agents [GH-90000]")
        ...
        assertThat(resp.statusCode()).isEqualTo(200); // GH-90000
        Map<?, ?> body = mapper.readValue(resp.body(), Map.class); // GH-90000
        assertThat(body.get("count [GH-90000]")).isEqualTo(2);
        List<?> agents = (List<?>) body.get("agents [GH-90000]");
        assertThat(agents).hasSize(2); // GH-90000
    }

    @Test
    @DisplayName("listAgents: DC returns empty list → 200 with count=0 [GH-90000]")
    void listAgents_withEmptyDcResult_returns200WithZeroCount() throws Exception { // GH-90000
        ...
        assertThat((List<?>) body.get("agents [GH-90000]")).isEmpty();
    }

    // ==================== GET /api/v1/agents/:agentId ====================

    @Test
    @DisplayName("getAgent: entity found in DC → 200 with agent detail [GH-90000]")
    void getAgent_whenEntityFound_returns200WithData() throws Exception { // GH-90000
        EntityStore.Entity entity = EntityStore.Entity.builder() // GH-90000
            .id("agent-42 [GH-90000]").collection("aep_agents [GH-90000]")
            .data(Map.of("name", "Sentinel", "type", "LLM", "status", "ACTIVE")).build(); // GH-90000
        when(mockEntityStore.findById(any(TenantContext.class), eq(EntityStore.EntityId.of("agent-42 [GH-90000]"))))
        ...
        HttpResponse<String> resp = get("/api/v1/agents/agent-42 [GH-90000]");

        assertThat(resp.statusCode()).isEqualTo(200); // GH-90000
        Map<?, ?> body = mapper.readValue(resp.body(), Map.class); // GH-90000
        assertThat(body.get("id [GH-90000]")).isEqualTo("agent-42 [GH-90000]");
        assertThat(body.get("config [GH-90000]")).isNotNull();
        assertThat(body.get("tenantId [GH-90000]")).isNotNull();
        assertThat(body.get("timestamp [GH-90000]")).isNotNull();
    }

    @Test
    @DisplayName("getAgent: entity not found in DC → 404 [GH-90000]")
    void getAgent_whenEntityNotFound_returns404() throws Exception { // GH-90000
        when(mockEntityStore.findById(any(TenantContext.class), eq(EntityStore.EntityId.of("missing-agent [GH-90000]"))))
        ...
        HttpResponse<String> resp = get("/api/v1/agents/missing-agent [GH-90000]");

        assertThat(resp.statusCode()).isEqualTo(404); // GH-90000
        Map<?, ?> body = mapper.readValue(resp.body(), Map.class); // GH-90000
        assertThat(body.get("message [GH-90000]")).isNotNull();
        assertThat(body.get("message [GH-90000]").toString()).contains("Agent not found [GH-90000]");
    }

    @Test
    @DisplayName("getAgent: no DataCloudClient → 503 service unavailable [GH-90000]")
    void getAgent_whenDcNull_returns503() throws Exception { // GH-90000
        server = new AepHttpServer(engine, port); // GH-90000
        server.start(); // GH-90000
        waitForServerReady(port); // GH-90000

        HttpResponse<String> resp = get("/api/v1/agents/any-agent [GH-90000]");

        assertThat(resp.statusCode()).isEqualTo(503); // GH-90000
        Map<?, ?> body = mapper.readValue(resp.body(), Map.class); // GH-90000
        assertThat(body.get("message [GH-90000]")).isNotNull();
        assertThat(body.get("message [GH-90000]").toString()).contains("DataCloudClient not configured [GH-90000]");
    }

    // ==================== POST /api/v1/agents/:agentId/execute ====================

    @Test
    @DisplayName("executeAgent: valid body → 200 with agentId and eventId [GH-90000]")
    void executeAgent_withValidBody_returns200WithEventId() throws Exception { // GH-90000
        ...
        assertThat(resp.statusCode()).isEqualTo(200); // GH-90000
        Map<?, ?> body = mapper.readValue(resp.body(), Map.class); // GH-90000
        assertThat(body.get("agentId [GH-90000]")).isEqualTo("agent-99 [GH-90000]");
        assertThat(body.get("tenantId [GH-90000]")).isEqualTo("test-tenant [GH-90000]");
        assertThat(body.get("eventId [GH-90000]")).isNotNull();
        assertThat(body.get("success [GH-90000]")).isNotNull();
    }

    @Test
    @DisplayName("executeAgent: empty body → 200 (defaults applied) [GH-90000]")
    void executeAgent_withEmptyBody_returns200() throws Exception { // GH-90000
        ...
        assertThat(resp.statusCode()).isEqualTo(200); // GH-90000
        Map<?, ?> body = mapper.readValue(resp.body(), Map.class); // GH-90000
        assertThat(body.get("agentId [GH-90000]")).isEqualTo("agent-007 [GH-90000]");
    }

    // ==================== GET /api/v1/agents/:agentId/memory ====================

    @Test
    @DisplayName("getAgentMemory: DC returns mixed-type items → 200 with byType counts [GH-90000]")
    void getAgentMemory_withMixedTypes_returns200WithCounts() throws Exception { // GH-90000
        ...
        when(mockDc.query(anyString(), eq("dc_memory [GH-90000]"), any(DataCloudClient.Query.class)))
        ...
        HttpResponse<String> resp = get("/api/v1/agents/agent-1/memory [GH-90000]");

        assertThat(resp.statusCode()).isEqualTo(200); // GH-90000
        Map<?, ?> body = mapper.readValue(resp.body(), Map.class); // GH-90000
        assertThat(body.get("agentId [GH-90000]")).isEqualTo("agent-1 [GH-90000]");
        assertThat(((Number) body.get("total [GH-90000]")).intValue()).isEqualTo(4);

        Map<?, ?> byType = (Map<?, ?>) body.get("byType [GH-90000]");
        assertThat(((Number) byType.get("episodic [GH-90000]")).intValue()).isEqualTo(2);
    ...
    @Test
    @DisplayName("getAgentMemory: DC returns empty list → 200 with all-zero counts [GH-90000]")
    void getAgentMemory_withNoItems_returns200WithZeroCounts() throws Exception { // GH-90000
        ...
        HttpResponse<String> resp = get("/api/v1/agents/agent-empty/memory [GH-90000]");
    ...
    @Test
    @DisplayName("getAgentMemory: no DataCloudClient → 503 service unavailable [GH-90000]")

 ...
 * @doc.pattern Test
 */
@DisplayName("Aep audit remediations [GH-90000]")
class AepRemediationTest extends EventloopTestBase {
    ...
    @Nested
    @DisplayName("Pattern matching [GH-90000]")
    class PatternMatchingTests {

        @Test
        @DisplayName("process() applies threshold pattern matching [GH-90000]")
        ...
        @Test
        @DisplayName("process() completes a configured sequence pattern [GH-90000]")
        void shouldDetectSequencePattern() { // GH-90000
            ...
            assertThat(result.detections()).hasSize(1); // GH-90000
            assertThat(result.detections().get(0).patternName()).isEqualTo("Login then purchase [GH-90000]");
        }
    }
    ...
    @Nested
    @DisplayName("Consent and identity [GH-90000]")
    class ConsentAndIdentityTests {

        @Test
        @DisplayName("process() rejects events with denied consent [GH-90000]")
        void shouldSkipDeniedConsent() { // GH-90000
            ...
            AepEngine.ProcessingResult result = runPromise(() -> engine.process( // GH-90000
                ...
                new AepEngine.Event( // GH-90000
                    "profile.update",
                    Map.of("consentStatus", "DENIED", "allowedPurposes", List.of("event_processing [GH-90000]")),
                    Map.of(), // GH-90000
        ...
        @Test
        @DisplayName("process() derives stitched identity from headers and payload [GH-90000]")
    ...
    @Nested
    @DisplayName("Anomaly detection [GH-90000]")
    class AnomalyDetectionTests {

        @Test
        @DisplayName("detectAnomalies() honors configurable anomaly threshold [GH-90000]")
        ...
        @Test
        @DisplayName("detectAnomalies() ignores events below threshold [GH-90000]")
        ...
        @Test
        @DisplayName("detectAnomalies() uses model-backed scoring for numeric series without explicit score [GH-90000]")
        void shouldUseModelBackedScoringForNumericSeries() { // GH-90000
            ...
            assertThat(anomalies).hasSize(1); // GH-90000
            assertThat(anomalies.get(0).anomalyType()).isEqualTo("MODEL_DETECTED [GH-90000]");
    ...
    @Nested
    @DisplayName("Event schema validation (AEP-002) [GH-90000]")
    class SchemaValidationTests {

        @Test
        @DisplayName("EventSchemaValidator rejects null event [GH-90000]")
        void shouldRejectNullEvent() { // GH-90000
            ...
            assertThat(result.firstError()).contains("null [GH-90000]");
            ...
            assertThat(result.firstDetail().field()).isEqualTo("event [GH-90000]");
        }

        @Test
        @DisplayName("EventSchemaValidator rejects event with oversized type [GH-90000]")
        void shouldRejectOversizedType() { // GH-90000
            ...
            assertThat(result.isValid()).isFalse(); // GH-90000
            assertThat(result.summary()).contains("maximum length [GH-90000]");
            ...
            assertThat(result.details()) // GH-90000
                .anySatisfy(detail -> { // GH-90000
                    assertThat(detail.field()).isEqualTo("event.type [GH-90000]");
                    assertThat(detail.code()).isEqualTo(EventSchemaValidator.ErrorCode.SIZE_EXCEEDED); // GH-90000
                });
        }

        @Test
        @DisplayName("EventSchemaValidator accepts a well-formed event [GH-90000]")
        ...
        @Test
        @DisplayName("process() short-circuits on invalid event schema [GH-90000]")
    ...
    @Nested
    @DisplayName("Configuration validation (AEP-004) [GH-90000]")
    class ConfigValidationTests {

        @Test
        @DisplayName("Aep.create() throws on zero anomalyThreshold [GH-90000]")
        ...
        @Test
        @DisplayName("Aep.create() throws when maxPipelinesPerTenant exceeds 10 000 [GH-90000]")
        ...
        @Test
        @DisplayName("Aep.create() uses configured consent provider when available [GH-90000]")
        void shouldUseConfiguredConsentProvider() { // GH-90000
            AepEngine eng = Aep.create(Aep.AepConfig.builder() // GH-90000
                .consentProvider("deny-all-test [GH-90000]")
                .build()); // GH-90000
            try {
        ...
        @Test
        @DisplayName("Aep.create() falls back to default consent provider when configured provider is missing [GH-90000]")
        void shouldFallbackWhenConsentProviderMissing() { // GH-90000
            AepEngine eng = Aep.create(Aep.AepConfig.builder() // GH-90000
                .consentProvider("missing-provider [GH-90000]")
                .build()); // GH-90000
            try {
                AepEngine.ProcessingResult result = runPromise(() -> eng.process( // GH-90000
                    TENANT_ID,
    ...
    @Nested
    @DisplayName("Event versioning (ECR-003) [GH-90000]")
    class EventVersioningTests {

        @Test
        @DisplayName("Event defaults to version 1.0 when not specified [GH-90000]")
        ...
        @Test
        @DisplayName("withVersion() creates a copy with the specified version [GH-90000]")
        void shouldUpdateVersionWithCopy() { // GH-90000
            AepEngine.Event v1 = AepEngine.Event.of("test.event", Map.of()); // GH-90000
            AepEngine.Event v2 = v1.withVersion("2.0 [GH-90000]");

            assertThat(v1.version()).isEqualTo("1.0 [GH-90000]");
            assertThat(v2.version()).isEqualTo("2.0 [GH-90000]");
            assertThat(v2.type()).isEqualTo(v1.type()); // GH-90000
        }

        @Test
        @DisplayName("Event.of() factory also defaults to version 1.0 [GH-90000]")
        void factoryShouldDefaultToVersion1() { // GH-90000
            ...
            assertThat(event.version()).isEqualTo("1.0 [GH-90000]");
        }

        @Test
        @DisplayName("Validator accepts events with non-default version [GH-90000]")
        void shouldAcceptNonDefaultVersion() { // GH-90000
            EventSchemaValidator validator = new EventSchemaValidator(); // GH-90000
            AepEngine.Event v2Event = AepEngine.Event.of("payment.received", Map.of()) // GH-90000
                .withVersion("2.0 [GH-90000]");
            EventSchemaValidator.ValidationResult result = validator.validate(v2Event); // GH-90000
            assertThat(result.isValid()).isTrue(); // GH-90000
        }

        @Test
        @DisplayName("process() succeeds with versioned event [GH-90000]")

 ...
 *
 * @doc.type class
 * @doc.purpose PipelineRegistration domain model with structured and legacy config support
 * @doc.layer product
...
public class PipelineRegistration {
    ...
    /**
     * PipelineRegistration stages/steps (NEW - preferred).
     */
    @Builder.Default
     ...
     */
    public static PipelineRegistration withId(String id) {
        PipelineRegistration pipeline = new PipelineRegistration();
        pipeline.setId(id);
        return pipeline;
    }
     ...
     */
    public static PipelineRegistration create(String name, TenantId tenantId) {
        PipelineRegistration pipeline = new PipelineRegistration();
     ...
     */
    public PipelineRegistration newVersion() {
        PipelineRegistration newPipeline = new PipelineRegistration();
     ...
     */
    public void updateFrom(PipelineRegistration update) {

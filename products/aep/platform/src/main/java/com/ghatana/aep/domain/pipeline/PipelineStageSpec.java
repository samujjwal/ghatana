 ...
 * representing a logical grouping of agents that execute together on the same
 * data.
 *
 * <h2>Purpose</h2>
 ...
 * <ul>
 * <li><b>name</b>: Human-readable stage identifier (e.g., "validation",
 * "enrichment")</li>
 * <li><b>workflow</b>: List of agents comprising this stage</li>
 * <li>All agents in workflow receive same input events</li>
 * <li>Agents may process sequentially or in parallel (orchestrator
 * decides)</li>
 ...
 * <tr><td>ingestion</td><td>Receive external data</td><td>KafkaIngestionAgent,
 * HTTPListenerAgent</td></tr>
 * <tr><td>validation</td><td>Check data against
 * schema</td><td>SchemaValidatorAgent, TypeValidatorAgent</td></tr>
 * <tr><td>transformation</td><td>Convert data format</td><td>MapperAgent,
 * NormalizerAgent</td></tr>
 * <tr><td>enrichment</td><td>Add context/metadata</td><td>EnricherAgent,
 * LookupAgent</td></tr>
 * <tr><td>analysis</td><td>Extract insights</td><td>AnalyzerAgent,
 * AggregatorAgent</td></tr>
 * <tr><td>persistence</td><td>Store processed data</td><td>DatabaseWriterAgent,
 * CacheAgent</td></tr>
 * </table>
 *
 ...
 * @doc.test-hints stage-composition, workflow-execution, agent-sequencing,
 * parallel-processing
 */
@Data
@NoArgsConstructor
...
public class PipelineStageSpec {
    ...
    /**
     * Optional list of connector IDs referenced by this stage. Connectors
     * provide source/sink operations for event ingress/egress. Each ID must
     * match a registered connector in the OperatorCatalog.
     */
    @JsonProperty("connectorIds")
    private List<String> connectorIds;

    /**
     * Optional list of inline connector specifications. Enables embedding
     * connector definitions directly in pipeline spec. Inline specs are
     * preferred when connectors are pipeline-specific.
     */
    @JsonProperty("connectors")
    private List<ConnectorSpec> connectors;

    /**
     * Type of stage (STREAM, PATTERN, CONNECTOR). Defaults to STREAM for
     * general processing stages. Set to CONNECTOR when stage uses source/sink
     * connectors.
     */

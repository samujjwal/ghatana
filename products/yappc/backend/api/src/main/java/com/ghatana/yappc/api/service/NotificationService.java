...
public class NotificationService {
  ...
  public Promise<Notification> createNotification(String tenantId, CreateNotificationInput input) {
    ...
    notification.setPriority(
        input.priority() != null ? input.priority() : NotificationPriority.NORMAL);
  ...
  public Promise<List<Notification>> notifyUsers(
      String tenantId, List<String> userIds, NotifyUsersInput input) {
    if (userIds.isEmpty()) {
    ...
    for (String userId : userIds) {
      CreateNotificationInput notifInput =
  ...
  public Promise<List<Notification>> notifySprintStarted(
    ...
    NotifyUsersInput input =
        new NotifyUsersInput(
  ...
  private NotificationCategory determineCategory(NotificationType type) {
    return switch (type) {
      ...
      case REVIEW_REQUESTED, REVIEW_APPROVED, REVIEW_CHANGES_REQUESTED, REVIEW_COMMENT, PR_MERGED ->

 ...
 * which honours {@code DC_DEPLOYMENT_MODE}, {@code DC_SERVER_URL}, and {@code DC_CLUSTER_URLS}
 * environment variables (see {@code DataCloudEnvConfig}).
 *
 ...
 * </pre>
 *
 * <p>Install this module in {@code ProductionModule} and {@code DevelopmentModule} via {@code
...
public class DataCloudModule extends AbstractModule {
   ...
   *
   * <p>Uses {@link DataCloudClientFactory#fromEnvironment()} which validates configuration and
   * selects the correct client strategy (embedded / standalone / distributed).
   *

 ...
 *
 * <p>A permission consists of: - A path pattern (supports wildcards and /** suffix) - A list of
 * allowed HTTP methods - An optional description
 *
 * @doc.type class
...
public class Permission {
  ...
  public Permission(
      @NotNull String pathPattern, @NotNull List<String> methods, @NotNull String description) {
  ...
  public boolean equals(Object o) {
    ...
    return pathPattern.equals(that.pathPattern) && methods.equals(that.methods);
  }
  ...
  public static Permission crud(@NotNull String pathPattern) {
    return new Permission(
        pathPattern, List.of("GET", "POST", "PUT", "PATCH", "DELETE", "HEAD", "OPTIONS"));
  }
}

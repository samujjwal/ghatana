 ...
 *
 * <p>Provides methods for common response types: - Success responses (200, 201) - Error responses
 * (400, 401, 403, 404, 409, 500) - JSON payload generation
 *
 * @doc.type class
...
public final class HttpResponseFactory {
  ...
  private static HttpResponse errorResponse(
      int status, @NotNull String errorType, @NotNull String message) {
  ...
  /**
   * Converts a Map to JSON string (simplified implementation). In production, use a proper JSON

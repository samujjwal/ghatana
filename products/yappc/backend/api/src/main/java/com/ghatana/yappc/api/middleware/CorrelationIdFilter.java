 ...
 *
 * <ol>
 *   <li>Reads the {@code X-Correlation-ID} request header.
 *   <li>If absent, generates a new random UUID.
 *   <li>Stores the correlation ID in the SLF4J {@link MDC} under key {@code correlationId} for the
 *       lifetime of the request handler.
 *   <li>Appends {@code X-Correlation-ID} to the response so callers can trace the request
 *       end-to-end.
 * </ol>
 *
 * <h2>Usage</h2>

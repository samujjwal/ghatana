...
public class PresenceManager {
  ...
  public void userConnected(
      String tenantId, String userId, String sessionId, Map<String, Object> metadata) {
  ...
  public void updateStatus(
      String tenantId, String userId, String status, Map<String, Object> metadata) {
    Map<String, PresenceInfo> tenantPresence = presenceByTenant.get(tenantId);
    if (tenantPresence != null) {
  ...
  public void updateCursor(
      String tenantId, String userId, String sessionId, Map<String, Object> cursor) {
    Map<String, PresenceInfo> tenantPresence = presenceByTenant.get(tenantId);
    if (tenantPresence != null) {
      PresenceInfo presence = tenantPresence.get(userId);
  ...
  public List<Map<String, Object>> getOnlineUsers(String tenantId) {
    ...
    return tenantPresence.values().stream().map(PresenceInfo::toMap).collect(Collectors.toList());
  }

...
public class HealthAggregationController {
   ...
   *
   * <p>This endpoint is intentionally <em>not</em> auth-gated so that load balancers and monitoring
   * agents can reach it without credentials.
   */

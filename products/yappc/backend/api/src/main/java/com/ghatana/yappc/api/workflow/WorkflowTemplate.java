 ...
 *
 * <p>Templates are loaded from {@code lifecycle-workflow-templates.yaml} at runtime by {@link
 * WorkflowMaterializer}. Each template is converted into a list of {@link
 * com.ghatana.platform.workflow.engine.DurableWorkflowEngine.StepDefinition}s and registered in the
 * workflow registry.
 *
 * @doc.type class
...
public final class WorkflowTemplate {
  ...
  public List<WorkflowStepTemplate> getSteps() {
    return steps;
  }

  @Override
  public String toString() {
    return "WorkflowTemplate{id='" + id + "', name='" + name + "', steps=" + steps.size() + "}";
  }
}

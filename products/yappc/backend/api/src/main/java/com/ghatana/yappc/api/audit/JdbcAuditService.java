 ...
 *
 * <p>All SQL operations are executed on a dedicated blocking executor and wrapped with {@code
 * Promise.ofBlocking} so the ActiveJ event-loop thread is never blocked.
 *
...
public class JdbcAuditService implements AuditService, AuditQueryService {
  ...
  public JdbcAuditService(@NotNull DataSource dataSource, @NotNull ObjectMapper objectMapper) {
    ...
    return Promise.ofBlocking(
        ...
        () -> {
          try (Connection conn = dataSource.getConnection();
            ...
            ps.executeUpdate();
            log.debug(
                "Recorded audit event id={} tenant={} type={}",
                event.getId(),
                event.getTenantId(),
                event.getEventType());
          }
  ...
  @Override
  public Promise<List<AuditEvent>> findByTenantId(@NotNull String tenantId, int offset, int limit) {
    return Promise.ofBlocking(
        JDBC_EXECUTOR,
        () -> {
          try (Connection conn = dataSource.getConnection();
  ...
  public Promise<List<AuditEvent>> findByResource(
      @NotNull String tenantId, @NotNull String resourceType, @NotNull String resourceId) {
    return Promise.ofBlocking(
        JDBC_EXECUTOR,
        () -> {
          try (Connection conn = dataSource.getConnection();
  ...
  @Override
  public Promise<List<AuditEvent>> findByPrincipal(
      @NotNull String tenantId, @NotNull String principal) {
    return Promise.ofBlocking(
        JDBC_EXECUTOR,
        () -> {
          try (Connection conn = dataSource.getConnection();
  ...
  @Override
  public Promise<List<AuditEvent>> findByEventType(
      @NotNull String tenantId, @NotNull String eventType) {
    return Promise.ofBlocking(
        JDBC_EXECUTOR,
        () -> {
          try (Connection conn = dataSource.getConnection();
  ...
  @Override
  public Promise<List<AuditEvent>> findByTimeRange(
      @NotNull String tenantId, @NotNull Instant from, @NotNull Instant to) {
    return Promise.ofBlocking(
        JDBC_EXECUTOR,
        () -> {
          try (Connection conn = dataSource.getConnection();
  ...
  @Override
  public Promise<Optional<AuditEvent>> findById(@NotNull String tenantId, @NotNull String eventId) {
    return Promise.ofBlocking(
        JDBC_EXECUTOR,
        () -> {
          try (Connection conn = dataSource.getConnection();
  ...
  public Promise<List<AuditEvent>> search(
      @NotNull String tenantId, AuditQueryService.AuditSearchCriteria criteria) {

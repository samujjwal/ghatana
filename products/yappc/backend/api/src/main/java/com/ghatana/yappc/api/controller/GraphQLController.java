 ...
 *
 * <p>Delegates data fetching to domain-specific resolver classes ({@link WorkspaceResolver}, {@link
 * CollaborationResolver}) to keep this controller focused on schema wiring and HTTP transport.
 *
 * @doc.type class
...
public class GraphQLController {
  ...
  private GraphQL initGraphQL(
      WorkspaceResolver workspaceResolver, CollaborationResolver collaborationResolver) {
            ...
            $ -> {
              try {
                ...
                Map<String, Object> json =
                    objectMapper.readValue(bodyString, new TypeReference<>() {});
                ...
                ExecutionInput executionInput =
                    ExecutionInput.newExecutionInput()
                        ...
                        .graphQLContext(
                            contextBuilder ->
                                contextBuilder.of(
                                    "requestContext", TenantContextExtractor.extract(request)))
                        .build();

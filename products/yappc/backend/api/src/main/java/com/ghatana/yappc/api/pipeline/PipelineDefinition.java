 ...
 *
 * <p>Models the {@code ghatana.aep/v1 Pipeline} manifest format used in {@code
 * products/yappc/config/pipelines/*.yaml}.
 *
...
public final class PipelineDefinition {
  ...
  public PipelineDefinition(
    ...
    this.outputs =
        outputs != null ? Collections.unmodifiableList(outputs) : Collections.emptyList();
    this.operators =
        operators != null ? Collections.unmodifiableList(operators) : Collections.emptyList();
  }
  ...
  public String toString() {
    return "PipelineDefinition{name='"
        + name
        + "', version='"
        + version
        + "', operators="

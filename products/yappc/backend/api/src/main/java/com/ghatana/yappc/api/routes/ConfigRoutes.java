 ...
 *
 * <ul>
 *   <li>/api/config/* - domains, workflows, lifecycle, agents, tasks, personas</li>
 *   <li>/api/dashboards/* - dashboard retrieval by id/domain</li>
 *   <li>/api/rail/* - unified left rail (components, infra, files, history, favourites)</li>
 * </ul>
 *
 * @doc.type class
...
public final class ConfigRoutes {
  ...
  public static void register(
    ...
    builder
        ...
        .with(GET, "/api/config/personas/:id",
            request -> {
              String id = request.getPathParameter("id");
        ...
        .with(GET, "/api/dashboards/domain/:domainId", request -> dashCtrl.getDashboardsByDomain(request))

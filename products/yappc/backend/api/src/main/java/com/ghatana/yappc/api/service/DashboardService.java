 ...
 *
 * <p>Dashboards are persona-aware views that combine widgets and actions for specific domains and
 * user levels.
 *
 * @doc.type class
...
public class DashboardService {
        ...
        new Dashboard(
            ...
            List.of(
                new Action(
                    ...
                    "Create PR",
                    "code.write",
                    Map.of("presentation", "drawer"),
                    Map.of("kind", "mutation", "operationName", "createPullRequest"))),
        ...
        new Dashboard(
            ...
            List.of(
                new Action(
                    ...
                    "Deploy",
                    "deploy.execute",
                    Map.of("presentation", "modal"),
                    Map.of("kind", "Job", "operationName", "triggerDeployment"))),
        ...
        new Dashboard(
            ...
            List.of(
                new Action(
                    ...
                    "Run Scan",
                    "security.scan",
                    Map.of("presentation", "inline"),
                    Map.of("kind", "Job", "operationName", "triggerSecurityScan"))),
        ...
        new Dashboard(
            ...
            List.of(
                new Action(
                    ...
                    "test.execute",
                    Map.of("presentation", "inline"),
                    Map.of("kind", "Job", "operationName", "triggerTestRun"))),
        ...
        new Dashboard(
            ...
            List.of(
                new Action(
                    ...
                    "New Requirement",
                    "requirements.define",
                    Map.of("presentation", "wizard"),
                    Map.of("kind", "Flow", "flowId", "product.requirement"))),
            Map.of(
                "levels", List.of(3, 4), "personas", List.of("product-manager", "product-owner"))));
  ...
  public Promise<List<Dashboard>> getDashboardsByDomain(String domainId) {
    List<Dashboard> filtered =
        dashboardCache.values().stream().filter(d -> d.domainId().equals(domainId)).toList();
  ...
  public record Widget(String id, String type, String title, Map<String, Object> dataBinding) {}

            ...
            .then(
                ctx -> {
                  ...
                  CreateAssessmentInput input =
                      objectMapper.readValue(body, CreateAssessmentInput.class);
                  return complianceService
                      .createAssessment(workspaceId, input)
        ...
        TenantContextExtractor.requireAuthenticated(request)
            .then(
                ctx -> {
                  ...
                  return complianceService
                      .getAssessment(workspaceId, id)
                      .map(
                          opt ->
                              opt.map(ApiResponse::ok)
                                  .orElse(ApiResponse.notFound("Assessment not found")));
                }));
  }
        ...
        TenantContextExtractor.requireAuthenticated(request)
            .then(
                ctx -> {
                  ...
                  return complianceService
                      .listProjectAssessments(workspaceId, projectId)
                      .map(ApiResponse::ok);
                }));
  }
        ...
        TenantContextExtractor.requireAuthenticated(request)
            .then(
                ctx -> {
                  ...
                  return complianceService
                      .startAssessment(workspaceId, id, assessorName)
                      .map(ApiResponse::ok);
                }));
  }
            ...
            .then(
                ctx -> {
                  ...
                  CompleteAssessmentInput input =
                      objectMapper.readValue(body, CompleteAssessmentInput.class);
                  return complianceService
                      .completeAssessment(workspaceId, id, input)
                      .map(ApiResponse::ok);
                }));
  }
        ...
        TenantContextExtractor.requireAuthenticated(request)
            .then(
                ctx -> {
                  ...
                  UUID projectId = UUID.fromString(request.getPathParameter("projectId"));
                  return complianceService
                      .getComplianceStatistics(workspaceId, projectId)
                      .map(ApiResponse::ok);
                }));
  }
        ...
        TenantContextExtractor.requireAuthenticated(request)
            .then(
                ctx -> {
                  ...
                  UUID id = UUID.fromString(request.getPathParameter("id"));
                  return complianceService
                      .deleteAssessment(workspaceId, id)

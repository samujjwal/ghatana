 ...
 *
 * <ul>
 *   <li>/api/agents/* - workflow agent execution and catalog
 *   <li>/api/v1/codegen/* - code generation from OpenAPI/GraphQL/schema
 *   <li>/api/v1/testing/* - test generation and coverage analysis
 *   <li>/api/v1/agents/{agentId}/history - agent history and decision rationale
 *   <li>/api/v1/agents/{agentId}/policies - learned policies
 * </ul>
 *
 * @doc.type class

...
class SimpleJwtTokenProviderTest extends EventloopTestBase {
  ...
  private static final String SECRET_KEY =
      "test-secret-key-for-jwt-signing-must-be-long-enough-for-hmac-sha512";
  ...
  void setUp() {
    ...
    testUser =
        new UserContext.Builder()
            .userId("user123")
            .email("test@ghatana.com")
            .userName("Test User")
            .tenantId("tenant123")
            .roles(List.of("user", "admin"))
            .permissions(List.of(new Permission("/api/**", List.of("GET", "POST"), "Full access")))
            .build();
  }

 ...
 *
 * <ul>
 *   <li>9.2.4 — Store episode with email field → retrieve → email redacted by filter
 *   <li>9.2.2 — Cross-tenant read and write rejected by TenantIsolatedMemorySecurityManager
 * </ul>
 *
 * @doc.type class

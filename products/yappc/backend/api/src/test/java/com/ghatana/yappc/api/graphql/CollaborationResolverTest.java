 ...
 * YAPPC API Module — CollaborationResolver Tests
 */
...
class CollaborationResolverTest extends EventloopTestBase {
    ...
    class TeamsQuery {
        ...
        void shouldReturnTeamsForOrganization() throws Exception {
            ...
            when(teamRepository.findByOrganization(TENANT, ORG_ID))
                    .thenReturn(Promise.of(List.of(t)));
    ...
    class ChannelsQuery {
        ...
        void shouldReturnChannelsForTeam() throws Exception {
            ...
            when(channelRepository.findByTeamId(TENANT, TEAM_ID))
                    .thenReturn(Promise.of(List.of(c)));
    ...
    class ChannelQuery {
        ...
        void shouldReturnChannelWhenFound() throws Exception {
            ...
            c.setId(CHANNEL_ID);
            when(channelRepository.findById(TENANT, CHANNEL_ID))
                    .thenReturn(Promise.of(Optional.of(c)));

 ...
 * YAPPC API Module — WorkspaceResolver Tests
 */
 ...
 *
 * <p>Covers the workspaces, workspace, and createWorkspace data fetchers.
 * Each fetcher is invoked directly via {@link DataFetcher#get(DataFetchingEnvironment)}
...
class WorkspaceResolverTest extends EventloopTestBase {
    ...
    class WorkspacesQuery {
        ...
        void shouldReturnListForTenant() throws Exception {
            ...
            when(workspaceRepository.findByTenantId(TENANT))
                    .thenReturn(Promise.of(List.of(w)));
    ...
    /**
     * Construct a mock DataFetchingEnvironment responding to the arguments used
     * by WorkspaceResolver. Supply {@code null} for unused arguments.
     */

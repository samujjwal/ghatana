...
class PipelineDefinitionTest {
  ...
  class Construction {
    ...
    void validNameStored() {
      PipelineDefinition def =
          new PipelineDefinition("my-pipeline", null, null, null, null, null, null);
  ...
  class Defaults {
    ...
    void nullVersionDefaultsTo100() {
      PipelineDefinition def = new PipelineDefinition("p", null, null, null, null, null, null);
    ...
    void nullDescriptionDefaultsToEmpty() {
      PipelineDefinition def = new PipelineDefinition("p", "1.0.0", null, null, null, null, null);
    ...
    void nullTagsDefaultToEmpty() {
      PipelineDefinition def = new PipelineDefinition("p", "1.0.0", "desc", null, null, null, null);
    ...
    void nullInputsDefaultToEmpty() {
      PipelineDefinition def =
          new PipelineDefinition("p", "1.0.0", "desc", List.of(), null, null, null);
    ...
    void nullOutputsDefaultToEmpty() {
      PipelineDefinition def =
          new PipelineDefinition("p", "1.0.0", "desc", List.of(), List.of(), null, null);
    ...
    void nullOperatorsDefaultToEmpty() {
      PipelineDefinition def =
          new PipelineDefinition("p", "1.0.0", "desc", List.of(), List.of(), List.of(), null);
  ...
  class Immutability {
    ...
    void tagsListIsUnmodifiable() {
      PipelineDefinition def =
          new PipelineDefinition("p", "1.0.0", "", List.of("tag1"), null, null, null);
    ...
    void operatorsListIsUnmodifiable() {
      PipelineDefinition def =
          new PipelineDefinition(
              "p", "1.0.0", "", null, null, null, List.of(Map.of("type", "transform")));

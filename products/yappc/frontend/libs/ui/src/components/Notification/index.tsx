...
export function Notification({
  ...
  }, [autoClose, duration, notification.id, notification.type, onClose]);
  ...
  return (
    <div
      className={clsx(
        'max-w-sm w-full border rounded-lg shadow-lg pointer-events-auto ring-1 ring-black ring-opacity-5 transform transition-all duration-300',
    ...
    >
      <div className="p-4">
        <div className="flex items-start">
          <div className={clsx('flex-shrink-0', iconClasses[notification.type])}>
                ...
                {notification.actions.map((action, index) => (
                  <button
                    ...
                    className={clsx(
                      ...
                      (!action.variant || action.variant === 'secondary') && 'text-gray-600'
                    )}
                  >
                    {action.label}
                  </button>

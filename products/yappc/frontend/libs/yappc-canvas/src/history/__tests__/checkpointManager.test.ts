...
describe('checkpointManager', () => {
  ...
  describe('Actor Management', () => {
    ...
    it('should record actions with updated actor', () => {
      setActor(state, 'user2', 'Bob');
      const action = recordAction(state, 'create', 'Created node', {
        nodeId: 'n1',
      });
  ...
  describe('Conflict Detection', () => {
    ...
    it('should resolve conflict with force strategy', () => {
      ...
      const resolved = resolveConflict(state, conflictId, {
        strategy: 'force',
      });
    ...
    it('should clear resolved conflicts', () => {
      ...
      const result = undo(state, {});
      resolveConflict(state, result.conflict!.conflictId, {
        strategy: 'cancel',
      });
  ...
  describe('Checkpoints', () => {
    ...
    it('should create checkpoint', () => {
      const checkpoint = createCheckpoint(state, 'My Checkpoint', {
        data: 'test',
      });
    ...
    it('should create checkpoint with auto name', () => {
      const checkpoint = createCheckpoint(state, '', {}, { autoName: true });

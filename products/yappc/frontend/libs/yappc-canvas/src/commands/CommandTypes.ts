 ...
 */
export type CommandListener = (command: Command, result: CommandResult) => void;
 ...
 */
export function isInsertNodePayload(
  payload: unknown
): payload is InsertNodePayload {
  return (
 ...
 */
export function isDeleteNodePayload(
  payload: unknown
): payload is DeleteNodePayload {
  return (
    typeof payload === 'object' &&
    payload !== null &&
    'nodeId' in payload &&
 ...
 */
export function isBatchCommandPayload(
  payload: unknown
): payload is BatchCommandPayload {
  return (
    typeof payload === 'object' &&
    payload !== null &&
    'commands' in payload &&

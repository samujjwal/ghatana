          ...
          {Array.from(groupedArtifacts.keys()).map((category) => (
            <button
              ...
              style={{
                ...
                justifyContent: 'center',
                backgroundColor:
                  activeCategory === category ? '#e0e7ff' : 'transparent',
                border: 'none',
                borderRadius: 4,
                cursor: 'pointer',
                fontSize: 16,
            ...
            onClick={() =>
              onCategoryChange?.(
                activeModality === modality
                  ? undefined
                  : (modality as ContentModality as unknown)
              )
            }
            style={{
              padding: '4px 8px',
              backgroundColor:
                activeModality === modality ? '#e0e7ff' : '#ffffff',
    ...
    return (
      ...
      >
        {contract.identity.icon && (
          <span style={{ marginRight: 4 }}>{contract.identity.icon}</span>
        )}

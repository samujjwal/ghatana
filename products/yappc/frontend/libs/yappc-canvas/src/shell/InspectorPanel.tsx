...
export const InspectorPanel: React.FC<InspectorPanelProps> = ({
  ...
  const mergedProps = useMemo((): Record<
    string,
  ...
  const mergedStyles = useMemo((): Record<
    string,
    { value: unknown; mixed: boolean }
  > => {
    if (selectedNodes.length === 0) return {};
  ...
  return (
    ...
    >
      ...
      >
        <h3
          style={{ margin: 0, fontSize: 14, fontWeight: 600, color: '#1e293b' }}
        >
  ...
  const groups = useMemo((): FieldGroup[] => {
    if (!contract?.propsSchema) {
      ...
      return [
        {
          label: 'Properties',
          fields: Object.entries(mergedProps).map(
            ([key, { value, mixed }]) => ({
              key,
...
const StyleTab: React.FC<StyleTabProps> = ({
  ...
  const groups = useMemo((): FieldGroup[] => {
    const commonStyles = [
      ...
      {
        key: 'fontWeight',
        schema: { type: 'select', options: ['normal', 'bold', '500', '600'] },
        group: 'typography',
      },
      { key: 'color', schema: { type: 'color' }, group: 'typography' },
      {
        key: 'textAlign',
        schema: { type: 'select', options: ['left', 'center', 'right'] },
        group: 'typography',
      },
    ];
    ...
    <div>
        ...
        >
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onStyleChange('transform.x', parseFloat(e.target.value))
              }
              style={{
                width: '100%',
                padding: 8,
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onStyleChange('transform.y', parseFloat(e.target.value))
              }
              style={{
                width: '100%',
                padding: 8,
        ...
        >
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onStyleChange('transform.width', parseFloat(e.target.value))
              }
              style={{
                width: '100%',
                padding: 8,
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onStyleChange('transform.height', parseFloat(e.target.value))
              }
              style={{
                width: '100%',
                padding: 8,
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <input
          ...
          onChange={(e) =>
            onStyleChange('transform.rotation', parseFloat(e.target.value))
          }
          style={{
            width: '100%',
            padding: 8,
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            onStyleChange('transform.zIndex', parseInt(e.target.value))
          }
          style={{
            width: '100%',
            padding: 8,
        ...
        dataBindings.map((binding) => (
          <div key={binding.property} style={{ marginBottom: 12 }}>
            ...
            <input
              type="text"
              value={
                (mergedProps[`_binding_${binding.property}`]
                  ?.value as string) ?? ''
              }
              onChange={(e) =>
                onPropertyChange(`_binding_${binding.property}`, e.target.value)
              }
          ...
          {group.fields.map((field) => (
            <div key={field.key} style={{ marginBottom: 8 }}>
              ...
              >
                ...
                {field.mixed && (
                  <span
                    style={{ marginLeft: 4, color: '#f59e0b', fontSize: 10 }}
                  >
                    (mixed)
                  </span>
                )}

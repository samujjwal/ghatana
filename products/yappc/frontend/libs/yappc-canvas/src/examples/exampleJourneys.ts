...
export const ecommerceProductCatalogJourney = {
  ...
  description:
    'Complete PM → Architect → Developer → QA workflow for product catalog feature',
  ...
  nodes: [
    // ========== PM Phase ==========
    {
      ...
      data: {
        ...
        persona: 'pm',
        prompt:
          'Design a modern product catalog system that supports:\n- Product search and filtering\n- Categories and subcategories\n- Inventory tracking\n- Dynamic pricing\n- Product recommendations',
        status: 'completed',
        aiResponse:
          'Based on your requirements, I recommend a microservice architecture with...',
      } as AIPromptNodeData,
    },
    {
      id: 'pm-requirement-1',
  ...
  edges: [
    ...
    {
      id: 'e1',
      source: 'pm-aiPrompt-1',
      target: 'pm-requirement-1',
      type: 'smoothstep',
      animated: true,
    },
    {
      id: 'e2',
      source: 'pm-aiPrompt-1',
      target: 'pm-requirement-2',
      type: 'smoothstep',
      animated: true,
    },
    {
      id: 'e3',
      source: 'pm-requirement-1',
      target: 'arch-database-1',
      type: 'smoothstep',
      label: 'Data Model',
    },
    {
      id: 'e4',
      source: 'pm-requirement-2',
      target: 'arch-database-1',
      type: 'smoothstep',
      label: 'Schema',
    },
    {
      id: 'e5',
      source: 'arch-database-1',
      target: 'arch-service-1',
      type: 'smoothstep',
    },
  ...
  edges: [
    {
      id: 'e1',
      source: 'pm-req-auth',
      target: 'dev-service-auth',
      type: 'smoothstep',
    },
    {
      id: 'e2',
      source: 'dev-service-auth',
      target: 'dev-api-login',
      type: 'smoothstep',
    },
    {
      id: 'e3',
      source: 'dev-api-login',
      target: 'qa-test-auth',
      type: 'smoothstep',
    },
  ] as Edge[],
...
export const notificationSystemJourney = {
    ...
    // QA Phase
    {
      ...
      data: {
        ...
        tests: [
          ...
          {
            name: 'Push notification batching',
            status: 'passing',
            description: '',
          },
          {
  ...
  edges: [
    {
      id: 'e1',
      source: 'arch-db-notifications',
      target: 'arch-service-notify',
      type: 'smoothstep',
    },
    {
      id: 'e2',
      source: 'arch-service-notify',
      target: 'dev-api-send',
      type: 'smoothstep',
    },
    {

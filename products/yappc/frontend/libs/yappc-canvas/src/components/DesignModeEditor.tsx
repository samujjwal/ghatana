...
export const DesignModeEditor: React.FC<DesignModeEditorProps> = ({
  ...
  return (
    <Paper
      className="fixed flex flex-col top-[50%] left-[50%] w-[90vw] h-[90vh] max-w-[1400px] z-[2000]"
    ...
    >
        ...
        <Box className="flex gap-2">
          ...
          <Tooltip title="Link Mode">
            <IconButton
              ...
              size="sm"
              color={linkMode ? 'primary' : 'default'}
            >
              <LinkIcon />
            </IconButton>
          </Tooltip>
      ...
      <Box className="flex-1 flex overflow-hidden">
          ...
          >
            ...
            {components.map((component) => (
              <Box
                ...
                className="absolute cursor-pointer flex items-center justify-center bg-white dark:bg-gray-900 border-dashed"
                style={{
                  left: component.x * (zoom / 100),
        ...
        {selectedComponentData && (
          <Paper
            className="p-4 overflow-auto w-[300px] border-gray-200 dark:border-gray-700 border-l"
            variant="flat"
          >
            <Box className="mb-4">
              <Box className="flex justify-between items-center mb-4">
                ...
                <IconButton
                  size="sm"
                  onClick={() =>
                    handleDeleteComponent(selectedComponentData.id)
                  }
                >
                  <CloseIcon />
                </IconButton>

            ...
            <AccordionDetails>
              <Stack spacing={2}>
                <TextField
                  ...
                  onChange={(e) =>
                    handleUpdate({ replicas: parseInt(e.target.value) || 1 })
                  }
                  fullWidth
                ...
                <TextField
                  ...
                  value={config.port}
                  onChange={(e) =>
                    handleUpdate({ port: parseInt(e.target.value) || 8080 })
                  }
                  fullWidth
                    ...
                    <TextField
                      ...
                      onChange={(e) =>
                        handleUpdate({
                          autoScaling: {
                            ...config.autoScaling,
                            minReplicas: parseInt(e.target.value) || 2,
                          } as unknown,
                        })
                      }
                      fullWidth
...
export function APIDesignerPanel({
  ...
  const handleUpdate = useCallback(
    (updates: Partial<APIEndpointConfig>) => {
      setConfig({ ...config, ...updates });
    },
    [config]
  );
        ...
        <Stack spacing={3}>
          ...
          <FormControl fullWidth>
            ...
            <Select
              ...
              onChange={(e) =>
                handleUpdate({
                  authentication: e.target
                    .value as APIEndpointConfig['authentication'],
                })
              }

...
import {
  PanelsTopLeft as SplitVerticalIcon,
  ListTodo as SplitHorizontalIcon,
  LayoutDashboard as SingleIcon,
  ChevronLeft as ChevronLeftIcon,
  ChevronRight as ChevronRightIcon,
  AlertCircle as ErrorIcon,
  AlertTriangle as WarningIcon,
  CheckCircle as ValidIcon,
  ArrowLeftRight as DataFlowIcon,
  Code as FrontendIcon,
  HardDrive as BackendIcon,
} from 'lucide-react';
...
export function FullStackModeToggle({
  ...
  return (
    <Paper elevation={4} className="fixed">
      {/* Header */}
      <Box
        display="flex"
        alignItems="center"
      ...
      >
        ...
        <Tooltip title="Layout Options">
          <IconButton size="sm" onClick={(e) => setAnchorEl(e.currentTarget)}>
            {getModeIcon(mode)}
          </IconButton>
        </Tooltip>
      </Box>

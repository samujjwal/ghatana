...
import {
  ...
  type BusinessRule,
  type FlowStep,
} from '../hooks/useRequirementWireframer';
...
export const RequirementWireframer: React.FC<RequirementWireframerProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'elements' | 'rules' | 'flow'>(
    'elements'
  );
          ...
          {parsedStory ? (
            <>
              ...
              <Box className="flex gap-0 border-gray-200 dark:border-gray-700 border-b">
                <Button
                  ...
                  className="rounded-none border-blue-600 px-6"
                  style={{ borderBottom: activeTab === 'elements' ? 2 : 0 }}
                ...
                <Button
                  ...
                  className="rounded-none border-blue-600 px-6"
                  style={{ borderBottom: activeTab === 'flow' ? 2 : 0 }}
              ...
              <Box className="flex-1 overflow-auto p-4">
                  ...
                  >
                    ...
                    {elements.length === 0 && (
                      <Box style={{ gridColumn: '1 / -1' }}>
                        <Alert severity="info">
                          No UI elements yet. Parse a user story to generate
                          wireframe elements.
                        </Alert>
                      </Box>
                    )}
                ...
                {activeTab === 'rules' && (
                  <List>
                    ...
                    {rules.length === 0 && (
                      <Alert severity="info">
                        No business rules found. Add conditional statements to
                        your user story to generate rules.
                      </Alert>
                    )}
                  </List>
                )}
                  ...
                  <Box>
                    ...
                    <Card variant="outlined" className="mb-4">
                      <CardContent>
                          ...
                          <Box className="flex gap-2">
                            ...
                            <Tooltip title="Next Step">
                              <IconButton
                                ...
                                onClick={nextStep}
                                disabled={
                                  simulation.currentStep >= flow.length - 1
                                }
                              >
                                <NextIcon />
                              </IconButton>
                        ...
                        <Stepper
                          activeStep={simulation.currentStep}
                          orientation="vertical"
                        >
                          {flow.map((step, index) => {
                            const element = elements.find(
                              (el) => el.id === step.elementId
                            );
                            return (
                              <Step
                                key={step.id}
                                completed={simulation.completed.has(
                                  step.elementId
                                )}
                              >
                                <StepLabel>
            ...
            <Box className="flex-1 flex items-center justify-center p-8">
              <Alert severity="info" icon={<DescriptionIcon />}>
                ...
                Enter a user story in the left panel and click "Parse Story" to
                begin.
              </Alert>
            </Box>
          )}

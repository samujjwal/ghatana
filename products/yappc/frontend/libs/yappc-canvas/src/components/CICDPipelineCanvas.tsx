...
import {
  ...
  GitBranch as JenkinsIcon,
  Cloud as CircleCIIcon,
} from 'lucide-react';
...
export const CICDPipelineCanvas: React.FC<CICDPipelineCanvasProps> = ({
  ...
  return (
    <Box className="h-full flex flex-col bg-[#fafafa]">
          ...
          <Box>
            <Card>
              <CardContent>
                ...
                {stages.length === 0 ? (
                  <Alert severity="info">
                    No stages defined yet. Click "Add Stage" to build your
                    pipeline.
                  </Alert>
                ) : (
                  <Box className="relative">
                    {/* Pipeline flow line */}
                    <Box className="absolute top-[40px] left-[0px] right-[0px] h-[2px] bg-[#e0e0e0] z-0" />

                    <Stack
                      direction="row"
                      spacing={2}
                      className="relative overflow-x-auto pb-4 z-[1]"
                    >
                          ...
                          >
                            ...
                            <Stack spacing={1}>
                              ...
                              {stage.environmentVariables &&
                                Object.keys(stage.environmentVariables).length >
                                  0 && (
                                  <>
                                    <Divider />
                                    <Box>
        ...
        <DialogContent>
          <Stack spacing={2} className="mt-2">
            ...
            <TextField
              ...
              onChange={(e) =>
                setNewStep({ ...newStep, command: e.target.value })
              }
              fullWidth
              required
            ...
            <TextField
              ...
              onChange={(e) =>
                setNewStep({ ...newStep, workingDirectory: e.target.value })
              }
              fullWidth
              placeholder="./src"
            />
      ...
      <Dialog
        open={addEnvVarDialogOpen}
        onClose={() => setAddEnvVarDialogOpen(false)}
        size="sm"
        fullWidth
      >
      ...
      >
        ...
        <DialogContent>
          <Stack spacing={2}>
            <Alert severity="info">
              Export pipeline configuration for{' '}

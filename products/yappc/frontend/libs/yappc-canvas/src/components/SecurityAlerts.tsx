...
export function SecurityAlerts({
        ...
        >
          ...
          >
            <Box display="flex" alignItems="center" gap={2}>
              <Badge badgeContent={status.totalCount} tone="danger" max={99}>
                <ShieldIcon
                  className="text-[32px]"
                  style={{
                    color:
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <Box className="p-4 flex items-center justify-between bg-red-600 text-white">
          <Box display="flex" alignItems="center" gap={1}>
            <ShieldIcon />
            <Typography as="h6">Security Alerts</Typography>
            <Badge
              badgeContent={totalVulnerabilities}
              tone="warning"
              max={99}
            />
          </Box>
          <Box display="flex" gap={0.5}>
            <Tooltip title="Refresh scan">
              ...
              >
                {scanning ? (
                  <CircularProgress size={20} tone="neutral" />
                ) : (
                  <RefreshIcon />
                )}
              </IconButton>
        ...
        <Box className="p-4">
          ...
          {lastScan && !scanning && (
            <Typography
              as="span"
              className="text-xs text-gray-500 mb-4 block"
            ...
            <Box>
              ...
              {currentFix && !generatingFix && (
                <Box>
                  ...
                  <Paper
                    variant="outlined"
                    className="p-4 mb-4 bg-gray-50 dark:bg-gray-800"
                  >
        ...
        <DialogActions>
          ...
          {currentFix && !generatingFix && (
            <Button
              variant="solid"
              startIcon={
                creatingPR ? <CircularProgress size={16} /> : <GitHubIcon />
              }

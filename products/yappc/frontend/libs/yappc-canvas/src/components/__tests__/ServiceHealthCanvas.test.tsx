...
describe('ServiceHealthCanvas', () => {
  ...
  describe('Alerts Panel', () => {
    ...
    it('should acknowledge alert', async () => {
      ...
      await waitFor(async () => {
        const acknowledgeButton = screen
          .getAllByRole('button')
  ...
  describe('Incident Report', () => {
    it('should generate incident report', async () => {
      mockCreateIncidentReport.mockResolvedValue(
        '# Incident Report\n\nTest report'
      );
  ...
  describe('Positioning', () => {
    it('should render in top-right position', () => {
      const { container } = render(
        <ServiceHealthCanvas position="top-right" />
      );
    ...
    it('should render in bottom-left position', () => {
      const { container } = render(
        <ServiceHealthCanvas position="bottom-left" />
      );

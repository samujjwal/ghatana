...
describe('DataWarehouseCanvas', () => {
  ...
  describe('Rendering', () => {
    it('should render the component with header', () => {
      ...
      expect(
        screen.getByText('Design fact tables, dimensions, and relationships')
      ).toBeInTheDocument();
    });
    ...
    it('should render all tabs', () => {
      ...
      expect(
        screen.getByRole('tab', { name: /etl mappings/i })
      ).toBeInTheDocument();
      expect(
    ...
    it('should render export DDL button', () => {
      ...
      expect(
        screen.getByRole('button', { name: /export ddl/i })
      ).toBeInTheDocument();
    });
    ...
    it('should render auto layout button when star schema enabled and fact table exists', () => {
      ...
      expect(
        screen.getByRole('button', { name: /auto layout/i })
      ).toBeInTheDocument();
    });
    ...
    it('should not render auto layout button when disabled', () => {
      ...
      expect(
        screen.queryByRole('button', { name: /auto layout/i })
  ...
  describe('Tables Tab', () => {
    ...
    it('should display table metadata', () => {
      ...
      // Fact table grain
      expect(
        screen.getByText(/One row per transaction line item/i)
      ).toBeInTheDocument();
  ...
  describe('Add Table Dialog', () => {
    ...
    it('should show SCD type selector for slowly-changing dimensions', async () => {
      ...
      await user.click(screen.getByLabelText(/dimension type/i));
      await user.click(
        screen.getByRole('option', { name: /slowly-changing/i })
      );
  ...
  describe('Add Column Dialog', () => {
    ...
    it('should allow marking column as primary key', async () => {
      ...
      const dimCard = screen
        .getByText('DimCustomer')
        .closest('div[class*="MuiPaper"]') as HTMLElement;
  ...
  describe('Relationships Tab', () => {
    it('should switch to relationships tab', async () => {
      ...
      expect(
        screen.getByText(/Foreign Key Relationships \(1\)/i)
      ).toBeInTheDocument();
    });
    ...
    it('should display all relationships', async () => {
      ...
      expect(
        screen.getByText(/FactSales.customer_id → DimCustomer.customer_id/)
      ).toBeInTheDocument();
    ...
    it('should open add relationship dialog', async () => {
      ...
      expect(screen.getByRole('dialog')).toBeInTheDocument();
      expect(
        screen.getByText('Add Foreign Key Relationship')
      ).toBeInTheDocument();
    });
    ...
    it('should show empty state when no relationships exist', async () => {
      ...
      expect(
        screen.getByText(/No relationships defined yet/i)
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Add Relationship Dialog', () => {
    it('should add relationship with all fields', async () => {
      ...
      await user.click(
        screen.getAllByRole('option', { name: /customer_id/i })[0]
      );
  ...
  describe('ETL Mappings Tab', () => {
    ...
    it('should display all ETL mappings', async () => {
      ...
      expect(
        screen.getByText(/Load Strategy: incremental/i)
      ).toBeInTheDocument();
    });
    ...
    it('should open add ETL mapping dialog', async () => {
      ...
      await user.click(screen.getByRole('tab', { name: /etl mappings/i }));
      await user.click(
        screen.getByRole('button', { name: /add etl mapping/i })
      );
    ...
    it('should show empty state when no mappings exist', async () => {
      ...
      expect(
        screen.getByText(/No ETL mappings defined yet/i)
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Validation Tab', () => {
    ...
    it('should display validation errors when schema is invalid', async () => {
      ...
      vi.mocked(useDataWarehouseHook.useDataWarehouse).mockReturnValue({
        ...
        validateSchema: vi.fn(() => ({
          valid: false,
          errors: [
            'Fact table must have grain defined',
      ...
      expect(
        screen.getByText(/Fact table must have grain defined/i)
      ).toBeInTheDocument();
      expect(
        screen.getByText(/Table X has no primary key/i)
      ).toBeInTheDocument();
    });
    ...
    it('should display validation warnings', async () => {
      ...
      expect(
        screen.getByText(/Large VARCHAR size detected/i)
      ).toBeInTheDocument();
    });
    ...
    it('should display validation errors in header alert', () => {
      ...
      expect(
        screen.getByText(/Schema Validation Errors:/i)
      ).toBeInTheDocument();
  ...
  describe('Export Functionality', () => {
    ...
    it('should export Mermaid diagram', async () => {
      ...
      await user.click(screen.getByLabelText(/export format/i));
      await user.click(
        screen.getByRole('option', { name: /Mermaid ER Diagram/i })
      );
    ...
    it('should support all SQL dialects', async () => {
      ...
      expect(
        screen.getByRole('option', { name: /PostgreSQL DDL/i })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('option', { name: /MySQL DDL/i })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('option', { name: /Snowflake DDL/i })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('option', { name: /BigQuery DDL/i })
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Auto Layout', () => {
    it('should trigger auto layout for star schema', async () => {
      ...
      expect(mockHookReturn.autoLayoutStarSchema).toHaveBeenCalledWith(
        'fact-1'
      );
    });

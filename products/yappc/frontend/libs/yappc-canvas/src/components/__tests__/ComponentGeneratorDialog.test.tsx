  ...
  useComponentGeneration: () => ({
    generateComponent: vi.fn().mockResolvedValue({
      ...
      testFile: {
        ...
        content:
          'describe("TestComponent", () => { it("renders", () => {}); });',
      },
      storyFile: {
...
describe('ComponentGeneratorDialog', () => {
  ...
  describe('Styling Selection', () => {
    ...
    it('should allow changing styling approach', async () => {
      ...
      const cssModulesOption = await screen.findByRole('option', {
        name: /css modules/i,
      });
  ...
  describe('Additional Options', () => {
    it('should display tests checkbox', () => {
      ...
      expect(
        screen.getByRole('checkbox', { name: /include tests/i })
      ).toBeInTheDocument();
    });
    ...
    it('should display storybook checkbox', () => {
      ...
      expect(
        screen.getByRole('checkbox', { name: /include storybook/i })
      ).toBeInTheDocument();
    });
    ...
    it('should display accessibility checkbox', () => {
      ...
      expect(
        screen.getByRole('checkbox', { name: /accessible/i })
      ).toBeInTheDocument();
    });
    ...
    it('should display responsive checkbox', () => {
      ...
      expect(
        screen.getByRole('checkbox', { name: /responsive/i })
      ).toBeInTheDocument();
    });
    ...
    it('should toggle all options independently', async () => {
      ...
      const testsCheckbox = screen.getByRole('checkbox', {
        name: /include tests/i,
      });
      const storybookCheckbox = screen.getByRole('checkbox', {
        name: /include storybook/i,
      });
      const a11yCheckbox = screen.getByRole('checkbox', {
        name: /accessible/i,
      });
  ...
  describe('Props Management', () => {
    ...
    it('should display add prop button', () => {
      ...
      expect(
        screen.getByRole('button', { name: /add prop/i })
      ).toBeInTheDocument();
    });
  ...
  describe('Preview Display', () => {
    it('should show code preview after generation', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/export function TestComponent/i)
        ).toBeInTheDocument();
      });
    });
    ...
    it('should display syntax highlighted code', async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByRole('region', { name: /code/i })
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe('Generated Files List', () => {
    it('should list all generated files', async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText(/TestComponent.stories.tsx/i)
        ).toBeInTheDocument();
      });
    });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle all screen types', () => {
      const screenTypes: UIScreenNodeData['screenType'][] = [
        'view',
        'edit',
        'list',
        'detail',

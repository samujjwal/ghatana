...
describe('DesignModeEditor', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should initialize with existing components', () => {
      ...
      render(
        <DesignModeEditor node={nodeWithComponents} onClose={mockOnClose} />
      );
    ...
    it('should initialize with existing prototype links', () => {
      ...
      render(<DesignModeEditor node={nodeWithLinks} onClose={mockOnClose} />);

      expect(screen.getByText('Links: 1')).toBeInTheDocument();
    });

    it('should show component library', () => {
      render(<DesignModeEditor node={mockNode} onClose={mockOnClose} />);
  ...
  describe('Component Operations', () => {
    ...
    it('should select component when clicked', async () => {
      ...
      render(
        <DesignModeEditor node={nodeWithComponent} onClose={mockOnClose} />
      );

      // Find and click the component (rendered as a box with label)
      const componentBox = screen
        .getAllByText('Avatar')
  ...
  describe('Prototype Linking', () => {
    it('should enable link mode', async () => {
      ...
      const linkButton = screen
        .getAllByRole('button')
        .find((btn) => btn.querySelector('[data-testid="LinkIcon"]'));
  ...
  describe('Zoom and View Controls', () => {
    it('should zoom in', async () => {
      ...
      const zoomInButton = screen
        .getAllByRole('button')
        .find((btn) => btn.querySelector('[data-testid="ZoomInIcon"]'));
    ...
    it('should zoom out', async () => {
      ...
      const zoomOutButton = screen
        .getAllByRole('button')
        .find((btn) => btn.querySelector('[data-testid="ZoomOutIcon"]'));
    ...
    it('should toggle grid display', async () => {
      ...
      const gridButton = screen
        .getAllByRole('button')
        .find((btn) => btn.querySelector('[data-testid="GridOnIcon"]'));
  ...
  describe('History (Undo/Redo)', () => {
    it('should undo component addition', async () => {
      ...
      const undoButton = screen
        .getAllByRole('button')
        .find((btn) => btn.querySelector('[data-testid="UndoIcon"]'));
    ...
    it('should redo component addition', async () => {
      ...
      const redoButton = screen
        .getAllByRole('button')
        .find((btn) => btn.querySelector('[data-testid="RedoIcon"]'));

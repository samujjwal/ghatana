...
describe('ServiceBlueprintCanvas', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render with initial blueprint name', () => {
      render(
        <ServiceBlueprintCanvas initialBlueprintName="Customer Onboarding" />
      );
      expect(
        screen.getByDisplayValue('Customer Onboarding')
      ).toBeInTheDocument();
    });
  ...
  describe('Lines of Interaction', () => {
    ...
    it('should show line of interaction marker', () => {
      ...
      const interactionElements =
        screen.queryAllByText(/interaction|interact/i);
  ...
  describe('Blueprint Name', () => {
    it('should allow editing blueprint name', async () => {
      ...
      expect(
        screen.getByDisplayValue('New Blueprint Name')
      ).toBeInTheDocument();
    });
  ...
  describe('Service Description', () => {
    it('should render with initial description', () => {
      render(
        <ServiceBlueprintCanvas initialServiceDescription="Service description here" />
      );
      expect(
        screen.getByDisplayValue('Service description here')
      ).toBeInTheDocument();
    });
    ...
    it('should allow editing description', async () => {
      const user = userEvent.setup();
      render(
        <ServiceBlueprintCanvas initialServiceDescription="Old description" />
      );
  ...
  describe('Lane Organization', () => {
    it('should show lanes in correct order', () => {
      ...
      const laneTexts = screen.getAllByText(
        /customer|frontstage|backstage|support/i
      );

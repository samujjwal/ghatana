...
export interface ComponentGeneratorDialogProps {
  ...
  onGenerated?: (
    node: Node,
    files: { component: string; test?: string; story?: string }
  ) => void;
}
 ...
 * ```
 */
export const ComponentGeneratorDialog: React.FC<
  ComponentGeneratorDialogProps
> = ({ open, onClose, node, onGenerated }) => {
  const {
    generateComponent,
    isGenerating,
    error,
    ...
    <Dialog open={open} onClose={onClose} size="lg" fullWidth>
          ...
          <Box className="grid gap-4">
            ...
            <Box className="grid gap-4 grid-cols-2">
              ...
              >
                ...
                <MenuItem value="svelte" disabled>
                  Svelte (Coming Soon)
                </MenuItem>
              </TextField>
            ...
            <Box className="h-full flex flex-col">
              <Box className="flex justify-between mb-4">
                ...
                <Button
                  startIcon={<CopyIcon />}
                  onClick={() =>
                    handleCopy(lastGenerated.componentFile.content)
                  }
                  size="sm"
                >
                  ...
                  <ListItem>
                    ...
                    <ListItemSecondaryAction>
                      <IconButton
                        edge="end"
                        onClick={() =>
                          handleCopy(lastGenerated.testFile!.content)
                        }
                      >
                        <CopyIcon />
                      </IconButton>
                  ...
                  <ListItem>
                    ...
                    <ListItemSecondaryAction>
                      <IconButton
                        edge="end"
                        onClick={() =>
                          handleCopy(lastGenerated.storyFile!.content)
                        }
                      >
                        <CopyIcon />
                      </IconButton>
                  ...
                  <ListItem>
                    ...
                    <ListItemSecondaryAction>
                      <IconButton
                        edge="end"
                        onClick={() =>
                          handleCopy(lastGenerated.styleFile!.content)
                        }
                      >
                        <CopyIcon />
                      </IconButton>
      ...
      <DialogActions>
        ...
        <Button
          ...
          startIcon={
            isGenerating ? <CircularProgress size={20} /> : <CodeIcon />
          }
        >

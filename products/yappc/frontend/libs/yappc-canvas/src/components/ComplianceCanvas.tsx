    ...
    <div className="w-full h-full p-6 bg-gray-50 overflow-auto">
      ...
      <div className="mb-6">
        ...
        <Typography variant="body2" className="text-gray-600">
          Track compliance controls, collect evidence, and generate audit
          reports
        </Typography>
      </div>
          ...
          <div className="flex gap-2 flex-wrap">
            {(
              ...
              <Button
                key={framework}
                variant={
                  compliance.selectedFramework === framework
                    ? 'contained'
                    : 'outlined'
                }
        ...
        <CardContent>
          <div className="space-y-3">
            {Object.entries(overview.byStatus).map(([status, count]) => {
              const percentage =
                compliance.getControlCount() > 0
                  ? (count / compliance.getControlCount()) * 100
                  : 0;
              return (
                <div key={status}>
      ...
      <Card className="mb-6">
        <CardHeader>
          <div className="flex justify-between items-center">
            ...
            <Button
              variant="contained"
              onClick={() => setAddControlDialogOpen(true)}
          ...
          {compliance.controls.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              <Typography variant="body1">
                No controls added yet. Click "Add Control" to get started.
              </Typography>
            </div>
          ) : (
            <div className="space-y-3">
              {compliance
                ...
                .map((control) => {
                  ...
                  return (
                    <Card
                      key={control.id}
                      className={`border-l-4 ${frameworkColors[control.framework]}`}
                    >
                      <CardContent className="p-4">
                        <div className="flex justify-between items-start mb-2">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span
                                className={`px-2 py-1 rounded text-xs font-medium ${statusColors[control.status]}`}
                              >
                          ...
                          <div className="flex gap-2">
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                compliance.updateControl(control.id, {
                                  status: e.target.value as ControlStatus,
                                })
                              }
                              ...
                              {evidence.map((ev) => (
                                ...
                                >
                                  ...
                                  <Button
                                    ...
                                    variant="text"
                                    onClick={() =>
                                      compliance.deleteEvidence(ev.id)
                                    }
        ...
        <Card className="mb-6">
          <CardHeader>
            <div className="flex justify-between items-center">
              ...
              <Button
                variant="outlined"
                onClick={() => setGapAnalysisDialogOpen(true)}
                className="border-gray-300"
              >
                View Details
              </Button>
      ...
      {/* Add Control Dialog */}
      <Dialog
        open={addControlDialogOpen}
        onClose={() => setAddControlDialogOpen(false)}
      >
        ...
        <DialogContent>
          <div className="space-y-4 w-96">
            ...
            <TextField
              ...
              onChange={(e) =>
                setNewControlForm({ ...newControlForm, title: e.target.value })
              }
      ...
      <Dialog
        ...
        onClose={() => setAddEvidenceDialogOpen(false)}
      >
        ...
        <DialogContent>
          <div className="space-y-4 w-96">
            ...
            <TextField
              ...
              onChange={(e) =>
                setNewEvidenceForm({ ...newEvidenceForm, url: e.target.value })
              }
        ...
        <DialogActions>
          <Button
            onClick={() => setAddEvidenceDialogOpen(false)}
            variant="text"
          >
            Cancel
          </Button>
      ...
      <Dialog
        ...
        onClose={() => setGapAnalysisDialogOpen(false)}
        maxWidth="md"
      >
        ...
        <DialogActions>
          <Button
            onClick={() => setGapAnalysisDialogOpen(false)}
            variant="text"
          >
            Close
          </Button>
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2 p-3 border rounded cursor-pointer hover:bg-gray-50">
                ...
                <div>
                  ...
                  <Typography variant="caption" className="text-gray-600">
                    Comprehensive audit report with controls, evidence, and
                    analysis
                  </Typography>
                </div>
              </label>

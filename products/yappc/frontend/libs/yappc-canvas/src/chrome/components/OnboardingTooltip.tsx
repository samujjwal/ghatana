...
import {
  chromeShownHintsAtom,
  chromeOnboardingStepAtom,
} from '../state/chrome-atoms';
import { CANVAS_TOKENS } from '../tokens/canvas-tokens';

const { SPACING, COLORS, TYPOGRAPHY, FONT_WEIGHT, RADIUS, SHADOWS, Z_INDEX } =
  CANVAS_TOKENS;
...
export function OnboardingTooltip({
  ...
  return (
    <Box
      className="fixed max-w-[320px] pointer-events-auto"
      style={{
        left: position.x,
        top: position.y,
    ...
    >
      ...
      <Box className="flex justify-between items-start mb-2">
        ...
        <IconButton
          ...
          className="p-0 ml-auto hover:bg-[rgba(255,_255,_255,_0.1)]"
      ...
      {action && (
        <Box className="flex gap-2 mt-4">
          <Button
            ...
            variant="contained"
            size="small"
            className="bg-[rgba(255,_255,_255,_0.2)] normal-case hover:bg-[rgba(255,_255,_255,_0.3)]"
            style={{ color: COLORS.TEXT_INVERSE, fontSize: TYPOGRAPHY.XS }}
          >
            {action.label}
          </Button>
          <Button
            ...
            variant="text"
            size="small"
            className="normal-case opacity-[0.7] hover:opacity-100 hover:bg-[rgba(255,_255,_255,_0.1)]"
            style={{ color: COLORS.TEXT_INVERSE, fontSize: TYPOGRAPHY.XS }}
          >
            Got it
          </Button>
...
export const ONBOARDING_HINTS = {
  ...
  FIRST_SHAPE: {
    ...
    message:
      'Click any edge dot or press C to create connectors between shapes',
    showDelay: 500,
  },
  FIRST_CONNECTION: {
    ...
    title: 'Looking good!',
    message:
      'Select multiple elements with Shift or drag, then press ⌘G to group',
    showDelay: 500,
  },
  FIRST_GROUP: {
    hintId: 'first-group',

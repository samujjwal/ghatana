...
const ALL_SHORTCUTS: ShortcutItem[] = [
  ...
  { action: 'Overview Mode', keys: '⌘⇧O', category: 'Navigation' },
  {
    ...
    keys: 'ESC',
    category: 'Navigation',
    description: 'Exit drill-down mode',
  },
...
function KeyboardKey({ children }: { children: React.ReactNode }) {
  return (
    <Box
      component="kbd"
      className="inline-flex items-center justify-center min-w-[24px] h-[24px] font-mono"
      style={{
    ...
    >
      ...
      >
        <Box>
          <Typography
            variant="h5"
            style={{ fontWeight: FONT_WEIGHT.BOLD, marginBottom: SPACING.XXS }}
          >
      ...
      {/* Shortcuts Grid */}
      <Box className="overflow-y-auto max-h-[calc(90vh - 180px)] px-6 pb-6">
        {categories.length === 0 ? (
          <Box className="text-center py-12">
            <Typography variant="body1">No shortcuts found</Typography>
            <Typography
              variant="body2"
              style={{ marginTop: SPACING.SM, fontSize: TYPOGRAPHY.SM }}
            >
          ...
          <Box
            ...
            style={{ gap: SPACING.LG, color: COLORS.TEXT_SECONDARY }}
          >
      ...
      >
        ...
        >
          Press <KeyboardKey>⌘/</KeyboardKey> or <KeyboardKey>?</KeyboardKey>{' '}

...
import {
  ...
  NotebookText as TextIcon,
  Square as ShapeIcon,
  ArrowRight as ConnectorIcon,
} from 'lucide-react';
      ...
      <ListItem
        ...
        secondaryAction={
          <Box className="flex gap-1">
            ...
            <Box className="flex items-center cursor-grab w-[24px]">
        ...
        >
          {hasChildren && (
            <IconButton
              ...
              className="mr-1"
            >
              {expanded ? <ExpandIcon size={16} /> : <CollapseIcon size={16} />}
            </IconButton>
          )}
...
export function LayersPanel({
  ...
  return (
    <Box className="h-full flex flex-col">
      {/* Header */}
      <Box
        className="border-gray-200 dark:border-gray-700 border-b border-solid"
        style={{ padding: CANVAS_TOKENS.SPACING.MD }}
      >
      ...
      {/* Footer with actions */}
      <Box className="p-2 flex gap-2 border-t border-solid border-gray-200 dark:border-gray-700">
        <Tooltip title="Bring to Front">
          ...
          >
            <Box className="flex flex-col gap-0.5 w-[16px] h-[16px]">

    ...
    <Box className="h-full flex flex-col">
      <Paper className="p-4 mb-4">
        <Box className="flex items-center gap-4 flex-wrap">
          <Security
            className="text-[32px]"
            style={{ color: enabled ? 'primary.main' : 'text.secondary' }}
          />
        ...
        <Box className="flex gap-2 mt-4">
          ...
          <Button
            size="sm"
            startIcon={<Speed />}
            onClick={() => onAddControl?.('ratelimiter')}
          >
            Rate Limiter
          </Button>
          <Button
          ...
          <Button
            size="sm"
            startIcon={<Lock />}
            onClick={() => onAddControl?.('encryption')}
          >
            Encryption
          </Button>
        </Box>
          ...
          {findings.length === 0 ? (
            <Alert severity="success">
              ...
              <Typography as="p" className="text-sm">
                Your architecture appears secure
              </Typography>
            </Alert>
          ) : (
            <>
              <Box className="mb-4 flex gap-2">
                ...
                />
                <Chip
                  label={`${findings.length - criticalCount - highCount} Other`}
                />
              </Box>

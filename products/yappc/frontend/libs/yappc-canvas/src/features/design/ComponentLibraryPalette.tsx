 ...
 * ```
 */
export const ComponentLibraryPalette: React.FC<
  ComponentLibraryPaletteProps
> = ({
  onSelectComponent,
  dragEnabled = true,
  customComponents = [],
  ...
  const handleDragStart =
    (component: ComponentDefinition) => (e: React.DragEvent) => {
          ...
          {Object.entries(componentsByCategory).map(
            ([category, components]) => (
              <React.Fragment key={category}>
                ...
                {/* Category Components */}
                <Collapse
                  in={expandedCategories.has(category as ComponentCategory)}
                >

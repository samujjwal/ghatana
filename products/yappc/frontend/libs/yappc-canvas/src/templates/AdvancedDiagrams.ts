...
export const bpmnProcessTemplate: DiagramTemplate = {
  ...
  name: 'BPMN Process',
  description:
    'Standard BPMN 2.0 business process with start, tasks, gateways, and end events',
  category: 'bpmn',
  elements: [
...
export const umlClassDiagramTemplate: DiagramTemplate = {
  ...
  description:
    'Standard UML class diagram with classes, attributes, and relationships',
  category: 'uml',
  elements: [
...
export const erDiagramTemplate: DiagramTemplate = {
  ...
  name: 'ER Diagram',
  description:
    'Entity-Relationship diagram with entities, attributes, and relationships',
  category: 'er',
  elements: [
  ...
  edges: [
    ...
    },
    {
      id: 'rel2-e2',
      source: 'entity2',
      target: 'relationship2',
      type: 'straight',
    },
    {
      id: 'rel2-e3',
      source: 'relationship2',
      target: 'entity3',
      type: 'straight',
    },
  ],
...
export const microservicesTemplate: DiagramTemplate = {
  ...
  description:
    'Microservices architecture with API gateway, services, and data stores',
...
export const serverlessTemplate: DiagramTemplate = {
  ...
  description:
    'Serverless architecture with functions, triggers, and managed services',
  category: 'architecture',
  elements: [

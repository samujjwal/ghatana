...
export const testPlanCanvasTemplate: JourneyTemplate = {
  ...
  description:
    'Plan comprehensive test coverage across unit, integration, and E2E',
  persona: 'qa',
  category: 'testing',
...
export const fullStackFeatureTemplate: JourneyTemplate = {
  ...
  description:
    'Design a complete feature from UI screens through API to database',
  persona: 'all',
  category: 'implementation',
 ...
 */
export function getTemplatesByPersona(
  persona: JourneyTemplate['persona']
): JourneyTemplate[] {
  if (persona === 'all') return journeyTemplates;
  return journeyTemplates.filter(
    (t) => t.persona === persona || t.persona === 'all'
  );
}

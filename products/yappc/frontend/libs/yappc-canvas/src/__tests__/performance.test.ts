...
describe('Performance Regression Tests', () => {
  describe('Viewport Performance', () => {
    it('should zoom within 16ms budget (60 FPS)', async () => {
      ...
      console.log(
        `  Zoom - Avg: ${avgTime.toFixed(2)}ms, P95: ${p95Time.toFixed(2)}ms`
      );
    ...
    it('should pan within 16ms budget', async () => {
      ...
      console.log(
        `  Pan - Avg: ${avgTime.toFixed(2)}ms, P95: ${p95Time.toFixed(2)}ms`
      );
  ...
  describe('Rendering Performance', () => {
    ...
    it('should handle large canvas (1000+ elements) within budget', async () => {
      ...
      console.log(
        `  Large Canvas (1000 elements) - Time: ${time.toFixed(2)}ms`
      );
  ...
  describe('Sync Performance', () => {
    it('should queue operations efficiently', async () => {
      ...
      console.log(
        `  Queue Operations - Total: ${time.toFixed(2)}ms, Per Op: ${timePerOp.toFixed(4)}ms`
      );
  ...
  describe('Memory Performance', () => {
    it('should not leak memory during viewport operations', async () => {
      ...
      console.log(
        `  Memory Usage - Before: ${(memBefore / 1024 / 1024).toFixed(2)}MB, After: ${(memAfter / 1024 / 1024).toFixed(2)}MB, Diff: ${memDiff.toFixed(2)}MB`
      );

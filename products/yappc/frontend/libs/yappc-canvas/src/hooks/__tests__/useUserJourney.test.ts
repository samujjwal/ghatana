...
describe('useUserJourney', () => {
  ...
  describe('Touchpoint Management', () => {
    ...
    it('should get touchpoint count', () => {
      ...
      act(() => {
        ...
        result.current.addTouchpoint(stage1, {
          name: 'Homepage',
          type: 'digital',
        });
        result.current.addTouchpoint(stage1, {
        ...
        result.current.addTouchpoint(stage2, {
          name: 'Store',
          type: 'physical',
        });
      });
  ...
  describe('Pain Point Management', () => {
    ...
    it('should get pain point count', () => {
      ...
      act(() => {
        ...
        result.current.addPainPoint(stage1, {
          description: 'Issue 1',
          severity: 1,
        });
        result.current.addPainPoint(stage2, {
          description: 'Issue 2',
          severity: 2,
        });
        result.current.addPainPoint(stage2, {
  ...
  describe('Journey Export', () => {
    it('should export journey as JSON', () => {
      ...
      act(() => {
        ...
        result.current.addTouchpoint(stage, {
          name: 'Homepage',
          type: 'digital',
        });
        result.current.addPainPoint(stage, {
  ...
  describe('Complex Scenarios', () => {
    it('should handle complete journey with all elements', () => {
      ...
      act(() => {
        // Stage 1: Awareness
        const awareness = result.current.addStage(
          'Awareness',
          'Discovery phase'
        );
        result.current.addTouchpoint(awareness, {
          name: 'Google Search',
          type: 'digital',
        });
        result.current.addTouchpoint(awareness, {
        ...
        const consideration = result.current.addStage(
          'Consideration',
          'Evaluation phase'
        );
        result.current.addTouchpoint(consideration, {
          name: 'Product Page',
          type: 'digital',
        });
        ...
        result.current.addTouchpoint(purchase, {
          name: 'Checkout',
          type: 'digital',
        });
    ...
    it('should maintain data integrity after multiple operations', () => {
      ...
      act(() => {
        ...
        result.current.addTouchpoint(stage1Id!, {
          name: 'TP1',
          type: 'digital',
        });
        result.current.addTouchpoint(stage2Id!, {
          name: 'TP2',
          type: 'physical',
        });
      });

  ...
  describe('Feature Management', () => {
    ...
    it('should filter features by status', () => {
      ...
      const inProgressFeatures =
        result.current.getFeaturesByStatus('in-progress');
  ...
  describe('Complex Multi-Team Release Scenario', () => {
    it('should handle complex release with multiple teams, dependencies, and blockers', () => {
      ...
      const notStartedFeatures =
        result.current.getFeaturesByStatus('not-started');
      ...
      const updatedAuthRisk =
        result.current.calculateFeatureRisk(authFeatureId);

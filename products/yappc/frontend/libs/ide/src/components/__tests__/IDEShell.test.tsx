...
describe('IDEShell activity bar', () => {
  test('toggles search, source control, run and extensions panels', async () => {
    ...
    expect(
      screen.getByRole('dialog', { name: /Search panel/i })
    ).toBeInTheDocument();
    await user.click(searchBtn);
    expect(
      screen.queryByRole('dialog', { name: /Search panel/i })
    ...
    expect(
      screen.getByRole('dialog', { name: /Source control panel/i })
    ).toBeInTheDocument();
    ...
    expect(
      screen.getByRole('dialog', { name: /Run and Debug panel/i })
    ).toBeInTheDocument();
    ...
    expect(
      screen.getByRole('dialog', { name: /Extensions panel/i })
    ).toBeInTheDocument();
  });
});

...
export const PerformanceDashboard: React.FC<PerformanceDashboardProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    'overview' | 'metrics' | 'alerts' | 'suggestions' | 'history' | 'settings'
  >('overview');
  ...
  const generateMockAlerts = useCallback(
    (metricsData: PerformanceMetric[]): PerformanceAlert[] => {
    ...
    (): PerformanceSuggestion[] => [
      {
        ...
        description:
          'Reduce bundle size by implementing code splitting and tree shaking',
        type: 'optimization',
        impact: 'high',
        effort: 'medium',
        implemented: false,
      ...
      },
      {
        ...
        description:
          'Implement memory leak detection to prevent performance degradation',
        type: 'refactor',
        impact: 'medium',
        effort: 'low',
        implemented: false,
      },
      {
        ...
        description:
          'Update outdated dependencies to improve performance and security',
        type: 'upgrade',
        impact: 'medium',
        effort: 'high',
        implemented: false,
  ...
  const updateMetrics = useCallback(
    (currentMetrics: PerformanceMetric[]): PerformanceMetric[] => {
    ...
    try {
      ...
      const report = {
        ...
        summary: {
          ...
          criticalIssues: alerts.filter((alert) => alert.type === 'error')
            .length,
      ...
      <div className="flex border-b border-gray-200 dark:border-gray-700">
        {[
          ...
          },
          {
            id: 'suggestions',
            label: 'Suggestions',
            count: suggestions.filter((s) => !s.implemented).length,
          },
            ...
            <div className="space-y-2">
              {metrics.slice(0, 3).map((metric) => (
                ...
                >
                  ...
                  <ProgressBar value={metric.value} max={100} className="h-2" />
            ...
            <div className="space-y-3">
              {metrics.map((metric) => (
                ...
                >
                  ...
                  <ProgressBar value={metric.value} max={100} className="h-3" />
                  <div className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    Threshold: {metric.threshold}
                    {metric.unit} • Trend: {metric.trend}
                  </div>
                </div>
              ))}
            </div>

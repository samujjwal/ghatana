 ...
 */
export class PRAnalyzerAgent extends BaseAgent<
  PRAnalysisInput,
  PRAnalysisOutput
> {
      ...
      if (file.patch) {
        ...
        if (
          ...
          findings.push({
            ...
            description: 'New code added without corresponding test file.',
  ...
  private generateRecommendations(
    ...
    if (metrics.documentationScore < 6) {
      recommendations.push(
        'Add more detailed PR description and code comments'
      );
    }

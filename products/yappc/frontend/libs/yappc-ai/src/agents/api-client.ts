 ...
 */
export class AIAgentAPIClient<TInput, TOutput> implements IAIAgent<
  TInput,
  TOutput
> {
...
export class AIAgentClientFactory {
  ...
  createCopilotClient(): AIAgentAPIClient<CopilotInput, CopilotOutput> {
    return new AIAgentAPIClient('CopilotAgent', '1.0.0', 2000, this.config);
  }

  /**
   * Create a Query Parser agent client
   */
  createQueryParserClient(): AIAgentAPIClient<
    QueryParserInput,
    QueryParserOutput
  > {
    return new AIAgentAPIClient('QueryParserAgent', '1.0.0', 300, this.config);
  }

  /**
   * Create a Prediction agent client
   */
  createPredictionClient(): AIAgentAPIClient<
    PredictionInput,
    PredictionOutput
  > {
    return new AIAgentAPIClient('PredictionAgent', '1.0.0', 500, this.config);
  }

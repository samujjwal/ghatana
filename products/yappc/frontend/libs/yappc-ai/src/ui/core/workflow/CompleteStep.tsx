...
export const CompleteStep: React.FC<CompleteStepProps> = ({
  ...
  const totalDuration =
    workflowData.endTime.getTime() - workflowData.startTime.getTime();
    ...
    <Box className="p-6 text-center">
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card variant="outlined">
            <CardContent>
              ...
              <Typography as="h4">
                {workflowData.filesCreated + workflowData.filesModified}
              </Typography>
              ...
              >
                {workflowData.filesCreated} created,{' '}
                {workflowData.filesModified} modified
              </Typography>
            </CardContent>
          </Card>
        </Grid>
          ...
          <Card variant="outlined">
            <CardContent>
              ...
              {workflowData.testsFailed > 0 && (
                <Chip
                  size="sm"
                  label={`${workflowData.testsFailed} failed`}
                  tone="danger"
                />
              )}
            </CardContent>
      ...
      {workflowData.deploymentUrl && (
        <Alert severity="success" className="mb-6">
          ...
          <a
            href={workflowData.deploymentUrl}
            target="_blank"

...
import {
  ...
  TrendingUp as SpikeIcon,
  TrendingDown as DropIcon,
  ShowChart as TrendIcon,
  AlertCircle as OutlierIcon,
  Report as BreachIcon,
} from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <Collapse in={expanded}>
        <Paper
          className="mt-4 p-4 text-inherit"
          style={{ backgroundColor: 'rgba(0', backgroundColor: 'rgba(255' }}
        >
          <Stack spacing={1}>
            ...
            <Box className="flex justify-between">
              ...
              <LinearProgress
                ...
                className="w-[100px] h-[8px] rounded-2xl"
                style={{ backgroundColor: 'rgba(255' }}
              />
            </Box>
            <Box className="flex justify-between">
              <Typography as="span" className="text-xs text-gray-500">

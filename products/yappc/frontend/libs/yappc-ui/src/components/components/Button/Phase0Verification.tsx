    ...
    <div className="p-8 space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          <div
            className="w-16 h-16 bg-primary-500 rounded-md"
            title="primary-500"
          />
          <div
            className="w-16 h-16 bg-secondary-500 rounded-md"
            title="secondary-500"
          />
          <div
            className="w-16 h-16 bg-success-DEFAULT rounded-md"
            title="success"
          />
          <div
            className="w-16 h-16 bg-error-DEFAULT rounded-md"
            title="error"
          />
        </div>
      </div>

    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <Grid cols="grid-cols-4">
          <Box p="p-4" bg="bg-warning-100" rounded="rounded">
            1
          </Box>
          <Box p="p-4" bg="bg-warning-100" rounded="rounded">
            2
...
export const ResponsiveGrid: Story = {
  render: () => (
    <div className="space-y-8">
      <div>
        <p className="mb-2 text-sm font-medium text-grey-700">
          Responsive: 1 column (mobile) → 2 columns (tablet) → 4 columns
          (desktop)
        </p>
...
export const DifferentGaps: Story = {
  render: () => (
    <div className="space-y-8">
      <div>
        <p className="mb-2 text-sm font-medium text-grey-700">
          Horizontal gap larger than vertical
        </p>
      ...
      <div>
        <p className="mb-2 text-sm font-medium text-grey-700">
          Vertical gap larger than horizontal
        </p>
    ...
    <Grid cols="grid-cols-1 md:grid-cols-2 lg:grid-cols-3" gap="gap-6">
      {Array.from({ length: 6 }).map((_, i) => (
        ...
        >
          <Box
            h="h-48"
            bg={`bg-${['primary', 'secondary', 'success', 'warning', 'error', 'grey'][i]}-400`}
          />
          <Box p="p-6">
            ...
            <Box as="p" color="text-grey-600" className="mb-4 text-sm">
              This is a card in a responsive grid layout. The grid adjusts from
              1 column on mobile to 3 columns on desktop.
            </Box>

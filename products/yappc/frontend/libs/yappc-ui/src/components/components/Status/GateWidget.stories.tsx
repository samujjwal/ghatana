...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'GateWidget displays a collection of gate statuses for CI/CD pipelines, quality checks, and deployment gates. It provides an overview of system health with detailed information and links to remediation.',
      },
    },
  },
  tags: ['autodocs'],
...
export const AllStatuses: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'GateWidget displaying all possible status types with different categories and messages.',
      },
    },
  },
};
...
export const ErrorState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'GateWidget showing a pipeline with errors and warnings that need attention.',
      },
    },
  },
};
...
export const CompactView: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'GateWidget in compact mode for inline display within other components or tight layouts.',
      },
    },
  },
};
...
export const TruncatedGates: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'GateWidget with many gates truncated to show only the first few, with indication of additional gates.',
      },
    },
  },
};
...
export const WithoutRefresh: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'GateWidget without refresh functionality for read-only contexts.',
      },
    },
  },
};
...
export const CustomTitle: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'GateWidget with custom title including emojis or special formatting.',
      },
    },
  },
};
...
export const RealTimeUpdates: Story = {
    ...
    return (
      <Stack spacing={2} className="w-full max-w-[500px]">
        ...
        <Typography as="p" className="text-sm" color="text.secondary">
          Gates update every 10 seconds. Click refresh to simulate manual
          update.
        </Typography>
        <GateWidget
          gates={gates}
  ...
  parameters: {
    docs: {
      description: {
        story:
          'GateWidget with simulated real-time updates and manual refresh capability.',
      },
    },
  },
};
...
export const AccessibilityFeatures: Story = {
  ...
  render: () => (
    <Stack spacing={2} className="w-full max-w-[500px]">
      ...
      <Typography as="p" className="text-sm" color="text.secondary">
        Gates include proper ARIA labels, semantic HTML, and keyboard
        navigation. The overall status is calculated and communicated to screen
        readers.
      </Typography>
      <GateWidget
        gates={sampleGates}
  ...
  parameters: {
    docs: {
      description: {
        story:
          'GateWidget includes comprehensive accessibility features including ARIA labels, semantic HTML, and keyboard navigation support.',
      },
    },
  },
};

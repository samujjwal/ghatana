...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A comprehensive project shell layout component that provides navigation tabs, breadcrumbs, and responsive design for project pages.',
      },
    },
  },
  tags: ['autodocs'],
...
const mockTabs = [
  ...
  },
  {
    ...
    badge: (
      <Box
        component="span"
        className="text-xs text-center bg-blue-600 text-white rounded-[10px] p-[2px 6px] min-w-[18px]"
      >
        5
      </Box>
    ),
...
const SampleContent = ({ title }: { title: string }) => (
  <Box className="p-6">
    ...
    <Typography color="text.secondary" paragraph>
      This is sample content for the {title.toLowerCase()} tab. In a real
      application, this would be replaced with the actual page content.
    </Typography>
    <Box className="rounded flex items-center justify-center h-[400px] bg-gray-100">
      <Typography color="text.secondary">{title} Page Content Area</Typography>
    </Box>
  </Box>
);
...
export const WithBackButton: Story = {
  args: {
    ...
    breadcrumbs: [...mockBreadcrumbs, { label: 'Settings' }],
    tabs: [

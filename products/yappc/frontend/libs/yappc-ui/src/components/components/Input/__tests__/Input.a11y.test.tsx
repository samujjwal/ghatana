...
describe('Input Accessibility', () => {
  ...
  it('should have no accessibility violations with formatting', async () => {
    const { container } = render(
      <Input label="Username" placeholder="Enter username" format="uppercase" />
    );
  ...
  it('should have no accessibility violations with mobile optimization', async () => {
    const { container } = render(
      <Input label="Mobile Input" placeholder="Enter text..." mobileOptimized />
    );
  ...
  it('should have proper focus management', () => {
    render(<Input label="Focus Test" placeholder="Click to focus" />);

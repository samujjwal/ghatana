...
export function WorkflowCategoryTabs({
  ...
  const categories = Object.entries(categoryConfig) as [
    WorkflowCategory,
    (typeof categoryConfig)[WorkflowCategory],
  ][];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Expand */}
        <span
          className={`material-icons text-gray-400 transition-transform ${expanded ? 'rotate-180' : ''}`}
        >
          expand_more
        </span>
      </button>
...
export function WorkflowDetail({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden max-w-2xl w-full">
      {/* Header */}
      <div className="p-6" style={{ backgroundColor: `${workflow.color}10` }}>

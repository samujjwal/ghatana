    ...
    configSchema: [
      {
        ...
        label: 'Metric',
        type: 'select',
        options: ['buildTime', 'deployTime', 'testTime'],
        required: true,
      },
      {
        key: 'timeRange',
    ...
    <Box className={`${className ?? ''} h-screen flex flex-col`}>
      ...
      <Box className="grow p-4 overflow-auto">
        {layout.widgets.length === 0 && (
          <Box className="h-full flex flex-col items-center justify-center text-gray-500 dark:text-gray-400">
          ...
          {editingWidget && (
            <Box className="pt-2">
              ...
              <Typography as="p" className="text-sm" color="text.secondary">
                Widget configuration options will be available based on widget
                type.
              </Typography>
            </Box>
          )}
      ...
      >
        ...
        <DialogContent>
          <Box className="pt-2">
            ...
            <TextField
              ...
              onChange={(e) =>
                setLayout((prev) => ({ ...prev, description: e.target.value }))
              }
              multiline
              rows={3}
              className="mb-4"
        ...
        <DialogActions>
          ...
          <Button onClick={() => setIsSettingsOpen(false)} variant="solid">
            Save
          </Button>
        </DialogActions>
      </Dialog>

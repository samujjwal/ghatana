      ...
      <Container>
        <Box p="p-6" bg="bg-white" shadow="shadow" rounded="rounded-lg">
          ...
          <p className="text-grey-700">
            This container has a max-width of 'lg' (512px), is centered, and
            includes horizontal padding. It's perfect for forms, articles, and
            other focused content.
          </p>
        </Box>
      </Container>
    </Box>
    ...
    <Box bg="bg-grey-100" className="min-h-screen">
      <Container maxWidth="2xl" padding={false}>
        <Box bg="bg-white" shadow="shadow-lg">
          ...
          <Box p="p-6">
            <p className="text-grey-700">
              This container has no horizontal padding, allowing content to
              extend to the edges. Useful for full-bleed images or layouts where
  ...
  render: () => (
    <div>
      ...
      <Box bg="bg-white" className="py-16">
        <Container maxWidth="6xl">
          <h3 className="mb-8 text-center text-3xl font-bold text-grey-900">
            Features
          </h3>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[1, 2, 3].map((i) => (
              <Box key={i} p="p-6" bg="bg-grey-50" rounded="rounded-lg">
                <h4 className="mb-2 text-xl font-semibold text-grey-900">
                  Feature {i}
                </h4>
                <p className="text-grey-600">
                  Description of this amazing feature and why it matters to
                  users.
                </p>
              </Box>
            ))}
      ...
      <Box bg="bg-grey-900" color="text-white" className="py-16">
        <Container maxWidth="3xl" className="text-center">
          ...
          <p className="mb-8 text-lg">
            Join thousands of users already building with us.
          </p>
    ...
    <Box bg="bg-grey-100" className="min-h-screen py-8">
      <Container maxWidth="7xl">
        <Box p="p-8" bg="bg-white" shadow="shadow-lg" rounded="rounded-xl">
          <h2 className="mb-6 text-2xl font-bold text-grey-900">
            Outer Container (7xl)
          </h2>
          ...
          <Container maxWidth="4xl">
            <Box
              ...
              className="mb-6"
            >
              <h3 className="mb-2 text-xl font-semibold text-grey-900">
                Inner Container (4xl)
              </h3>
              <p className="text-grey-700">
                Containers can be nested to create different content widths
          ...
          <Container maxWidth="2xl">
            <Box p="p-6" bg="bg-secondary-50" rounded="rounded-lg">
              <h3 className="mb-2 text-xl font-semibold text-grey-900">
                Narrow Container (2xl)
              </h3>
              <p className="text-grey-700">
                This narrower container is perfect for focused content like
                forms or text.
              </p>
            </Box>
          </Container>
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                id="terms"
                className="h-4 w-4 rounded border-grey-300 text-primary-600"
              />
    ...
    <Box bg="bg-grey-100" className="min-h-screen py-8">
      <Container {...args}>
        <Box p="p-6" bg="bg-white" shadow="shadow" rounded="rounded-lg">
          ...
          <p className="text-grey-700">
            Adjust the controls to see how the container behaves with different
            settings.
          </p>
        </Box>
      </Container>

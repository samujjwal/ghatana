...
describe('ProjectShell Component', () => {
  ...
  it('renders breadcrumb navigation when provided', () => {
    render(
      <ThemeProvider mode="light">
        <ProjectShell {...defaultProps} breadcrumbs={mockBreadcrumbs} />
      </ThemeProvider>
    );
  ...
  it('calls onTabChange when tab is clicked', () => {
    ...
    render(
      <ThemeProvider mode="light">
        <ProjectShell {...defaultProps} onTabChange={onTabChange} />
      </ThemeProvider>
    );
  ...
  it('renders action buttons when provided', () => {
    render(
      <ThemeProvider mode="light">
        <ProjectShell {...defaultProps} actions={mockActions} />
      </ThemeProvider>
    );
  ...
  it('shows loading state when isLoading is true', () => {
    render(
      <ThemeProvider mode="light">
        <ProjectShell {...defaultProps} isLoading={true} />
      </ThemeProvider>
    );
  ...
  it('renders custom header content when provided', () => {
    ...
    render(
      <ThemeProvider mode="light">
        <ProjectShell {...defaultProps} headerContent={customHeader} />
      </ThemeProvider>
    );
  ...
  it('handles disabled tabs correctly', () => {
    ...
    render(
      <ThemeProvider mode="light">
        <ProjectShell {...defaultProps} tabs={tabsWithDisabled} />
      </ThemeProvider>
    );
  ...
  it('applies custom className when provided', () => {
    const { container } = render(
      <ThemeProvider mode="light">
        <ProjectShell {...defaultProps} className="custom-shell" />
      </ThemeProvider>
    );

    ...
    `;
      ...
      const applyMask = useCallback(
        (value: string): string => {
          ...
          for (
            let i = 0;
            i < pattern.length && valueIndex < value.length;
            i++
          ) {
        ...
        <div style={containerStyle} className={className}>
          {label && (
            <label htmlFor={inputId} style={labelStyle}>
              {label}
              {required && (
                <span style={{ color: '#f44336', marginLeft: '0.25rem' }}>
                  *
                </span>
              )}
            </label>
          ...
          <div style={inputWrapperStyle}>
            {startIcon && (
              <div style={{ ...iconStyle, left: '0.75rem' }}>{startIcon}</div>
            )}
            ...
            <input
              ...
              aria-controls={
                autocomplete && showOptions ? `${inputId}-options` : undefined
              }
            ...
            >
              ...
              <div id={error ? `${inputId}-error` : `${inputId}-helper`}>
                {error && (
                  <span
                    style={{
                      fontWeight: errorSeverity === 'error' ? 500 : 400,
                    }}
                  >
                    {errorSeverity === 'error'
                      ? 'Error: '
          ...
          {autocomplete && showOptions && filteredOptions.length > 0 && (
            <div
              ...
              style={{
                ...
                maxHeight:
                  mobileOptimized && isMobileViewport ? '240px' : '200px',
                overflowY: 'auto',
              }}
            >
          ...
          {showCounter && maxLength && (
            <div
              style={{ ...helperStyle, textAlign: 'right' }}
              aria-live="polite"
              aria-atomic="true"
            >

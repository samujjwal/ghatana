...
describe('Status Components Accessibility', () => {
  ...
  describe('GateWidget', () => {
    it('should not have accessibility violations in default state', async () => {
      const { container } = renderWithTheme(<GateWidget gates={mockGates} />);
    ...
    it('should not have accessibility violations in loading state', async () => {
      const { container } = renderWithTheme(<GateWidget gates={[]} loading />);
    ...
    it('should not have accessibility violations in empty state', async () => {
      const { container } = renderWithTheme(<GateWidget gates={[]} />);
    ...
    it('should not have accessibility violations with custom title', async () => {
      const { container } = renderWithTheme(
        <GateWidget gates={mockGates} title="Custom Pipeline Gates" />
      );

...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'StatusBadge displays the status of various system operations like builds, tests, deployments, etc. It supports different states, categories, variants and provides consistent visual feedback across the application.',
      },
    },
  },
  tags: ['autodocs'],
...
export const AllCategories: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'StatusBadge with different categories showing how icons change based on category.',
      },
    },
  },
};
...
export const AnimatedStates: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'StatusBadge with animation enabled for running and pending states.',
      },
    },
  },
};
...
export const CustomLabelsAndTooltips: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'StatusBadge with custom labels and detailed tooltips for better user experience.',
      },
    },
  },
};
...
export const AccessibilityFeatures: Story = {
  ...
  render: () => (
    <Stack spacing={2}>
      ...
      <Typography
        ...
        gutterBottom
      >
        All badges have proper ARIA labels and role attributes for screen
        readers. Focus outlines are visible when navigating with keyboard.
      </Typography>
      <Stack direction="row" spacing={1}>
        <StatusBadge
          status="success"
  ...
  parameters: {
    docs: {
      description: {
        story:
          'StatusBadge includes built-in accessibility features including ARIA labels, role attributes, and keyboard focus indicators.',
      },
    },
  },
};

...
export const Horizontal: Story = {
  render: () => (
    <Stack direction="horizontal">
      <Box p="p-4" bg="bg-secondary-100" rounded="rounded-md">
        Item 1
      </Box>
      <Box p="p-4" bg="bg-secondary-100" rounded="rounded-md">
        Item 2
  ...
  render: () => (
    <div className="space-y-8">
      <div>
        ...
        <Stack spacing="gap-2">
          <Box p="p-3" bg="bg-primary-100" rounded="rounded">
            Item 1
          </Box>
          <Box p="p-3" bg="bg-primary-100" rounded="rounded">
            Item 2
      ...
      <div>
        ...
        <Stack spacing="gap-4">
          <Box p="p-3" bg="bg-secondary-100" rounded="rounded">
            Item 1
          </Box>
          <Box p="p-3" bg="bg-secondary-100" rounded="rounded">
            Item 2
      ...
      <div>
        ...
        <Stack spacing="gap-8">
          <Box p="p-3" bg="bg-success-100" rounded="rounded">
            Item 1
          </Box>
          <Box p="p-3" bg="bg-success-100" rounded="rounded">
            Item 2
    ...
    <div className="space-y-8">
      <div>
        ...
        <Stack align="items-start">
          <Box p="p-3" w="w-32" bg="bg-primary-100" rounded="rounded">
            Small
          </Box>
          <Box p="p-3" w="w-48" bg="bg-primary-100" rounded="rounded">
            Medium
          </Box>
          <Box p="p-3" w="w-64" bg="bg-primary-100" rounded="rounded">
            Large
          </Box>
        </Stack>
      </div>
      ...
      <div>
        ...
        <Stack align="items-center">
          <Box p="p-3" w="w-32" bg="bg-secondary-100" rounded="rounded">
            Small
          </Box>
          <Box p="p-3" w="w-48" bg="bg-secondary-100" rounded="rounded">
            Medium
          </Box>
          <Box p="p-3" w="w-64" bg="bg-secondary-100" rounded="rounded">
            Large
          </Box>
        </Stack>
      </div>
      ...
      <div>
        ...
        <Stack align="items-end">
          <Box p="p-3" w="w-32" bg="bg-success-100" rounded="rounded">
            Small
          </Box>
          <Box p="p-3" w="w-48" bg="bg-success-100" rounded="rounded">
            Medium
          </Box>
          <Box p="p-3" w="w-64" bg="bg-success-100" rounded="rounded">
            Large
          </Box>
        </Stack>
      </div>
      ...
      <div>
        ...
        <Stack align="items-stretch">
          <Box p="p-3" bg="bg-warning-100" rounded="rounded">
            Stretched 1
          </Box>
          <Box p="p-3" bg="bg-warning-100" rounded="rounded">
            Stretched 2
    ...
    <div className="space-y-8">
      <div>
        ...
        <Stack direction="horizontal" align="items-start">
          ...
          <Box p="p-6" bg="bg-primary-100" rounded="rounded">
            Large
          </Box>
        </Stack>
      </div>
      ...
      <div>
        ...
        <Stack direction="horizontal" align="items-center">
          <Box p="p-2" bg="bg-secondary-100" rounded="rounded">
            Small
          </Box>
          <Box p="p-4" bg="bg-secondary-100" rounded="rounded">
            Medium
          </Box>
          <Box p="p-6" bg="bg-secondary-100" rounded="rounded">
            Large
          </Box>
        </Stack>
      </div>
      ...
      <div>
        ...
        <Stack direction="horizontal" align="items-end">
          <Box p="p-2" bg="bg-success-100" rounded="rounded">
            Small
          </Box>
          <Box p="p-4" bg="bg-success-100" rounded="rounded">
            Medium
          </Box>
          <Box p="p-6" bg="bg-success-100" rounded="rounded">
            Large
          </Box>
        </Stack>
      </div>
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <Stack
          ...
          className="w-full"
        >
          <Box p="p-3" bg="bg-error-100" rounded="rounded">
            1
          </Box>
          <Box p="p-3" bg="bg-error-100" rounded="rounded">
            2
  ...
  render: () => (
    <div className="space-y-8">
      ...
      <div>
        ...
        >
          <Box p="p-3" bg="bg-grey-50" rounded="rounded">
            Content Block 1
          </Box>
          <Box p="p-3" bg="bg-grey-50" rounded="rounded">
            Content Block 2
    ...
    <div className="space-y-8">
      <div>
        ...
        <Stack direction="horizontal" className="w-64 overflow-auto">
          <Box p="p-3" minW="min-w-24" bg="bg-primary-100" rounded="rounded">
            1
          </Box>
          <Box p="p-3" minW="min-w-24" bg="bg-primary-100" rounded="rounded">
            2
      ...
      <div>
        ...
        <Stack direction="horizontal" wrap="flex-wrap" className="w-64">
          <Box p="p-3" minW="min-w-24" bg="bg-secondary-100" rounded="rounded">
            1
          </Box>
          <Box p="p-3" minW="min-w-24" bg="bg-secondary-100" rounded="rounded">
            2
        ...
        >
          <Stack spacing="gap-3">
            ...
            <Box as="p" color="text-grey-600" className="text-sm">
              This is a card layout example using Stack components for
...
export const Playground: Story = {
  ...
  render: (args) => (
    <Stack {...args}>
      ...
      <Box p="p-4" bg="bg-success-100" rounded="rounded-md">
        Item 3
      </Box>
    </Stack>
  ),

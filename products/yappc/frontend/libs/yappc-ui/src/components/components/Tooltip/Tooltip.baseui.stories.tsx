...
export const CustomStyling: Story = {
  render: () => (
    <div className="flex gap-4">
      <Tooltip content="Success message" className="bg-success-600 text-white">
        <Button color="success">Success Tooltip</Button>
      </Tooltip>

      <Tooltip content="Warning message" className="bg-warning-500 text-white">
        <Button color="warning">Warning Tooltip</Button>
      </Tooltip>

      <Tooltip content="Error message" className="bg-error-600 text-white">

...
function KanbanColumnComponent({
  ...
  return (
    ...
    >
      ...
      {/* Column Items */}
      <Box className="p-4 grow overflow-y-auto min-h-[400px] bg-gray-50 dark:bg-gray-800">
        <SortableContext
...
export function KanbanBoard({
  ...
  const handleDragEnd = (event: DragEndEvent) => {
    ...
    const sourceColumn = columns.find(
      (col) => col.status === draggedItem.status
    );
  ...
  return (
    ...
    >
      <Box className="flex gap-4 overflow-x-auto pb-4 min-h-[600px]">
        {columns

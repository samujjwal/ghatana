...
export const mediaQueries = {
     ...
     */
    up: (breakpoint) => `(min-width: ${breakpoints[breakpoint]}px)`,
    /**
     * Max-width media query
     */
    down: (breakpoint) => `(max-width: ${breakpoints[breakpoint] - 1}px)`,
    /**
     * Between two breakpoints
     */
    between: (min, max) => `(min-width: ${breakpoints[min]}px) and (max-width: ${breakpoints[max] - 1}px)`,
    /**

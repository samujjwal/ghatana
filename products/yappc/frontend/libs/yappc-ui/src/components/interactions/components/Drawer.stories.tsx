...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A side panel drawer component with multiple anchors, variants, and animations. Built with Framer Motion for smooth transitions.',
      },
    },
  },
  tags: ['autodocs'],
...
const DrawerDemo = (
  props: Partial<React.ComponentProps<typeof InteractionDrawer>>
) => {
    ...
    <DrawerDemo anchor="top">
      <Box className="p-6 w-full">
        ...
        <Typography
          ...
          className="mt-2"
        >
          This is a full-width drawer anchored to the top. Useful for
          notifications or banners.
        </Typography>
      </Box>
    </DrawerDemo>
  ),
    ...
    <DrawerDemo anchor="bottom">
      <Box className="p-6 w-full">
        ...
        <Typography
          ...
          className="mt-2"
        >
          This is a full-width drawer anchored to the bottom. Useful for action
          sheets or filters.
        </Typography>
      </Box>
    </DrawerDemo>
    ...
    return (
      <Box className="p-8">
        ...
        <InteractionDrawer
          ...
          onClose={() => setOpen(false)}
          variant={
            { xs: 'temporary', sm: 'temporary', md: 'persistent' } as unknown
          }
        >
          <Box className="p-6 w-[280px]">
            <Typography as="h6" gutterBottom>

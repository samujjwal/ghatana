...
const meta: Meta<typeof AITextCompletion> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'AI-powered text input with inline suggestions. Press Tab to accept, Escape to reject.',
      },
    },
  },
  tags: ['autodocs'],
...
const AITextCompletionWrapper = (
  props: Partial<React.ComponentProps<typeof AITextCompletion>>
) => {
...
export const Streaming: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Streaming mode shows AI completions as they are generated, word by word.',
      },
    },
  },
};
...
export const MultipleInstances: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Multiple independent AI text completion instances on the same page.',
      },
    },
  },
};
    ...
    return (
      <Box className="p-6 rounded-lg w-[700px] bg-gray-50 dark:bg-gray-800">
        ...
        <Typography
          ...
          className="mb-4"
        >
          Type at least 10 characters, wait 500ms, then press Tab to accept
          suggestions.
        </Typography>

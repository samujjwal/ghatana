...
const meta: Meta<typeof SentimentIndicator> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Real-time sentiment analysis with visual feedback. Supports keyword-based and AI-powered analysis.',
      },
    },
  },
  tags: ['autodocs'],
...
export const WithHistory: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Shows historical sentiment analysis. Click the expand button to view history.',
      },
    },
  },
};
...
export const InteractiveLive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Interactive demo with live text input and real-time sentiment feedback.',
      },
    },
  },
};
      ...
      <Box className="p-6 rounded-lg w-[600px] bg-gray-50 dark:bg-gray-800">
        ...
        <Box className="mt-4 p-4 rounded bg-white">
          <Typography
            ...
            color="text.secondary"
          >
            💡 Type and press Enter to add to history. Click the expand button
            to view all.
          </Typography>
        </Box>
      </Box>
...
export const CommentFeedback: Story = {
      ...
      <Box className="p-6 rounded-lg w-[600px] bg-gray-50 dark:bg-gray-800">
        ...
        <Box className="p-4 rounded bg-white">
          ...
          <Box className="flex justify-between items-center">
            ...
            <Box className="px-6 py-2 rounded cursor-pointer bg-blue-600 text-white">
              Post Comment
            </Box>
          </Box>
        </Box>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Practical example: sentiment feedback on user-generated content.',
      },
    },
  },
};

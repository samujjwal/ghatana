...
const meta: Meta<typeof SmartSuggestions> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Context-aware AI suggestions with keyboard navigation. Use arrow keys to navigate, Enter to select.',
      },
    },
  },
  tags: ['autodocs'],
  argTypes: {
    ...
    suggestionTypes: {
      control: 'check',
      options: ['completion', 'edit', 'explain', 'improve'],
    },
...
export const AllSuggestionTypes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Shows all four types of suggestions: completion, edit, explain, and improve.',
      },
    },
  },
};
...
export const EditSuggestions: Story = {
  args: {
    ...
    selection:
      'function getUserData() { return fetch("/api/user").then(r => r.json()) }',
...
export const InteractiveDemo: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Full interactive demo with context input and selection feedback.',
      },
    },
  },
};

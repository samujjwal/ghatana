...
import { palette, lightColors, darkColors, typographyVariants, fontFamilies, spacing, borderRadius, lightShadows, darkShadows, elevationLevels, breakpoints, durations, easings, zIndex, } from '../../tokens/index';
...
const getThemeOptions = (mode) => {
    ...
    return {
        ...
        spacing: (factor) => {
            const mappedValue = spacing[String(factor)];
        ...
        shadows: shadows, // Cast to any to avoid type issues with MUI's shadow type
        components: {
            MuiCssBaseline: {
                styleOverrides: {
                    html: {

...
export const SkipLinks: Story = {
  render: () => (
    <div className="space-y-8">
      ...
      <p className="text-sm text-gray-600">
        Press Tab to see the skip link appear. It's visually hidden until
        focused.
      </p>
      ...
      <div className="border rounded-lg overflow-hidden">
        ...
        <div className="flex">
          ...
          <main role="main" aria-label="Main content" className="flex-1 p-4">
            ...
            >
              <span className="text-xs font-mono">role="region"</span> - Named
              section
            </div>
          </main>
        ...
        <footer role="contentinfo" className="bg-gray-200 p-4">
          <span className="text-sm font-mono">role="contentinfo"</span> - Site
          footer
        </footer>
      </div>
            ...
            >
              {items.map((item, index) => (
                <li
                  ...
                  className={`px-4 py-2 cursor-pointer focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 ${
                    selected === index
              ...
              <tbody className="divide-y">
                <tr>
                  <td className="px-4 py-2">
                    <kbd className="px-1.5 py-0.5 bg-gray-100 rounded">Tab</kbd>
                  </td>
                  <td className="px-4 py-2">Move to next focusable element</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">
                    <kbd className="px-1.5 py-0.5 bg-gray-100 rounded">
                      Enter
                    </kbd>{' '}
                    /{' '}
                    <kbd className="px-1.5 py-0.5 bg-gray-100 rounded">

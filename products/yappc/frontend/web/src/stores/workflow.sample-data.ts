...
export const sampleWorkflows: Workflow[] = [
    ...
    steps: {
      intent: {
        ...
        data: {
          workflowType: 'BUG_FIX',
          goalStatement:
            'Fix the login timeout issue causing users to be logged out after 5 minutes',
          successCriteria: [
    ...
    steps: {
      intent: {
        ...
        data: {
          workflowType: 'FEATURE',
          goalStatement:
            'Build a new user dashboard with real-time analytics and customizable widgets',
          successCriteria: [
      ...
      plan: {
        ...
        data: {
          tasks: [
            {
              id: 't1',
              title: 'Setup dashboard service scaffold',
              status: 'DONE',
              assignee: 'david',
            },
            {
            ...
            {
              id: 't3',
              title: 'Build analytics integration',
              status: 'TODO',
              assignee: 'frank',
            },
            ...
            {
              id: 't5',
              title: 'Implement drag-and-drop layout',
              status: 'TODO',
            },
          ],
    ...
    steps: {
      intent: {
        ...
        data: {
          workflowType: 'RELEASE',
          goalStatement:
            'Deploy Q1 2024 release with new dashboard and auth improvements',
        },
    ...
    steps: {
      intent: {
        ...
        data: {
          workflowType: 'SECURITY_INCIDENT',
          goalStatement:
            'Remediate critical RCE vulnerability in authentication service',
          successCriteria: [
      ...
      context: {
        ...
        data: {
          ...
          threatIntelligence:
            'Active exploitation in the wild reported by CISA',
    ...
    steps: {
      intent: {
        ...
        data: {
          workflowType: 'AUDIT_PREP',
          goalStatement:
            'Prepare for and pass SOC 2 Type II annual audit with zero critical findings',
          successCriteria: [
      ...
      context: {
        ...
        data: {
          previousFindings: [
            'Access review automation needed',
            'MFA coverage gaps',
          ],
          controlsInScope: 142,
          ...
          gaps: [
            ...
            'Backup testing documentation missing',
          ],
        },
    ...
    steps: {
      intent: {
        ...
        data: {
          workflowType: 'INCIDENT',
          goalStatement:
            'Resolve database connection pool exhaustion causing API timeouts',
          successCriteria: [
            'Service restored',
            'Root cause fixed',
            'Monitoring improved',
      ...
      plan: {
        ...
        data: {
          selectedPlan: {
            ...
            description:
              'Patch batch job connection leak and increase pool size',
          },
          mitigationStrategy:
            'Temporarily increase max connections and restart batch job',
        },
      ...
      learn: {
        ...
        data: {
          rootCauses: [
            'Batch job not releasing connections on error',
            'Pool size too conservative',
          ],
          lessons: [
          ...
          improvements: [
            'Add PgBouncer metrics to dashboard',
      ...
      institutionalize: {
        ...
        data: {
          ...
          approvals: [
            {
              approver: 'Tech Lead',
              approvedAt: new Date(Date.now() - 21600000).toISOString(),
            },
          ],
        },
  ...
  // Threat Modeling (Architecture)
  {
    ...
    contributors: [
      {
        userId: 'security-architect',
        userName: 'Security Architect',
        role: 'OWNER',
        joinedAt: new Date(Date.now() - 86400000 * 5).toISOString(),
      },
      {
        userId: 'payments-lead',
    ...
    steps: {
      intent: {
        ...
        data: {
          workflowType: 'THREAT_MODEL',
          goalStatement:
            'Identify and mitigate security threats for new payment gateway integration',
          successCriteria: [
          ...
          threats: [
            {
              id: 'T1',
              category: 'Spoofing',
              description: 'Attacker impersonates merchant',
              mitigation: 'Mutual TLS authentication',
            },
            {
              id: 'T2',
              category: 'Tampering',
              description: 'Transaction amount modification',
              mitigation: 'Request signing with HMAC',
            },
            {
              id: 'T3',
              category: 'Information Disclosure',
              description: 'Card data leakage in logs',
              mitigation: 'PII masking, log sanitization',
            },
          ],
          mitigations: [
            'mTLS for all gateway calls',
            'Request signing',
...
export const sampleTemplates: WorkflowTemplate[] = [
  ...
  },
  {
    ...
    description:
      'Template for security incident response and remediation (SecOps)',
    workflowType: 'SECURITY_INCIDENT',
    category: 'SECOPS',
    defaultIntent: {
      workflowType: 'SECURITY_INCIDENT',
  ...
  },
  {
    ...
    description:
      'Template for controlled release deployment with verification gates',

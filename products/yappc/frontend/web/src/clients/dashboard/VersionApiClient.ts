...
export class VersionApiClient extends BaseDashboardApiClient {
  ...
  async compareVersions(
    ...
    return this.get<CompareVersionsResponse>(`${this.basePath}/compare`, {
      version1: version1Id,
      version2: version2Id,
    });
  }
  ...
  async getSnapshot(
    ...
    return this.get<Record<string, unknown>>(
      `${this.basePath}/versions/${versionId}/snapshot`
    );
  }

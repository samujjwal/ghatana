...
export class AISuggestionsApiClient extends BaseDashboardApiClient {
  ...
  async generateSuggestions(
    ...
    return this.post<AISuggestionResponse[]>(
  ...
  async getPendingSuggestions(
    ...
    return this.get<AISuggestionResponse[]>(`${this.basePath}/pending`, {
      resourceId,
      resourceType,
    });
  }
  ...
  async submitFeedback(
    ...
    return this.post<void>(
      `${this.basePath}/${suggestionId}/feedback`,
      feedback
    );
  }
  ...
  async bulkAccept(
    ...
    return this.post<AISuggestionResponse[]>(`${this.basePath}/bulk-accept`, {
      suggestionIds,
    });
  }
  ...
  async bulkReject(
    ...
    return this.post<AISuggestionResponse[]>(`${this.basePath}/bulk-reject`, {
      suggestionIds,
      reason,
    });
  }
  ...
  private registerDefaultMocks(): void {
    ...
    const mockSuggestions: AISuggestionResponse[] = [
      {
        ...
        description:
          'The requirement description could be more specific about error handling scenarios.',
        suggestedChange: {
        ...
        reasoning:
          'Adding specific authentication protocol and error handling improves implementation guidance.',
      ...
      },
      {
        ...
        reasoning:
          'Single Responsibility Principle suggests separating authentication from user management.',
      ...
      recent: [
        ...
        },
        {
          ...
          feedback: {
            rating: 2,
            helpful: false,
            comment: 'Not applicable to our use case',
          },
        },
      ],
      summary: {
    ...
    // Mock for generate
    this.registerMock<AISuggestionResponse[]>(
      `${this.basePath}/generate`,

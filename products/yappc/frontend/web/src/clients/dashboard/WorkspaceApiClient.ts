...
export class WorkspaceApiClient extends BaseDashboardApiClient {
  ...
  async updateWorkspace(
    ...
    return this.put<WorkspaceResponse>(
  ...
  async deleteWorkspace(
    ...
    ApiResponse<{ workspaceId: string; status: string; deletedAt: string }>
  > {
    return this.delete<{
      workspaceId: string;
      status: string;
  ...
  async listMembers(
    ...
    return this.get<ListMembersResponse>(
  ...
  async getSettings(
    ...
    return this.get<WorkspaceSettingsResponse>(
  ...
  async listTeams(
    workspaceId: string
  ): Promise<ApiResponse<{ teams: TeamResponse[]; total: number }>> {
  ...
  async getTeam(
    ...
    return this.get<TeamResponse>(
      `${this.basePath}/${workspaceId}/teams/${teamId}`
    );
  }

    ...
    <div className="min-h-screen bg-surface text-white p-8">
      <div className="max-w-6xl mx-auto">
          ...
          {(['all', 'active', 'resolved'] as const).map((f) => (
            <Button
              ...
              className={cn(
                ...
                filter === f ? 'bg-surface text-white' : 'text-fg-muted hover:text-white'
              )}
            >
              {f}
            </Button>
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <AlertTriangle className="w-12 h-12 text-fg-muted mb-4" />
          <h3 className="text-lg font-semibold text-fg-muted mb-2">No incidents</h3>

      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-info-bg/10">
              <Rocket className="w-6 h-6 text-info-color" />
            </div>
            <div>
              <h1 className="text-2xl font-bold">Deployments</h1>
              <p className="text-fg-muted">Pipeline runs, environment status, and release history</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          {['Development', 'Staging', 'Production'].map((env) => (
            <div key={env} className="p-4 rounded-xl bg-surface border border-border">
              ...
              <div className="text-xs text-fg-muted">No active deployment</div>
            </div>
          ))}
        </div>

        <div className="flex flex-col items-center justify-center py-16 text-center">
          <Rocket className="w-12 h-12 text-fg-muted mb-4" />
          <h3 className="text-lg font-semibold text-fg-muted mb-2">No deployments yet</h3>

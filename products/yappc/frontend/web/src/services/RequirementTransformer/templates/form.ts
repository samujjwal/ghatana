...
export const formTemplate: PageConfig = {
  ...
  components: [
    ...
    },
    {
      ...
      position: { x: 24, y: 70, width: 400, height: 30 },
    },
    {
      id: 'form-container',
      type: 'Container',
      ...
      children: ['form-field-1', 'form-field-2', 'form-field-3', 'submit-button'],
      position: { x: 0, y: 120, width: 800, height: 400 },
    },
    {
      id: 'form-field-1',
      type: 'TextField',
    ...
    },
    {
      ...
      position: { x: 24, y: 180, width: 550, height: 120 },
    },
    {
      id: 'submit-button',
      type: 'Button',
      ...
      position: { x: 24, y: 320, width: 120, height: 40 },
    },
  ],
  connections: {
    events: [
    ...
    data: [
      {
        id: 'data-binding-1',
        sourceComponentId: 'form-field-1',
        targetComponentId: 'form-container',
        bindingType: 'formData.name',
      },
      {
        id: 'data-binding-2',
        sourceComponentId: 'form-field-2',
        targetComponentId: 'form-container',
        bindingType: 'formData.email',
      },
    ],
    navigation: [],
  },

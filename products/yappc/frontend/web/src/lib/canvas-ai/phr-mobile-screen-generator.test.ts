/**
 * Tests for PHR Mobile Screen Generator (YAPPC-T08)
 */

import { describe, it, expect } from 'vitest';
import { createPhrMobileScreenGenerator, type PhrRouteContract } from './phr-mobile-screen-generator';

describe('PhrMobileScreenGenerator', () => {
      ...
      routes: [
        {
          ...
          minimumRole: 'patient',
          surface: ['mobile'],
          i18nKey: 'phr.routes.mobileDashboard.label',
          descriptionI18nKey: 'phr.routes.mobileDashboard.description',
        },
      ],
    };

    const generator = createPhrMobileScreenGenerator();

...
export const FOW_STAGE_DESCRIPTIONS: Record<FOWStage, string> = {
  ...
  [FOWStage.SOLUTION_DESIGN]:
    'Design architecture and make technical decisions',
...
export const FOW_STAGE_CONFIGS: Record<FOWStage, FOWStageConfig> = {
  ...
  [FOWStage.DISCOVERY]: {
    ...
    primaryPhase: LifecyclePhase.INTENT,
    requiredArtifacts: [
      ArtifactType.PROBLEM_STATEMENT_METRICS,
  ...
  [FOWStage.SOLUTION_DESIGN]: {
    ...
    gate: {
      ...
      requiredArtifacts: [
        {
          type: ArtifactType.ARCHITECTURE_DECISION_RECORD,
          minCount: 1,
          requiredStatus: 'approved',
        },
      ],
  ...
  [FOWStage.VERIFY_RELEASE]: {
    ...
    gate: {
      ...
      requiredArtifacts: [
        {
          type: ArtifactType.RELEASE_PACKET,
          minCount: 1,
          requiredStatus: 'approved',
        },
      ],
  ...
  [FOWStage.OPERATE_OBSERVE]: {
    ...
    gate: {
      id: 'ops-gate',
      requiredArtifacts: [{ type: ArtifactType.OPS_BASELINE, minCount: 1 }],
    },
  ...
  [FOWStage.ENHANCE_EVOLVE]: {
    ...
    gate: {
      id: 'enhance-gate',
      requiredArtifacts: [{ type: ArtifactType.ENHANCEMENT, minCount: 1 }],
    },

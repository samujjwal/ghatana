...
import { SpeedDial, SpeedDialAction, SpeedDialIcon } from '@ghatana/design-system';
  ...
  return (
    ...
    >
      <SpeedDial
        ...
        open={open}
        direction="up"
        className="[&_.MuiSpeedDial-fab]:bg-info-color [&_.MuiSpeedDial-fab:hover]:bg-info-bg [&_.MuiSpeedDial-fab]:shadow-lg"
      >
        {actions.map((action) => (
          <SpeedDialAction
            key={action.id}

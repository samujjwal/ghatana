...
describe('TypeSelectorModal', () => {
    ...
    describe('Rendering', () => {
        ...
        it('should display current type', () => {
            ...
            expect(screen.getAllByText('Code Editor')[0]).toBeInTheDocument();
        });
    });
    ...
    describe('All Types Section', () => {
        ...
        it('should expand all types when accordion clicked', async () => {
            ...
            await waitFor(() => {
                expect(screen.getAllByText(/code/i)[0]).toBeInTheDocument();
            });
        });
    ...
    describe('Type Selection', () => {
        it('should allow selecting a type', async () => {
            ...
            const testType = screen.getAllByText(/Test Case/i)[0];
    ...
    describe('User Actions', () => {
        ...
        it('should close modal after type change', async () => {
            ...
            // Select and confirm
            await user.click(screen.getAllByText(/Test Case/i)[0]);

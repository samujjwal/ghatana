...
import { Fade, Slide } from '@ghatana/design-system';
                        ...
                        <Stack spacing={1.5}>
                            ...
                            <Stack direction="row" alignItems="flex-start" justifyContent="space-between">
                                <Stack direction="row" alignItems="center" spacing={1}>
                                    <Box
                                        className="flex items-center justify-center rounded-full w-[32px] h-[32px] bg-info-color" style={{ animation: 'pulse 2s ease-in-out infinite' }} >

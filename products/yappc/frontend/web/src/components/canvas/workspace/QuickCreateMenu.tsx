...
import { Menu, MenuItem, ListItemIcon, ListItemText, Typography, Divider, Box, TextField, InputAdornment } from '@ghatana/design-system';
        ...
        >
            ...
            <Box className="px-4 py-3 border-border dark:border-border border-b" >
                <TextField
                    ...
                    fullWidth
                    size="sm"
                    placeholder={t('canvas.quickCreate.searchPlaceholder')}
                    value={searchQuery}

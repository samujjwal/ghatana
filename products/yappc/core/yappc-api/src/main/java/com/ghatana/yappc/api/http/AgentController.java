...
public final class AgentController {
    ...
    /**
     * Creates a new AgentController with no-op audit logging.
     *
    ...
    public AgentController(
        ...
        this(registry, objectMapper, AuditLogger.noop());
    }
     ...
     * @param registry The agent registry
     * @param objectMapper JSON object mapper
     * @param auditLogger Audit logger for security-relevant events
     */
    public AgentController(
            @NotNull AgentRegistry registry,
            @NotNull ObjectMapper objectMapper,
        ...
        this.auditLogger = Objects.requireNonNull(auditLogger, "auditLogger is required");
    }
        ...
        return agent.execute(input, context)
                .map(result -> {
                    auditLogger.log(Map.of(
                            ...
                            "agent", name.name(),
                            "tenantId", context.tenantId() != null ? context.tenantId() : "unknown",
                            "userId", context.userId() != null ? context.userId() : "unknown",
                            "durationMs", System.currentTimeMillis() - startMs
                    ));
                    return toExecuteResponse(name, result);
                })
                .whenException(err -> auditLogger.log(Map.of(

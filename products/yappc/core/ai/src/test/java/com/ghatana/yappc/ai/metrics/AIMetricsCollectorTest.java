 ...
 */
@DisplayName("AIMetricsCollector [GH-90000]")
class AIMetricsCollectorTest {
    ...
    @Nested
    @DisplayName("recordLlmCall [GH-90000]")
    class RecordLlmCall {

        @Test
        @DisplayName("increments LLM requests counter on success [GH-90000]")
        ...
        @Test
        @DisplayName("increments LLM error counter on failure [GH-90000]")
        ...
        @Test
        @DisplayName("does not increment error counter on successful call [GH-90000]")
        void doesNotIncrementErrorCounterOnSuccess() { // GH-90000
            ...
            var errorMeter = registry.find("yappc.ai.llm.errors.total [GH-90000]")
        ...
        @Test
        @DisplayName("records latency timer [GH-90000]")
        void recordsLatencyTimer() { // GH-90000
            collector.recordLlmCall("claude-3-sonnet", "suggestion", "tenant-1", // GH-90000
                    true, 750L, 100, 150, 0.008);

            double totalTime = registry.find("yappc.ai.llm.latency.seconds [GH-90000]")
        ...
        @Test
        @DisplayName("records input and output token distributions [GH-90000]")
        void recordsTokenDistributions() { // GH-90000
            ...
            double inputMean = registry.find("yappc.ai.llm.tokens.input [GH-90000]")
                    .tag("model", "claude-3-sonnet") // GH-90000
                    .summary().mean(); // GH-90000
            double outputMean = registry.find("yappc.ai.llm.tokens.output [GH-90000]")
                    .tag("model", "claude-3-sonnet") // GH-90000
                    .summary().mean(); // GH-90000
    ...
    @Test
    @DisplayName("recordLlmError increments error counter with error_type tag [GH-90000]")
    void recordLlmErrorIncrementsCounter() { // GH-90000
        ...
        double count = registry.find("yappc.ai.llm.errors.total [GH-90000]")
    ...
    @Nested
    @DisplayName("cache metrics [GH-90000]")
    class CacheMetrics {

        @Test
        @DisplayName("recordCacheHit increments cache hits counter [GH-90000]")
        void recordCacheHitIncrementsCounter() { // GH-90000
            collector.recordCacheHit("suggestion", "tenant-1"); // GH-90000

            double count = registry.find("yappc.ai.cache.hits.total [GH-90000]")
        ...
        @Test
        @DisplayName("recordCacheMiss increments cache misses counter [GH-90000]")
        void recordCacheMissIncrementsCounter() { // GH-90000
            collector.recordCacheMiss("generation", "tenant-1"); // GH-90000

            double count = registry.find("yappc.ai.cache.misses.total [GH-90000]")
    ...
    @Test
    @DisplayName("recordFallback increments fallback counter [GH-90000]")
    void recordFallbackIncrementsCounter() { // GH-90000
        collector.recordFallback("claude-3-sonnet", "RATE_LIMIT", "tenant-1"); // GH-90000

        double count = registry.find("yappc.ai.fallback.total [GH-90000]")
                .tag("model", "claude-3-sonnet") // GH-90000
                .counter().count(); // GH-90000
        assertThat(count).isEqualTo(1.0); // GH-90000
    }
    ...
    @Nested
    @DisplayName("suggestion feedback [GH-90000]")
    class SuggestionFeedback {

        @Test
        @DisplayName("recordSuggestionAccepted increments accepted counter [GH-90000]")
        void recordSuggestionAcceptedIncrementsCounter() { // GH-90000
            collector.recordSuggestionAccepted("suggestion", "tenant-1"); // GH-90000

            double count = registry.find("yappc.ai.suggestion.accepted.total [GH-90000]")
                    .tag("feature", "suggestion") // GH-90000
                    .counter().count(); // GH-90000
            assertThat(count).isEqualTo(1.0); // GH-90000
        }
        ...
        @Test
        @DisplayName("recordSuggestionRejected increments rejected counter [GH-90000]")
        void recordSuggestionRejectedIncrementsCounter() { // GH-90000
            collector.recordSuggestionRejected("suggestion", "tenant-1"); // GH-90000

            double count = registry.find("yappc.ai.suggestion.rejected.total [GH-90000]")
                    .tag("feature", "suggestion") // GH-90000
                    .counter().count(); // GH-90000
            assertThat(count).isEqualTo(1.0); // GH-90000
        }
    ...
    @Test
    @DisplayName("null model tag does not crash [GH-90000]")

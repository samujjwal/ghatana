...
public final class SuggestionRanker {
   ...
   */
  public static java.util.Map<com.ghatana.requirements.ai.persona.Persona, Integer> distributionByPersona(
      List<AISuggestion> suggestions) {
    java.util.Map<com.ghatana.requirements.ai.persona.Persona, Integer> distribution =

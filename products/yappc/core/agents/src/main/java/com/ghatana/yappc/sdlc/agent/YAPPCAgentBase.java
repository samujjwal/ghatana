...
public abstract class YAPPCAgentBase<I, O> extends BaseAgent<StepRequest<I>, StepResult<O>>
  ...
  private static volatile AepEventPublisher aepEventPublisher = HttpAepEventPublisher.fromEnvironment();

  private final String stepName;
  private final StepContract stepContract;

  /**
   * Constructs a YAPPC agent with the given configuration.
   *

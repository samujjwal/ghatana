...
/**
 * Result of Maven build specification validation.
 * @doc.type class
 * @doc.purpose Result of Maven build specification validation.
 * @doc.layer platform
 * @doc.pattern Value Object
 */
public class MavenValidationResult {

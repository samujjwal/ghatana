...
/**
 * Python project analysis result.
 *
 * @doc.type record
 * @doc.purpose Analysis result for Python projects
 * @doc.layer platform
 * @doc.pattern Data Transfer Object
 */
public record PythonAnalysisResult(
        @JsonProperty("projectType") PythonBuildSpec.PythonProjectType projectType,
        @JsonProperty("detectedDependencies") List<String> detectedDependencies,
        @JsonProperty("pythonVersion") String pythonVersion,
        @JsonProperty("buildTool") PythonBuildSpec.PythonBuildTool buildTool,
        @JsonProperty("hasTests") boolean hasTests,
        @JsonProperty("hasTypeHints") boolean hasTypeHints,

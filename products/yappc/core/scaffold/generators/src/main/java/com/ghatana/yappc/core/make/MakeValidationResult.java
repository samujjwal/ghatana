...
/**
 * Result of Make build specification validation.
 * @doc.type class
 * @doc.purpose Result of Make build specification validation.
 * @doc.layer platform
 * @doc.pattern Value Object
 */
public class MakeValidationResult {

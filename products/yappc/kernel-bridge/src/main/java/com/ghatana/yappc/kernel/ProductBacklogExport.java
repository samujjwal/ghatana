...
/**
 * G10-009: Product Backlog Export
 *
 * Exports Product backlog grouped by verification pass for tracking
 * implementation progress across different verification stages.
 *
 * @doc.type class
 * @doc.purpose Export Product backlog grouped by verification pass
 * @doc.layer integration
 * @doc.pattern Export
 */
public class ProductBacklogExport {
    ...
    public String generateMarkdownExport() {
        ...
        md.append("# Product Backlog Export\n\n");

...
public final class DmosActionPermissionRegistry {
    ...
    private static final Map<String, String> ACTION_MINIMUM_ROLES = Map.ofEntries(
        ...
        Map.entry("approve-campaign", "marketing-director"),
        ...
        Map.entry("request-campaign-approval", "brand-manager"),
        ...
        Map.entry("transition-campaign", "brand-manager"),

...
@DisplayName("DmGoogleAdsCampaignLinkEphemeralRepository")
class DmGoogleAdsCampaignLinkEphemeralRepositoryTest extends EventloopTestBase {

    private DmGoogleAdsCampaignLinkEphemeralRepository repository;

    @BeforeEach
    void setUp() {
        repository = new DmGoogleAdsCampaignLinkEphemeralRepository();
    }

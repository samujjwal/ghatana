...
@DisplayName("DmConnectorInMemoryRepository")
class DmConnectorInMemoryRepositoryTest extends EventloopTestBase {

    private DmConnectorInMemoryRepository repository;

    @BeforeEach
    void setUp() {
        repository = new DmConnectorInMemoryRepository();
    }

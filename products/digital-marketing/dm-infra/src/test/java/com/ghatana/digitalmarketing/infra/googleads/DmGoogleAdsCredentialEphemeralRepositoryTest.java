...
@DisplayName("DmGoogleAdsCredentialEphemeralRepository")
class DmGoogleAdsCredentialEphemeralRepositoryTest extends EventloopTestBase {

    private DmGoogleAdsCredentialEphemeralRepository repository;

    @BeforeEach
    void setUp() {
        repository = new DmGoogleAdsCredentialEphemeralRepository();
    }

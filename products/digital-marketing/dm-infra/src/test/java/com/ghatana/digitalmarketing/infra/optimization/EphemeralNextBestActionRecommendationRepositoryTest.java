...
/**
 * @doc.type class
 * @doc.purpose Unit tests for EphemeralNextBestActionRecommendationRepository
 * @doc.layer product
 * @doc.pattern Test
 */
@DisplayName("EphemeralNextBestActionRecommendationRepository")
class EphemeralNextBestActionRecommendationRepositoryTest extends EventloopTestBase {

    private EphemeralNextBestActionRecommendationRepository repository;

    @BeforeEach
    void setUp() {
        repository = new EphemeralNextBestActionRecommendationRepository();
    }

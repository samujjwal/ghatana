...
@DisplayName("EphemeralContentVersionRepository")
class EphemeralContentVersionRepositoryTest extends EventloopTestBase {

    private EphemeralContentVersionRepository repository;
    ...
    @BeforeEach
    void setUp() {
        repository = new EphemeralContentVersionRepository();
    }

...
@DisplayName("EphemeralApprovalSnapshotRepository")
class EphemeralApprovalSnapshotRepositoryTest extends EventloopTestBase {

    private EphemeralApprovalSnapshotRepository repository;

    private static final String WS_ID = "ws-1";

    @BeforeEach
    void setUp() {
        repository = new EphemeralApprovalSnapshotRepository();
    }

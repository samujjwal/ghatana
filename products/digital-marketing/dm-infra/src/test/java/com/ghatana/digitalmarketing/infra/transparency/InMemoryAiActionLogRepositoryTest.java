...
@DisplayName("InMemoryAiActionLogRepository")
class InMemoryAiActionLogRepositoryTest extends EventloopTestBase {

    private InMemoryAiActionLogRepository repository;
    ...
    @BeforeEach
    void setUp() {
        repository = new InMemoryAiActionLogRepository();
    }

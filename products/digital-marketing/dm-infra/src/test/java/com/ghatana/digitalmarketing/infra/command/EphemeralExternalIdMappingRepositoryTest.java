...
@DisplayName("EphemeralExternalIdMappingRepository")
class EphemeralExternalIdMappingRepositoryTest extends EventloopTestBase {

    private EphemeralExternalIdMappingRepository repository;
    private DmOperationContext context;

    @BeforeEach
    void setUp() {
        repository = new EphemeralExternalIdMappingRepository();

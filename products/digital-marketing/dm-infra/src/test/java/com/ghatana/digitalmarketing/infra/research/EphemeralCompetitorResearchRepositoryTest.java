...
@DisplayName("EphemeralCompetitorResearchRepository")
class EphemeralCompetitorResearchRepositoryTest extends EventloopTestBase {

    private EphemeralCompetitorResearchRepository repository;
    ...
    @BeforeEach
    void setUp() {
        repository = new EphemeralCompetitorResearchRepository();
    }

...
/**
 * @doc.type class
 * @doc.purpose Unit tests for InMemoryExperimentSuggestionRepository
 * @doc.layer product
 * @doc.pattern Test
 */
@DisplayName("InMemoryExperimentSuggestionRepository")
class InMemoryExperimentSuggestionRepositoryTest extends EventloopTestBase {

    private InMemoryExperimentSuggestionRepository repository;

    @BeforeEach
    void setUp() {
        repository = new InMemoryExperimentSuggestionRepository();
    }

...
@DisplayName("EphemeralContentItemRepository")
class EphemeralContentItemRepositoryTest extends EventloopTestBase {

    private EphemeralContentItemRepository repository;
    ...
    @BeforeEach
    void setUp() {
        repository = new EphemeralContentItemRepository();
    }

...
export const dmosRouteManifest: readonly DmosRouteManifestEntry[] = [
  ...
  {
    path: '/v1/workspaces/:workspaceId/next-best-action-recommendations',
    uiPath: '/workspaces/:workspaceId/ai-optimization',
    label: 'AI Optimization',
    description: 'AI-driven next-best-action recommendations, anomaly detection, and budget optimization.',
    group: 'Intelligence',
  ...
  {
    path: '/v1/workspaces/:workspaceId/next-best-action-recommendations/:recId',
    uiPath: '/workspaces/:workspaceId/ai-optimization',
    label: 'AI Optimization',
    description: 'AI-driven next-best-action recommendations, anomaly detection, and budget optimization.',
    group: 'Intelligence',
  ...
  {
    path: '/v1/workspaces/:workspaceId/next-best-action-recommendations/:recId/approve',
    uiPath: '/workspaces/:workspaceId/ai-optimization',
    label: 'AI Optimization',
    description: 'AI-driven next-best-action recommendations, anomaly detection, and budget optimization.',
    group: 'Intelligence',
  ...
  {
    path: '/v1/workspaces/:workspaceId/next-best-action-recommendations/:recId/reject',
    uiPath: '/workspaces/:workspaceId/ai-optimization',
    label: 'AI Optimization',
    description: 'AI-driven next-best-action recommendations, anomaly detection, and budget optimization.',
    group: 'Intelligence',

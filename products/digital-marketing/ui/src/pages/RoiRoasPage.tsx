  ...
  return (
    <section data-testid="roi-roas-page" className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="border border-dashed border-gray-300 rounded-lg p-12 text-center text-gray-400">
        <p className="text-lg font-medium">ROI &amp; ROAS Reporting Coming Soon</p>
        <p className="text-sm mt-2">Return-on-investment and return-on-ad-spend dashboards will be available here.</p>
      </div>
    </section>
  );
}

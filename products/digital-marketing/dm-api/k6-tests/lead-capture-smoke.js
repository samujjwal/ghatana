...
/**
 * Phase 1: Lightweight performance smoke test for Digital Marketing lead capture
 *
 * Validates that lead capture workflow meets SLO latency thresholds:
 * - p50 latency < 200ms
 * - p95 latency < 800ms
 * - throughput >= 40 rps
 * - error rate < 1%
...
export default function () {
  ...
  const success = check(res, {
    ...
    'has lead ID': (r) => r.json('leadId') !== undefined,
  });

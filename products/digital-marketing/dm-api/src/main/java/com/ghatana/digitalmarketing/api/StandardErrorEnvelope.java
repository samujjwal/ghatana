...
public record StandardErrorEnvelope(
     ...
     */
    public StandardErrorEnvelope(int code, String safeMessage, String correlationId) {
        this(code, safeMessage, correlationId, Map.of());
    }
     ...
     */
    public static StandardErrorEnvelope of(int code, String safeMessage, String correlationId) {
        return new StandardErrorEnvelope(code, safeMessage, correlationId);
    }
    ...
    public static StandardErrorEnvelope withDetails(
        ...
        return new StandardErrorEnvelope(code, safeMessage, correlationId, details);
    }
}

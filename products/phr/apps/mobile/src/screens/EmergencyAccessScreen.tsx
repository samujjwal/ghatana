    ...
    return (
      <View style={styles.container} accessibilityLabel={t("emergency.title")}>
        ...
        <Text style={styles.summary}>
          {state === "verifying"
            ? t("emergency.requesting")
            : t("emergency.serverApproval")}
        </Text>
      </View>
    );
  }
    ...
    return (
      ...
      >
        ...
        <Text style={styles.summary}>
          ...
          {reason || t("emergency.reasonPlaceholder")}
        </Text>
  ...
  return (
    <View style={styles.container} accessibilityLabel={t("emergency.title")}>
      ...
      <Pressable
        ...
        style={[
          styles.button,
          (!patientId.trim() || !reason.trim()) && styles.buttonDisabled,
        ]}
        accessibilityRole="button"

...
@DisplayName("DataCloudAgentRegistry – Agent Lifecycle & Execution [GH-90000]")
class DataCloudAgentRegistryComprehensiveTest extends EventloopTestBase {
    ...
    void setUp() { // GH-90000
        ...
        nlpConfig = AgentConfig.builder() // GH-90000
                .agentId("nlp-processor-v1 [GH-90000]")
                .type(AgentType.PROBABILISTIC) // GH-90000
                .version("1.5.0 [GH-90000]")
    ...
    @Nested
    @DisplayName("Agent Registration & Lifecycle [GH-90000]")
    class RegistrationTests {

        @Test
        @DisplayName("[REG-001]: register_persists_descriptor_to_datacloud [GH-90000]")
        ...
        @Test
        @DisplayName("[REG-002]: register_populates_in_memory_cache [GH-90000]")
        ...
        @Test
        @DisplayName("[REG-003]: register_multiple_agents_independently [GH-90000]")
        ...
        @Test
        @DisplayName("[REG-004]: register_replaces_existing_registration [GH-90000]")
        ...
        @Test
        @DisplayName("[REG-005]: register_propagates_datacloud_failure [GH-90000]")
        ...
        @Test
        @DisplayName("[REG-006]: register_with_null_agent_rejected [GH-90000]")
        ...
        @Test
        @DisplayName("[REG-007]: register_with_null_config_rejected [GH-90000]")
    ...
    @Nested
    @DisplayName("Agent Resolution & Discovery [GH-90000]")
    class ResolutionTests {

        @Test
        @DisplayName("[RES-008]: resolve_returns_cached_agent [GH-90000]")
        ...
        @Test
        @DisplayName("[RES-009]: resolve_nonexistent_agent_returns_empty [GH-90000]")
        void resolveNonexistentReturnsEmpty() { // GH-90000
            // When
            Optional<TypedAgent<String, String>> resolved =
                    runPromise(() -> registry.resolve("nonexistent-agent [GH-90000]"));
        ...
        @Test
        @DisplayName("[RES-010]: listAgentIds_returns_all_registered_agents [GH-90000]")
        ...
        @Test
        @DisplayName("[RES-011]: listAgentIds_empty_registry_returns_empty_set [GH-90000]")
        ...
        @Test
        @DisplayName("[RES-012]: findByCapability_filters_agents_by_capability [GH-90000]")
        void findByCapabilityFiltersAgents() { // GH-90000
            ...
            List<String> fraudAgentIds = runPromise(() -> // GH-90000
                    registry.findByCapability("fraud-detection [GH-90000]"));

            // Then
            assertThat(fraudAgentIds) // GH-90000
                    .hasSize(1) // GH-90000
                    .contains("fraud-detector-v1 [GH-90000]");
        }

        @Test
        @DisplayName("[RES-013]: findByCapability_returns_multiple_matches [GH-90000]")
        ...
        @Test
        @DisplayName("[RES-014]: getStats_returns_registry_statistics [GH-90000]")
        void getStatsReturnsStatistics() { // GH-90000
            ...
            // Then
            assertThat(stats).containsKey("registeredAgents [GH-90000]")
                    .containsKey("persistedAgents [GH-90000]")
                    .containsKey("registryTenantId [GH-90000]");
        }
    }
    ...
    @Nested
    @DisplayName("Agent Execution & Delegation [GH-90000]")
    class ExecutionTests {

        @Test
        @DisplayName("[EXE-015]: registered agent is resolvable and processable [GH-90000]")
        void executeDelegatesToAgent() { // GH-90000
            ...
            when(mockAgent.process(any(), eq("input [GH-90000]")))
            ...
            // When
            Optional<TypedAgent<String, String>> resolved =
                    runPromise(() -> registry.resolve("test-agent [GH-90000]"));
            ...
            verify(mockAgent).process(any(), eq("input [GH-90000]"));
        }

        @Test
        @DisplayName("[EXE-016]: resolve_unregistered_agent_returns_empty [GH-90000]")
        void executeUnregisteredAgentThrowsError() { // GH-90000
            // When
            Optional<TypedAgent<String, String>> resolved =
                    runPromise(() -> registry.resolve("nonexistent [GH-90000]"));
    ...
    @Nested
    @DisplayName("Cache Management & TTL Eviction [GH-90000]")
    class CacheManagementTests {

        @Test
        @DisplayName("[CACHE-017]: cache_stores_agents_in_memory [GH-90000]")
        ...
        @Test
        @DisplayName("[CACHE-018]: cache_respects_ttl_eviction [GH-90000]")
        ...
        @Test
        @DisplayName("[CACHE-019]: cache_respects_max_size_lru_eviction [GH-90000]")
        ...
        @Test
        @DisplayName("[CACHE-020]: concurrent_cache_access_safe [GH-90000]")
        void concurrentCacheAccessSafe() { // GH-90000
            ...
            for (int i = 0; i < 100; i++) { // GH-90000
                runPromise(() -> registry.resolve("fraud-detector-v1 [GH-90000]"));
                runPromise(() -> registry.resolve("anomaly-detector-v1 [GH-90000]"));
            }
    ...
    @Nested
    @DisplayName("Agent Deregistration [GH-90000]")
    class DeregistrationTests {

        @Test
        @DisplayName("[DEREG-021]: deregister_removes_from_cache_and_datacloud [GH-90000]")
        void deregisterRemovesAgent() { // GH-90000
            ...
            // When
            Void result = runPromise(() -> registry.deregister("fraud-detector-v1 [GH-90000]"));
        ...
        @Test
        @DisplayName("[DEREG-022]: deregister_nonexistent_agent_safe [GH-90000]")
        void deregisterNonexistentSafe() { // GH-90000
            // When & Then: Should not throw
            Void result = runPromise(() -> registry.deregister("nonexistent [GH-90000]"));
            assertThat(result).isNull(); // GH-90000
        }

        @Test
        @DisplayName("[DEREG-023]: deregister_propagates_datacloud_failure [GH-90000]")
    ...
    class TenantIsolationTests {
        ...
        @Test
        @DisplayName("[TENANT-024]: registration_respects_tenant_boundary [GH-90000]")
        ...
        @Test
        @DisplayName("[TENANT-025]: registry_isolated_by_tenant [GH-90000]")
    ...
    @Nested
    @DisplayName("Integration Scenarios [GH-90000]")
    class IntegrationTests {

        @Test
        @DisplayName("[INT-026]: full_lifecycle_register_resolve_execute_deregister [GH-90000]")
        void fullLifecycle() { // GH-90000
            ...
            assertThat(ids).contains("fraud-detector-v1 [GH-90000]");
        }

        @Test
        @DisplayName("[INT-027]: registry_handles_mixed_operations [GH-90000]")

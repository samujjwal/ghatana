...
class PiiLeakagePreventionTest {
    ...
    void setUp() { 
        ...
        masker = new OptimizedFieldMasker(policy, 256, true); 
    }
    ...
    class RegulatoryPiiFields {
        ...
        void sinIsFullyMasked() { 
            String masked = masker.mask("sin", "123 456 789"); 
            assertThat(masked).doesNotContain("123").doesNotContain("789");
        }

        @Test
        @DisplayName("Tax ID is fully masked")
        void taxIdIsFullyMasked() { 
            String masked = masker.mask("taxId", "98-7654321"); 
        ...
        void dateOfBirthIsRedacted() { 
            String masked = masker.mask("dob", "1985-07-04"); 
        ...
        void dateOfBirthFieldAlsoRedacted() { 
            String masked = masker.mask("dateOfBirth", "04/07/1985"); 
            assertThat(masked).isEqualTo("[REDACTED]");
        }
    }
    ...
    class ContactAndIdentityFields {
        ...
        void emailIsPartiallyMasked() { 
            String masked = masker.mask("email", "alice.smith@example.com"); 
        ...
        void phoneNumberShowsLastFourDigits() { 
            String masked = masker.mask("phone", "+1 (800) 555-1234"); 
        ...
        void mobilePhoneShowsLastFourDigits() { 
            String masked = masker.mask("mobilePhone", "6045559876"); 
    ...
    class FinancialFields {
        ...
        void creditCardShowsLastFourDigits() { 
            String masked = masker.mask("creditCard", "4111 1111 1111 4321"); 
        ...
        void cardNumberFieldMaskedLikeCreditCard() { 
            String masked = masker.mask("cardNumber", "5500000000000004"); 
        ...
        void bankAccountFullyMasked() { 
            String masked = masker.mask("bankAccount", "00123456789"); 
            assertThat(masked).doesNotContain("0012").doesNotContain("6789");
        }

        @Test
        @DisplayName("routing number is fully masked")
        void routingNumberFullyMasked() { 
            String masked = masker.mask("routingNumber", "021000021"); 
    ...
    class CredentialAndSecretFields {
        ...
        void passwordIsRedacted() { 
            String masked = masker.mask("password", "Sup3rS3cr3t!"); 
            assertThat(masked).isEqualTo("[REDACTED]");
        ...
        void apiKeyIsRedacted() { 
            String masked = masker.mask("apiKey", "sk-prod-abc123xyzSecret"); 
            assertThat(masked).isEqualTo("[REDACTED]");
        ...
        void secretKeyIsRedacted() { 
            String masked = masker.mask("secretKey", "AKIAIOSFODNN7EXAMPLE"); 
            assertThat(masked).isEqualTo("[REDACTED]");
        }
        ...
        void accessTokenIsRedacted() { 
            String masked = masker.mask("accessToken", "Bearer eyJhbGciOiJSUzI1NiJ9.payload.sig"); 
            assertThat(masked).isEqualTo("[REDACTED]");
    ...
    class BatchExportPiiLeakagePrevention {
        ...
        void allPiiFieldsInRecordAreMaskedInBatch() { 
            ...
            Map<String, String> masked = masker.maskBatch(exportRecord); 
        ...
        void nullAndEmptyPiiValuesHandledSafely() { 
            Map<String, String> exportRecord = new HashMap<>();
        ...
        void largeBatchHasNoPiiLeakage() { 
            ...
            for (int i = 0; i < 200; i++) { 
                ...
                Map<String, String> masked = masker.maskBatch(record); 

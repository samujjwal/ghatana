...
public class WebhookController {
     ...
     * @return Promise of HTTP response
     */
        @Operation(summary = "Create webhook", description = "Registers a webhook subscription for the caller tenant.")
        @ApiResponses({
     ...
     * @return Promise of HTTP response
     */
        @Operation(summary = "List webhooks", description = "Lists webhook subscriptions for the caller tenant.")
        @ApiResponses({
     ...
     * @return Promise of HTTP response
     */
        @Operation(summary = "Get webhook", description = "Returns a webhook subscription by identifier.")
        @ApiResponses({
     ...
     * @return Promise of HTTP response
     */
        @Operation(summary = "Update webhook", description = "Updates webhook URL or enabled state for the caller tenant.")
        @ApiResponses({
     ...
     * @return Promise of HTTP response
     */
        @Operation(summary = "Delete webhook", description = "Deletes a webhook subscription for the caller tenant.")
        @ApiResponses({

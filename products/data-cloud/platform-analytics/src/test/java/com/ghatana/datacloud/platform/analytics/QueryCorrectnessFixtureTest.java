 ...
 * @doc.pattern Test
 */
@DisplayName("[Analytics]: query_correctness_aggregation_reporting [GH-90000]")
class QueryCorrectnessFixtureTest extends EventloopTestBase {
    ...
    @Test
    @DisplayName("[SUM]: total_quantity_across_all_sales [GH-90000]")
    void totalQuantityAcrossAllSales() { // GH-90000
        int totalQuantity = SALES_DATA.stream() // GH-90000
            .mapToInt(s -> (Integer) s.get("quantity [GH-90000]"))
            .sum(); // GH-90000
    ...
    @Test
    @DisplayName("[SUM]: total_revenue_calculated_correctly [GH-90000]")
    void totalRevenueCalculatedCorrectly() { // GH-90000
        double totalRevenue = SALES_DATA.stream() // GH-90000
            .mapToDouble(s -> (Integer) s.get("quantity [GH-90000]") * (Double) s.get("price [GH-90000]"))
            .sum(); // GH-90000
    ...
    @Test
    @DisplayName("[SUM]: revenue_by_product_grouped_correctly [GH-90000]")
    void revenueByProductGroupedCorrectly() { // GH-90000
        Map<String, Double> revenueByProduct = SALES_DATA.stream() // GH-90000
            .collect(Collectors.groupingBy( // GH-90000
                s -> (String) s.get("product [GH-90000]"),
                Collectors.summingDouble(s -> (Integer) s.get("quantity [GH-90000]") * (Double) s.get("price [GH-90000]"))
            ));
    ...
    @Test
    @DisplayName("[COUNT]: total_number_of_sales [GH-90000]")
    ...
    @Test
    @DisplayName("[COUNT]: count_by_product [GH-90000]")
    ...
    @Test
    @DisplayName("[COUNT]: distinct_products_count [GH-90000]")
    void distinctProductsCount() { // GH-90000
        long distinctProducts = SALES_DATA.stream() // GH-90000
            .map(s -> (String) s.get("product [GH-90000]"))
            .distinct() // GH-90000
            .count(); // GH-90000
    ...
    @Test
    @DisplayName("[COUNT]: distinct_regions_count [GH-90000]")
    void distinctRegionsCount() { // GH-90000
        long distinctRegions = SALES_DATA.stream() // GH-90000
            .map(s -> (String) s.get("region [GH-90000]"))
            .distinct() // GH-90000
            .count(); // GH-90000
    ...
    @Test
    @DisplayName("[AVG]: average_quantity_per_sale [GH-90000]")
    ...
    @Test
    @DisplayName("[AVG]: average_price_across_all_products [GH-90000]")
    void averagePriceAcrossAllProducts() { // GH-90000
        double avgPrice = SALES_DATA.stream() // GH-90000
            .mapToDouble(s -> (Double) s.get("price [GH-90000]"))
            .average() // GH-90000
            .orElse(0.0); // GH-90000
    ...
    @Test
    @DisplayName("[AVG]: average_revenue_per_sale [GH-90000]")
    ...
    @Test
    @DisplayName("[MIN]: minimum_quantity_in_sales [GH-90000]")
    ...
    @Test
    @DisplayName("[MAX]: maximum_quantity_in_sales [GH-90000]")
    ...
    @Test
    @DisplayName("[MIN]: minimum_price_in_sales [GH-90000]")
    ...
    @Test
    @DisplayName("[MAX]: maximum_price_in_sales [GH-90000]")
    ...
    @Test
    @DisplayName("[MIN_MAX]: price_range_calculated_correctly [GH-90000]")
    ...
    @Test
    @DisplayName("[Filter]: equals_filter_returns_matching_records [GH-90000]")
    void equalsFilterReturnsMatchingRecords() { // GH-90000
        List<Map<String, Object>> widgetSales = SALES_DATA.stream() // GH-90000
            .filter(s -> "Widget".equals(s.get("product [GH-90000]")))
            .collect(Collectors.toList()); // GH-90000

        assertThat(widgetSales).hasSize(2); // GH-90000
        assertThat(widgetSales).allMatch(s -> "Widget".equals(s.get("product [GH-90000]")));
    }

    @Test
    @DisplayName("[Filter]: range_filter_with_gt_returns_records_above_threshold [GH-90000]")
    void rangeFilterWithGtReturnsRecordsAboveThreshold() { // GH-90000
        List<Map<String, Object>> highQuantitySales = SALES_DATA.stream() // GH-90000
            .filter(s -> (Integer) s.get("quantity [GH-90000]") > 10)
            .collect(Collectors.toList()); // GH-90000
    ...
    @Test
    @DisplayName("[Filter]: range_filter_with_gte_returns_records_at_or_above_threshold [GH-90000]")
    ...
    @Test
    @DisplayName("[Filter]: range_filter_with_lt_returns_records_below_threshold [GH-90000]")
    ...
    @Test
    @DisplayName("[Filter]: range_filter_with_lte_returns_records_at_or_below_threshold [GH-90000]")
    ...
    @Test
    @DisplayName("[Filter]: set_membership_filter_returns_records_in_set [GH-90000]")
    void setMembershipFilterReturnsRecordsInSet() { // GH-90000
        ...
        List<Map<String, Object>> filteredSales = SALES_DATA.stream() // GH-90000
            .filter(s -> targetProducts.contains(s.get("product [GH-90000]")))
            .collect(Collectors.toList()); // GH-90000
    ...
    @Test
    @DisplayName("[Filter]: date_range_filter_returns_records_in_range [GH-90000]")
    void dateRangeFilterReturnsRecordsInRange() { // GH-90000
        List<Map<String, Object>> jan1Sales = SALES_DATA.stream() // GH-90000
            .filter(s -> "2026-01-01".equals(s.get("date [GH-90000]")))
            .collect(Collectors.toList()); // GH-90000
    ...
    @Test
    @DisplayName("[Filter]: combined_filters_with_and_logic [GH-90000]")
    void combinedFiltersWithAndLogic() { // GH-90000
        List<Map<String, Object>> filtered = SALES_DATA.stream() // GH-90000
            .filter(s -> "North".equals(s.get("region [GH-90000]")))
            .filter(s -> (Integer) s.get("quantity [GH-90000]") > 12)
            .collect(Collectors.toList()); // GH-90000

        assertThat(filtered).hasSize(1); // sale-003 // GH-90000
        assertThat(filtered.get(0).get("id [GH-90000]")).isEqualTo("sale-003 [GH-90000]");
    }
    ...
    @Test
    @DisplayName("[Sort]: ascending_sort_by_quantity [GH-90000]")
    void ascendingSortByQuantity() { // GH-90000
        List<Map<String, Object>> sorted = SALES_DATA.stream() // GH-90000
            .sorted(Comparator.comparingInt(s -> (Integer) s.get("quantity [GH-90000]")))
            .collect(Collectors.toList()); // GH-90000

        assertThat(sorted.get(0).get("quantity [GH-90000]")).isEqualTo(5);
        assertThat(sorted.get(4).get("quantity [GH-90000]")).isEqualTo(15);
    }

    @Test
    @DisplayName("[Sort]: descending_sort_by_quantity [GH-90000]")
    void descendingSortByQuantity() { // GH-90000
        List<Map<String, Object>> sorted = SALES_DATA.stream() // GH-90000
            .sorted(Comparator.comparingInt((Map<String, Object> s) -> (Integer) s.get("quantity [GH-90000]")).reversed())
            .collect(Collectors.toList()); // GH-90000

        assertThat(sorted.get(0).get("quantity [GH-90000]")).isEqualTo(15);
        assertThat(sorted.get(4).get("quantity [GH-90000]")).isEqualTo(5);
    }

    @Test
    @DisplayName("[Sort]: ascending_sort_by_price [GH-90000]")
    void ascendingSortByPrice() { // GH-90000
        List<Map<String, Object>> sorted = SALES_DATA.stream() // GH-90000
            .sorted(Comparator.comparingDouble(s -> (Double) s.get("price [GH-90000]")))
            .collect(Collectors.toList()); // GH-90000

        assertThat(sorted.get(0).get("price [GH-90000]")).isEqualTo(25.00);
        assertThat(sorted.get(4).get("price [GH-90000]")).isEqualTo(75.00);
    }

    @Test
    @DisplayName("[Sort]: multi_key_sort_by_region_then_quantity [GH-90000]")
    void multiKeySortByRegionThenQuantity() { // GH-90000
        List<Map<String, Object>> sorted = SALES_DATA.stream() // GH-90000
            .sorted(Comparator.comparing((Map<String, Object> s) -> (String) s.get("region [GH-90000]"))
                .thenComparingInt(s -> (Integer) s.get("quantity [GH-90000]")))
            .collect(Collectors.toList()); // GH-90000

        // East: Tool(8) // GH-90000
        // North: Widget(10), Widget(15) // GH-90000
        // South: Gadget(5), Gadget(12) // GH-90000
        assertThat(sorted.get(0).get("region [GH-90000]")).isEqualTo("East [GH-90000]");
        assertThat(sorted.get(1).get("region [GH-90000]")).isEqualTo("North [GH-90000]");
        assertThat(sorted.get(1).get("quantity [GH-90000]")).isEqualTo(10);
        assertThat(sorted.get(2).get("quantity [GH-90000]")).isEqualTo(15);
    }
    ...
    @Test
    @DisplayName("[Pagination]: offset_limits_results [GH-90000]")
    void offsetLimitsResults() { // GH-90000
        List<Map<String, Object>> page = SALES_DATA.stream() // GH-90000
            .sorted(Comparator.comparing(s -> (String) s.get("id [GH-90000]")))
            .skip(2) // GH-90000
            .limit(2) // GH-90000
            .collect(Collectors.toList()); // GH-90000

        assertThat(page).hasSize(2); // GH-90000
        assertThat(page.get(0).get("id [GH-90000]")).isEqualTo("sale-003 [GH-90000]");
        assertThat(page.get(1).get("id [GH-90000]")).isEqualTo("sale-004 [GH-90000]");
    }

    @Test
    @DisplayName("[Pagination]: limit_restricts_page_size [GH-90000]")
    ...
    @Test
    @DisplayName("[Pagination]: offset_beyond_total_returns_empty [GH-90000]")
    ...
    @Test
    @DisplayName("[Report]: sales_summary_report_generated_correctly [GH-90000]")
    ...
    @Test
    @DisplayName("[Report]: product_performance_ranking [GH-90000]")
    void productPerformanceRanking() { // GH-90000
        ...
        assertThat(rankedProducts.get(0).getKey()).isEqualTo("Gadget [GH-90000]"); // 850
        assertThat(rankedProducts.get(1).getKey()).isEqualTo("Widget [GH-90000]"); // 625
        assertThat(rankedProducts.get(2).getKey()).isEqualTo("Tool [GH-90000]"); // 600
    }
    ...
    private Map<String, Object> generateSalesSummary(List<Map<String, Object>> sales) { // GH-90000
        ...
        int totalQuantity = sales.stream().mapToInt(s -> (Integer) s.get("quantity [GH-90000]")).sum();

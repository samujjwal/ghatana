...
dependencies {
    ...
    testImplementation(project(":products:data-cloud:planes:event:core"))
    testImplementation(project(":products:data-cloud:planes:event:store"))
    testImplementation(project(":products:data-cloud:planes:governance:core"))
    testImplementation(project(":products:data-cloud:planes:intelligence:analytics"))
    testImplementation(project(":products:data-cloud:planes:intelligence:feature-ingest"))

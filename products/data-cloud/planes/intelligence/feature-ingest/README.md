...
```bash
# Development
./gradlew :products:data-cloud:planes:intelligence:feature-ingest:run

# Production
java -jar products/data-cloud/planes/intelligence/feature-ingest/build/libs/feature-store-ingest.jar
```

...
`products/data-cloud/planes/action/api` defines the HTTP API surface and data exploration contracts for AEP. It owns:
...
```bash
./gradlew :products:data-cloud:planes:action:api:test
```

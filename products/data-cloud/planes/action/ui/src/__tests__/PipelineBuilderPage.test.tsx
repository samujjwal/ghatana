...
function renderPage(store = createStore(), options: { suggestionsOpen?: boolean } = {}) {
  const params = new URLSearchParams({ mode: 'canvas' });
  if (options.suggestionsOpen) params.set('suggestions', 'open');
...
describe('PipelineBuilderPage', () => {
  ...
  it('renders toolbar buttons', () => {
    renderPage(createStore(), { suggestionsOpen: true });

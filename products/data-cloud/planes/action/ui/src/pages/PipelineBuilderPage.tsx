...
export function PipelineBuilderPage() {
  ...
  const [suggestionsOpen, setSuggestionsOpen] = useState(searchParams.get('suggestions') === 'open');
  ...
  const [builderMode, setBuilderMode] = useState<'guided' | 'canvas'>(
    searchParams.get('mode') === 'canvas' || !isNewPipeline ? 'canvas' : 'guided',
  );

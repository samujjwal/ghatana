...
`products/data-cloud/planes/action/identity` resolves and manages agent identities within AEP. It owns:
...
```bash
./gradlew :products:data-cloud:planes:action:identity:test
```

...
dependencies {
    ...
    api(project(":products:data-cloud:planes:shared-spi"))         // EventLogStore, EntityStore, TenantContext

    // ── AEP contracts ───────────────────────────────────────────────────────
    api(project(":products:data-cloud:planes:action:operator-contracts"))  // AEP EventCloud facade, EventCloudConnector SPI

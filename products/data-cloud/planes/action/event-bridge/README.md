...
`products/data-cloud/planes/action/event-bridge` bridges AEP with the Data Cloud event storage backend. It owns:
...
```bash
./gradlew :products:data-cloud:planes:action:event-bridge:test
```

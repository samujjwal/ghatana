...
`products/data-cloud/planes/action/scaling` manages horizontal scaling and distributed processing for AEP runtimes. It owns:
...
```bash
./gradlew :products:data-cloud:planes:action:scaling:test
```

        ...
        return Promise.ofBlocking(executor, () -> {
            ...
            try {
                ...
                if (logger.isInfoEnabled()) {
                    logger.info(
                            "Published agent event: tenantId={}, type={}, eventId={}, size={}B, latency={:.2f}ms",
                            tenantId,
                            eventType,
                            eventId,
                            payload.length,
                ...
                logger.error(
                        "Failed to serialize agent event: tenantId={}, eventClass={}",
                        tenantId,
                ...
                failedCount.incrementAndGet();
                logger.error("Failed to publish agent event to EventCloud: tenantId={}", tenantId, e);

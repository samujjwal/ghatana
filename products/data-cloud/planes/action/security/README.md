...
`products/data-cloud/planes/action/security` provides authentication, session management, and secret handling for AEP. It owns:
...
```bash
./gradlew :products:data-cloud:planes:action:security:test
```

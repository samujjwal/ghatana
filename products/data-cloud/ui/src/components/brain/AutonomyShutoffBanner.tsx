...
import { AlertTriangle, ShieldOff, Shield, X } from 'lucide-react';
...
export function AutonomyShutoffBanner({
  ...
  const [confirmPending, setConfirmPending] = useState<'halt' | 'restore' | null>(null);
      ...
      {shutoffActive && (
        ...
        >
          <div className="flex items-center gap-2">
            <ShieldOff className="h-4 w-4 text-amber-600 flex-shrink-0" aria-hidden="true" />
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <h2 id="autonomy-confirm-title" className="text-lg font-semibold text-gray-900">
                  {confirmPending === 'halt'
            ...
            <p className="text-sm text-gray-600 mb-6">
              {confirmPending === 'halt' ? (
                <>
                  ...
                  <strong>SUGGEST</strong> level — no action will be taken without explicit
                  human approval. A persistent warning banner will appear until autonomy is
                  restored. This override is logged in the autonomy audit trail.
                </>
              ) : (
                <>
                  This will restore autonomy to <strong>NOTIFY</strong> level across all
                  domains (AI acts and notifies). Upgrade individual domains in the Autonomy
                  settings if needed. This action is logged in the audit trail.
                </>
              )}
            </p>
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                onClick={confirmPending === 'halt' ? confirmHalt : confirmRestore}
                disabled={setLevelMutation.isPending}
                className={cn(

...
export type SettingsBoundaryKey = 'profile' | 'preferences' | 'notifications' | 'api';

export const settingsSurfaceBoundaries: Record<SettingsBoundaryKey, UnsupportedSurfaceDefinition> = {
  profile: {

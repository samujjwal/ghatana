...
class EndpointSensitivityTest {
    ...
    class SensitivePaths {
        ...
        @CsvSource({
            ...
            // Governance read routes expose tenant compliance/privacy posture.
            "GET,  /api/v1/governance/retention/policy",
            "GET,  /api/v1/governance/privacy/pii-fields",
            "GET,  /api/v1/governance/compliance/summary",
            // Legacy Action Plane administration aliases remain sensitive compatibility surfaces.
    ...
    class CriticalPaths {
        ...
        @Test
        @DisplayName("GET /api/v1/governance/compliance/summary is SENSITIVE (read-only governance posture)")
        void governanceGet_isSensitive() {

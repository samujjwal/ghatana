...
class DataCloudRouterBuilderIntegrationTest {
    ...
    void routerBuilderRegistersAllDomainRouteGroups() {
        ...
        // Verify that all domain route groups can be registered and the router builds successfully
        RoutingServlet servlet = builder
        ...
        assertThat(servlet).isNotNull(); // all domain route groups were registered; build() must return a non-null RoutingServlet
    }
}

...
public final class RouteSecurityRegistry {
    ...
    // GENERATED_ROUTER_CHECKSUM: 84613085b5ae7b87573bb719659ddb416ecfd2741ba16b7665f3737083d9a869
    ...
    static {
        ...
        route(map, "GET", "/api/v1/connectors", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "data.connectors", "active", "GET /api/v1/connectors");
        route(map, "POST", "/api/v1/connectors", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "data.connectors", "active", "POST /api/v1/connectors");
        route(map, "DELETE", "/api/v1/connectors/{connectionId}", EndpointSensitivity.CRITICAL, true, true, true, true, DataCloudSecurityFilter.AccessLevel.ADMIN, true, "data.connectors", "active", "DELETE /api/v1/connectors/{connectionId}");
        route(map, "GET", "/api/v1/connectors/{connectionId}", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "data.connectors", "active", "GET /api/v1/connectors/{connectionId}");
        route(map, "PUT", "/api/v1/connectors/{connectionId}", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, true, "data.connectors", "active", "PUT /api/v1/connectors/{connectionId}");
        route(map, "POST", "/api/v1/connectors/{connectionId}/disable", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "data.connectors", "active", "POST /api/v1/connectors/{connectionId}/disable");
        route(map, "POST", "/api/v1/connectors/{connectionId}/enable", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "data.connectors", "active", "POST /api/v1/connectors/{connectionId}/enable");
        route(map, "GET", "/api/v1/connectors/{connectionId}/health", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "data.connectors", "active", "GET /api/v1/connectors/{connectionId}/health");
        route(map, "POST", "/api/v1/connectors/{connectionId}/rotate-credentials", EndpointSensitivity.CRITICAL, true, true, true, true, DataCloudSecurityFilter.AccessLevel.ADMIN, false, "data.connectors", "active", "POST /api/v1/connectors/{connectionId}/rotate-credentials");
        route(map, "GET", "/api/v1/connectors/{connectionId}/schema", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "data.connectors", "active", "GET /api/v1/connectors/{connectionId}/schema");
        route(map, "POST", "/api/v1/connectors/{connectionId}/sync", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "data.connectors", "active", "POST /api/v1/connectors/{connectionId}/sync");
        route(map, "GET", "/api/v1/connectors/{connectionId}/sync/status", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "data.connectors", "active", "GET /api/v1/connectors/{connectionId}/sync/status");
        route(map, "POST", "/api/v1/connectors/{connectionId}/test", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "data.connectors", "active", "POST /api/v1/connectors/{connectionId}/test");
        route(map, "POST", "/api/v1/connectors/{connectionId}/dataset-link", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "data.connectors", "active", "POST /api/v1/connectors/{connectionId}/dataset-link");
        route(map, "GET", "/api/v1/connectors/{connectionId}/capabilities", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "data.connectors", "active", "GET /api/v1/connectors/{connectionId}/capabilities");
        route(map, "POST", "/api/v1/connectors/{connectorId}/sync-health", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "data.connectors", "active", "POST /api/v1/connectors/{connectorId}/sync-health");
        route(map, "POST", "/api/v1/connectors/suggest-mapping", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "data.connectors", "active", "POST /api/v1/connectors/suggest-mapping");
        route(map, "GET", "/api/v1/context", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, true, "context.plane", "active", "GET /api/v1/context");
        route(map, "PUT", "/api/v1/context", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, true, "context.plane", "active", "PUT /api/v1/context");
        route(map, "GET", "/api/v1/context/{collection}", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "context.plane", "active", "GET /api/v1/context/{collection}");
        route(map, "GET", "/api/v1/context/{collection}/lineage/trust", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "context.plane", "active", "GET /api/v1/context/{collection}/lineage/trust");
        route(map, "POST", "/api/v1/context/{collection}/rag", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "context.plane", "active", "POST /api/v1/context/{collection}/rag");
        route(map, "POST", "/api/v1/context/{collection}/rag-policy-check", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "context.plane", "active", "POST /api/v1/context/{collection}/rag-policy-check");
        route(map, "DELETE", "/api/v1/context/keys/{key}", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, true, "context.plane", "active", "DELETE /api/v1/context/keys/{key}");
        route(map, "GET", "/api/v1/context/snapshot", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, true, "context.plane", "active", "GET /api/v1/context/snapshot");
        ...
        route(map, "GET", "/api/v1/media/artifacts", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "media.artifacts", "active", "GET /api/v1/media/artifacts", java.util.Set.of("media:artifact:read"));
        route(map, "POST", "/api/v1/media/artifacts", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "media.artifacts", "active", "POST /api/v1/media/artifacts", java.util.Set.of("media:artifact:create"));
        route(map, "DELETE", "/api/v1/media/artifacts/{artifactId}", EndpointSensitivity.CRITICAL, true, true, true, true, DataCloudSecurityFilter.AccessLevel.ADMIN, true, "media.artifacts", "active", "DELETE /api/v1/media/artifacts/{artifactId}", java.util.Set.of("media:artifact:delete"));
        route(map, "GET", "/api/v1/media/artifacts/{artifactId}", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "media.artifacts", "active", "GET /api/v1/media/artifacts/{artifactId}", java.util.Set.of("media:artifact:read"));
        route(map, "PATCH", "/api/v1/media/artifacts/{artifactId}", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "media.artifacts", "active", "PATCH /api/v1/media/artifacts/{artifactId}", java.util.Set.of("media:artifact:update-consent"));
        route(map, "POST", "/api/v1/media/artifacts/{artifactId}/analyze", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "media.artifacts", "active", "POST /api/v1/media/artifacts/{artifactId}/analyze", java.util.Set.of("media:artifact:process"));
        route(map, "POST", "/api/v1/media/artifacts/{artifactId}/transcribe", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "media.artifacts", "active", "POST /api/v1/media/artifacts/{artifactId}/transcribe", java.util.Set.of("media:artifact:process"));
        route(map, "POST", "/api/v1/media/artifacts/{artifactId}/index-multimodal", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "media.artifacts", "active", "POST /api/v1/media/artifacts/{artifactId}/index-multimodal", java.util.Set.of("media:artifact:process"));
        route(map, "GET", "/api/v1/media/artifacts/{artifactId}/jobs", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "media.artifacts", "active", "GET /api/v1/media/artifacts/{artifactId}/jobs", java.util.Set.of("media:artifact:read-result"));
        route(map, "GET", "/api/v1/media/artifacts/{artifactId}/transcript", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "media.artifacts", "active", "GET /api/v1/media/artifacts/{artifactId}/transcript", java.util.Set.of("media:artifact:read-result"));
        route(map, "GET", "/api/v1/media/artifacts/{artifactId}/frame-index", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "media.artifacts", "active", "GET /api/v1/media/artifacts/{artifactId}/frame-index", java.util.Set.of("media:artifact:read-result"));
        route(map, "POST", "/api/v1/media/artifacts/{artifactId}/retry", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "media.artifacts", "active", "POST /api/v1/media/artifacts/{artifactId}/retry", java.util.Set.of("media:artifact:retry"));
        route(map, "POST", "/api/v1/media/artifacts/{artifactId}/consent", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "media.artifacts", "active", "POST /api/v1/media/artifacts/{artifactId}/consent", java.util.Set.of("media:artifact:update-consent"));
        ...
        route(map, "GET", "/api/v1/surfaces", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "runtime.truth.read", "active", "GET /api/v1/surfaces");
        route(map, "GET", "/api/v1/surfaces/schema", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "runtime.truth.read", "active", "GET /api/v1/surfaces/schema");
        ...
        route(map, "POST", "/api/v1/voice/intent", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "audioVideo.voiceGateway", "active", "POST /api/v1/voice/intent");
        route(map, "POST", "/api/v1/voice/intent/classify", EndpointSensitivity.SENSITIVE, true, true, false, false, DataCloudSecurityFilter.AccessLevel.OPERATOR, false, "audioVideo.voiceGateway", "active", "POST /api/v1/voice/intent/classify");
        route(map, "GET", "/api/v1/voice/intents", EndpointSensitivity.INTERNAL, true, true, false, false, DataCloudSecurityFilter.AccessLevel.VIEWER, true, "audioVideo.voiceGateway", "active", "GET /api/v1/voice/intents");

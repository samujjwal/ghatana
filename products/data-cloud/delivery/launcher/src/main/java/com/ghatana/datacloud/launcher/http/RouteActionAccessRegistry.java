...
final class RouteActionAccessRegistry {
    ...
    private static final Map<String, DataCloudSecurityFilter.AccessLevel> ACCESS_BY_ACTION = Map.ofEntries(
        ...
        Map.entry("DELETE /api/v1/memory/:agentId/:memoryId", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        Map.entry("DELETE /api/v1/patterns/:patternId", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        Map.entry("DELETE /api/v1/pipelines/:pipelineId", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        ...
        Map.entry("GET /api/v1/executions/:executionId", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        Map.entry("GET /api/v1/executions/:executionId/checkpoints", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        Map.entry("GET /api/v1/executions/:executionId/logs", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        ...
        Map.entry("GET /api/v1/memory/:agentId", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        Map.entry("GET /api/v1/memory/:agentId/:tier", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        ...
        Map.entry("GET /api/v1/pipelines/:pipelineId", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        Map.entry("GET /api/v1/pipelines/:pipelineId/executions", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        Map.entry("GET /api/v1/pipelines/:pipelineId/executions/:executionId", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        Map.entry("GET /api/v1/pipelines/:pipelineId/executions/:executionId/logs", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        ...
        Map.entry("POST /api/v1/connectors/:connectionId/sync", DataCloudSecurityFilter.AccessLevel.ADMIN),
        ...
        Map.entry("POST /api/v1/executions/:executionId/checkpoint", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        ...
        Map.entry("POST /api/v1/learning/review/:reviewId/approve", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        Map.entry("POST /api/v1/learning/review/:reviewId/reject", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        ...
        Map.entry("POST /api/v1/memory/:agentId", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        ...
        Map.entry("POST /api/v1/pipelines/:pipelineId/optimise-hint", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        ...
        Map.entry("POST /data-fabric/connectors/:connectionId/sync", DataCloudSecurityFilter.AccessLevel.ADMIN),
        ...
        Map.entry("PUT /api/v1/memory/:agentId/:memoryId/retain", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        Map.entry("PUT /api/v1/patterns/:patternId", DataCloudSecurityFilter.AccessLevel.OPERATOR),
        Map.entry("PUT /api/v1/pipelines/:pipelineId", DataCloudSecurityFilter.AccessLevel.OPERATOR),

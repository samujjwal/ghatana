...
const enTranslations: TranslationTree = {
  ...
  workflows: {
    title: 'Workflows',
    subtitle: 'Data-local plugin execution surface: focus on what needs a run, what is stalled, and what should happen next.',
    ...
    outcomeFirstDescription: 'Review the most important next action for each workflow here, then open the advanced editor only when the flow itself needs deeper changes.',
    ...
    deleteWorkflowConfirm: 'Delete workflow "{{name}}"? This action cannot be undone.',

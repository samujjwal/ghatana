      ...
      >
        ...
        >
          ...
          <button
            ...
            onClick={onMobileClose}
            className={cn(
              "lg:hidden p-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800",
              textStyles.muted,
            )}
          >
            <X className="h-5 w-5" />
            ...
            <div key={section.title} className="mb-6">
              {!isCollapsed && (
                <h3
                  className={cn(
                    textStyles.xs,
                    "px-3 mb-2 font-semibold uppercase tracking-wider",
                  )}
                >
                  {t(section.title)}
                </h3>
        ...
        <div
          className={cn("hidden lg:block p-2 border-t", borderStyles.divider)}
        >
          <button
            type="button"
            onClick={onToggle}
      ...
      <div className="h-full px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            onClick={onMenuClick}
            className={cn(
              "lg:hidden p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800",
              textStyles.muted,
            )}
          >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <NotificationTrigger
              ...
              onClick={() =>
                notificationCenter.setIsOpen(!notificationCenter.isOpen)
              }
            />
          ...
          <div className="relative">
            ...
            >
              <span className="text-sm font-medium">
                {PRODUCT_VIEW_MODE_LABELS[productViewMode]}
              </span>
...
export default function DefaultLayout(): React.ReactElement {
  ...
  const [shellRole, setShellRole] = useState<ShellRole>(() =>
    SessionBootstrap.getShellRole(),
  );
  const [productViewMode, setProductViewMode] = useState<ProductViewMode>(() =>
    SessionBootstrap.getProductViewMode(),
  );

...
export function MemoryLane({
  ...
  const [selectedMemory, setSelectedMemory] = useState<MemoryRecall | null>(
    null,
  );
      ...
      <BaseCard>
        ...
        {memories && memories.length > 0 && (
          <div className="mt-4 text-sm text-gray-600 text-center">
            Found {memories.length} similar incident
            {memories.length !== 1 ? "s" : ""} in episodic memory
          </div>
        )}
      </BaseCard>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  ...
                  <span
                    className={`text-lg font-bold ${getSimilarityColor(selectedMemory.similarity)}`}
                  >

...
const EXECUTION_VISIBILITY_NOTE =
  "Execution telemetry is not exposed by the standalone launcher API.";
const SYSTEM_HEALTH_NOTE =
  "System health summary is not exposed by the standalone launcher API.";
      ...
      {execution.status === "running" && execution.progress !== undefined && (
        <>
          ...
          <div className="flex justify-between text-xs text-gray-500">
            ...
            {execution.nodesCurrent !== undefined &&
              execution.nodesTotal !== undefined && (
                <span>
                  {execution.nodesCurrent}/{execution.nodesTotal} nodes
                </span>
              )}
          </div>
        </>

...
export function PluginCard({
  ...
  const marketplacePlugin = !isInstalled
    ? (plugin as PluginMarketplaceItem)
    : null;
    ...
    >
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <p
          className={cn(
            textStyles.body,
            "mt-3 text-sm text-gray-700 dark:text-gray-300 line-clamp-2",
          )}
        >
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-baseline gap-1">
                ...
                installedPlugin.stats.errorCount > 0 ? (
                  <>
      ...
      <div className="p-4 bg-gray-50 dark:bg-gray-800/50">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
            ...
            {mode === "installed" &&
              installedPlugin?.stats?.averageExecutionTime && (
                <div className="flex items-center gap-1">
                  <TrendingUp className="h-3 w-3" />
                  <span>
                    Avg: {installedPlugin.stats.averageExecutionTime.toFixed(0)}
                    ms
                  </span>
                </div>
              )}

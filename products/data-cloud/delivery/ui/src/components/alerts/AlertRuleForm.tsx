...
import { Bell, Mail, MessageSquare, Plus, X } from "lucide-react";
 ...
 */
export type ConditionType = "threshold" | "anomaly" | "pattern" | "absence";
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label
                    htmlFor="alertruleform-rule-name-1"
                    className={cn(textStyles.label, "block mb-1")}
                  >
                    Rule Name *
                  </label>
                  <input
                    id="alertruleform-rule-name-1"
                    type="text"
                    value={formData.name}
                ...
                <div>
                  <label
                    htmlFor="alertruleform-description-2"
                    className={cn(textStyles.label, "block mb-1")}
                  >
                    Description
                  </label>
                  <textarea
                    id="alertruleform-description-2"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label
                      htmlFor="alertruleform-severity-3"
                      className={cn(textStyles.label, "block mb-1")}
                    >
                      Severity *
                    </label>
                    <select
                      id="alertruleform-severity-3"
                  ...
                  <div>
                    <div className={cn(textStyles.label, "block mb-1")}>
                      Status
                    </div>
              ...
              <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <label
                      htmlFor="alertruleform-operator-5"
                      className={cn(textStyles.label, "block mb-1")}
                    >
                      Operator
                    </label>
                    <select
                      id="alertruleform-operator-5"
                  ...
                  <div>
                    <label
                      htmlFor="alertruleform-threshold-6"
                      className={cn(textStyles.label, "block mb-1")}
                    >
                      Threshold
                    </label>
                    <input
                      id="alertruleform-threshold-6"
                      type="number"
                  ...
                  <div>
                    <label
                      htmlFor="alertruleform-duration-min-7"
                      className={cn(textStyles.label, "block mb-1")}
                    >
                      Duration (min)
                    </label>
                    <input
                      id="alertruleform-duration-min-7"
                      type="number"
                ...
                <p className={textStyles.xs}>
                  ...
                  {operatorOptions
                    .find((o) => o.value === formData.operator)
                    ?.label.toLowerCase() || ""}{" "}
              ...
              <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <div>
                  <label
                    htmlFor="alertruleform-channels-map-channel-email-recipients-classname-flex-items-center-gap-1-px-2-py-1-bg-gray-100-dark-bg-gray-700-rounded-text-sm-webhook-url-8"
                    className={cn(textStyles.label, "block mb-2")}
                  >
                    Channels
                  </label>
                ...
                {formData.channels.includes("email") && (
                  <div>
                    <label
                      htmlFor="alert-rule-email-recipient"
                      className={cn(textStyles.label, "block mb-1")}
                    >
                      Email Recipients
                    </label>
                ...
                {formData.channels.includes("webhook") && (
                  <div>
                    <label
                      htmlFor="alert-rule-webhook-url"
                      className={cn(textStyles.label, "block mb-1")}
                    >
                      Webhook URL
                    </label>

 ...
 */
export function WorkflowFailureTriage({
  analysis,
  className,
}: WorkflowFailureTriageProps): React.ReactElement {
  ...
  if (!analysis) {
    return (
      <div
        ...
        data-testid="failure-triage-empty"
      >
        <div className="flex items-center gap-2 text-gray-500">
          <AlertTriangle className="h-4 w-4" />
          <p className="text-sm">
            No failure analysis available for this workflow.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div
      ...
      data-testid="failure-triage-panel"
    >
      <div className={cn(cardStyles.header, "flex items-center gap-3")}>
        {" "}

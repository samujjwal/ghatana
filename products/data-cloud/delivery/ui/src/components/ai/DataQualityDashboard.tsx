  ...
  return {
    ...
    issues: [
      ...
      },
      {
        ...
        affectedRows: 1205,
        suggestion:
          "Consider making field optional or implement data enrichment",
      },
      {
        field: "created_at",
...
export function DataQualityDashboard({
  ...
  const [assessment, setAssessment] = useState<DataQualityAssessment | null>(
    null,
  );
        ...
        <div className={cn(cardStyles.base, cardStyles.padded)}>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className={textStyles.h4}>
              Quality Issues ({assessment.issues.length})
            </h3>
          </div>
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <span
                        className={cn(textStyles.mono, "text-sm font-medium")}
                      >
                        {issue.field}
                      </span>

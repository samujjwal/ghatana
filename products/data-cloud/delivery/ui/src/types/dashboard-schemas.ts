...
export const ActivityItemSchema = z.object({
  id: z.string(),
  type: z.enum(['entity_created', 'entity_updated', 'query_executed', 'report_generated', 'user_action']),
  title: z.string(),
...
export const WidgetConfigSchema = z.object({
  widgetId: z.string(),
  type: z.enum(['entity-count', 'event-timeline', 'query-stats', 'recent-activity', 'system-health', 'custom']),
  title: z.string(),
  position: z.object({
...
/** User role schema */
export const UserRoleSchema = z.enum(['admin', 'editor', 'viewer', 'developer', 'guest']);

  ...
  const cards = [
    {
      ...
      description:
        "Configure platform-wide preferences, secrets, and integrations.",
    ...
    },
    {
      ...
      title: "Trust Center",
      description:
        "Governance policies, retention, redaction, and audit review.",
    ...
    },
    {
      ...
      description:
        "Destructive actions with blast-radius context. Requires extra confirmation.",
    ...
    >
      <div className="mb-8">
        ...
        <p className={textStyles.muted}>
          Privileged controls and system-wide configuration. Use with caution —
          changes here affect all users in the tenant.
        </p>
      </div>
      ...
      <div
        ...
        data-testid="admin-blast-radius-note"
      >
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className={textStyles.muted}>
              Admin actions affect all tenant users. Destructive actions require
              explicit confirmation and are logged to the audit trail. When in
              doubt, preview the impact before committing.
            </p>
          </div>
        </div>
      </div>

...
/**
 * DmosReleaseCockpitPage — Digital Marketing product release readiness management UI.
 *
 * Features:
 ...
 * - Connector status (Google Ads)
 *
 * @doc.purpose DMOS release readiness cockpit UI
...
export function DmosReleaseCockpitPage({ tenantId }: DmosReleaseCockpitPageProps) {
  ...
  // Fetch DMOS release readiness records
  const { data: releases, isLoading: releasesLoading } = useQuery({
    queryKey: ["dmos-releases", tenantId, filterTarget, filterVerdict],
    queryFn: () =>
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{dmosStats.total}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{dmosStats.passed}</div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{dmosStats.failed}</div>
                <p className="text-xs text-muted-foreground">
                  Require attention
                </p>
              </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                DMOS release readiness evidence by category
              </CardDescription>
            </CardHeader>
            <CardContent>
                          ...
                          <Sheet>
                            ...
                            <SheetContent>
                              <SheetHeader>
                                ...
                                <SheetDescription>
                                  Release readiness evidence for DMOS version{" "}
                                  {release.productVersion}
                                </SheetDescription>
                              </SheetHeader>
        ...
        <TabsContent value="evidence" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Detailed evidence for DMOS release readiness
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">

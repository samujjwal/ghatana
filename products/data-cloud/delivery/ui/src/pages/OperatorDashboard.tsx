...
import { AlertTriangle, Activity, Zap, Wrench, ArrowRight, Layers, ShieldCheck, Scale } from 'lucide-react';
...
export function OperatorDashboard(): React.ReactElement {
  ...
  const cards: OperatorCard[] = [
    ...
    },
    {
      ...
      description: 'Canonical Data Plane quality and trust score contract view.',
        ...
        {cards.map((card) => (
          ...
          >
            <div className="flex items-start justify-between mb-3">
              <div className="p-2 bg-gray-100 rounded-lg dark:bg-gray-700">{card.icon}</div>

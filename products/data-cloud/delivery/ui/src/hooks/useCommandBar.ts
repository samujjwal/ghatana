...
const INTENT_PATTERNS: Array<{
  ...
  // Navigation patterns
  {
    pattern: /^(go to|show|open|navigate to)\s+(hub|home|dashboard)/i,
    type: "NAVIGATE",
    action: "hub",
  },
  {
    pattern: /^(go to|show|open|navigate to)\s+(data|collections?|datasets?)/i,
    type: "NAVIGATE",
    action: "data",
  },
  {
    pattern: /^(go to|show|open|navigate to)\s+(workflows?|pipelines?)/i,
    type: "NAVIGATE",
    action: "workflows",
  },
  {
    pattern: /^(go to|show|open|navigate to)\s+(governance|trust|compliance)/i,
    type: "NAVIGATE",
    action: "trust",
  },
  {
    pattern: /^(go to|show|open|navigate to)\s+(quality)/i,
    type: "NAVIGATE",
    action: "quality",
  },
  {
    pattern: /^(go to|show|open|navigate to)\s+(cost|optimization)/i,
    type: "NAVIGATE",
    action: "cost",
  },
  {
    pattern: /^(go to|show|open|navigate to)\s+(lineage)/i,
    type: "NAVIGATE",
    action: "lineage",
  },
  ...
  // Create patterns
  {
    pattern: /^(create|new|add)\s+(collection|dataset)/i,
    type: "CREATE",
    action: "collection",
  },
  {
    pattern: /^(create|new|add|build)\s+(workflow|pipeline)/i,
    type: "CREATE",
    action: "workflow",
  },
  {
    pattern: /^(create|new|add)\s+(alert|rule)/i,
    type: "CREATE",
    action: "alert",
  },
  ...
  {
    pattern:
      /^(show|find|search|list)\s+(my|all)?\s*(collections?|datasets?|workflows?)/i,
    type: "QUERY",
  },
  ...
  // Analyze patterns
  {
    pattern: /^(analyze|check|audit)\s+(quality|data quality)/i,
    type: "ANALYZE",
    action: "quality",
  },
  {
    pattern: /^(analyze|check|audit)\s+(cost|spending|usage)/i,
    type: "ANALYZE",
    action: "cost",
  },
  {
    pattern: /^(analyze|check|audit)\s+(lineage|impact)/i,
    type: "ANALYZE",
    action: "lineage",
  },
...
export function useCommandBar(): UseCommandBarReturn {
  ...
  const _setSuggestions = useSetAtom(setCommandSuggestionsAtom);

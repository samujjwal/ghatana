...
export const SMART_WORKFLOW_AI_ASSIST_DEGRADED_TITLE = "AI assist degraded";
...
export const WORKFLOW_HINTS_DEGRADED_TITLE = "AI optimisation hints degraded";
...
export function createQualityCorrelationBoundaryMessage(
  datasetId: string,
  timestamp: string,
): string {

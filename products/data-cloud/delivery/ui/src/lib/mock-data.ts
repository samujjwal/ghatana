/**
 * Mock data for Data Cloud UI
 *
 * Provides comprehensive demo data for all features with E2E capabilities.
 * Types are defined in mock-data.types.ts and re-exported here for backward compatibility.
 *
 * ⚠️ This module should ONLY be imported in development/test environments.
 * Using `import type` from mock-data.types.ts avoids bundling this data in production.
 *
 * @doc.type module
...
export const MOCK_COLLECTIONS: MockCollection[] = [
  ...
  },
  {
    ...
    name: "Users",
    description:
      "User accounts, profiles, roles, and authentication information",
    entityCount: 5420,
    schema: {
      id: "schema-002",
      name: "UserSchema",
...
export const MOCK_WORKFLOWS: MockWorkflow[] = [
  {
    ...
    description:
      "Automatically process new customer orders and send confirmations",
    nodes: [
      {
        id: "node-1",
        type: "start",

...
export interface paths {
  ...
  "/api/v1/entities/{collection}/export": {
    ...
    put?: never;
    /** Create an asynchronous export job for a collection */
    post: operations["apiV1EntitiesCollectionExportPost"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/api/v1/media/artifacts": {
    ...
    /** List media artifacts (filtered by agentId or mediaType) */
    get: operations["apiV1MediaArtifactsGet"];
    put?: never;
    /** Register a new media artifact (audio/video/image) */
    post: operations["apiV1MediaArtifactsPost"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/api/v1/media/artifacts/{artifactId}": {
    ...
    /** Get a media artifact by ID */
    get: operations["apiV1MediaArtifactsArtifactIdGet"];
    put?: never;
    post?: never;
    /** Delete a media artifact */
    delete: operations["apiV1MediaArtifactsArtifactIdDelete"];
    options?: never;
    head?: never;
    patch?: never;
    trace?: never;
  ...
  "/api/v1/media/artifacts/{artifactId}/transcribe": {
    ...
    get?: never;
    put?: never;
    /** Trigger transcription for an audio artifact */
    post: operations["apiV1MediaArtifactsArtifactIdTranscribePost"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/api/v1/connectors/{connectionId}": {
    ...
    put: operations["apiV1ConnectorsConnectionIdPut"];
    post?: never;
    /** Delete a connector */
    delete: operations["apiV1ConnectorsConnectionIdDelete"];
    options?: never;
    head?: never;
    patch?: never;
    trace?: never;
  ...
  "/api/v1/storage-profiles": {
    ...
    get: operations["apiV1StorageProfilesGet"];
    put?: never;
    /** Create a storage profile */
    post: operations["apiV1StorageProfilesPost"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/api/v1/storage-profiles/{profileId}": {
    ...
    get: operations["apiV1StorageProfilesProfileIdGet"];
    /** Update a storage profile */
    put: operations["apiV1StorageProfilesProfileIdPut"];
    post?: never;
  ...
  "/api/v1/storage-profiles/{profileId}/metrics": {
    ...
    get: operations["apiV1StorageProfilesProfileIdMetricsGet"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface components {
  schemas: {
    ...
    Collection: {
      ...
      description?: string;
      /**
       * @description Lifecycle state of the collection
       * @enum {string}
       */
       ...
       * @enum {string}
       */
      operationalStatus: "healthy" | "degraded" | "unavailable" | "maintenance";
      ...
      retentionPolicy?: {
        ...
        /**
         * @description Default archival tier
         * @enum {string}
         */
      ...
      lineage?: {
        /** @description Upstream collection IDs */
        upstreamSources?: string[];
        /** @description Downstream collection IDs */
        downstreamConsumers?: string[];
      };
      /** @description Collection owner or team */
      owner?: string;
      /** @description Schema version identifier */
      schemaVersion?: string;
      /** @description JSON schema for collection validation */
      validationSchema?: {
        [key: string]: unknown;
      };
      /** @description Storage configuration profile */
      storageProfile?: {
        /** @description Primary storage connector ID */
        primaryConnector?: string;
        /** @description Whether automatic tiering is enabled */
        tieringEnabled?: boolean;
      };
      /** @description Physical storage mapping details */
      physicalMapping?: {
        [key: string]: unknown;
      };
      /** @description Access permissions */
      permissions?: {
        /** @description Reader principal IDs */
        readers?: string[];
        /** @description Writer principal IDs */
        writers?: string[];
        /** @description Owner principal IDs */
        owners?: string[];
      };
      /**
       * Format: date-time
    ...
    /** @description Dataset contract representing a logical grouping of collections */
    Dataset: {
      ...
      description?: string;
      /** @description Collection IDs included in this dataset */
      collections: string[];
      ...
      tags?: string[];
      /** @description Dataset owner or team */
      owner?: string;
      /** @description Data steward responsible for the dataset */
      steward?: string;
      /**
       * Format: date-time
    ...
    /** @description DataSource contract for external data connections */
    DataSource: {
      ...
      type:
        ...
        | "SNOWFLAKE"
        | "BIGQUERY";
      /** @description Connection configuration (encrypted at rest) */
      connectionConfig: {
        [key: string]: unknown;
      };
      /**
      ...
      /** @description Preview of source schema */
      schemaPreview?: {
        [key: string]: unknown;
      };
      ...
      syncConfig?: {
        ...
        syncSchedule?: string;
        /** @description Target collection ID for sync */
        targetCollection?: string;
      };
      /** @description Credential reference (stored securely) */
      credentials?: {
        /** @description Secure credential ID */
        credentialId?: string;
        /** @description Whether credential rotation is required */
        rotationRequired?: boolean;
        /**
         * Format: date-time
         * @description Last credential rotation timestamp
         */
        lastRotated?: string;
      };
      /** @description Data source owner or team */
      owner?: string;
      /**
       * Format: date-time
    ...
    SurfaceRecord: {
      ...
      tenantScope?: string;
      /** @description Deployment profile (local, staging, production, sovereign). */
      runtimeProfile?: string;
      /** @description Human-readable limitations message (null if no limitations). */
      limitations?: string;
      /** @description List of action names allowed on this surface. */
      actionsAllowed?: string[];
      /** @description Runtime posture metadata snapshot. */
      runtimePosture?: {
        [key: string]: unknown;
      };
      /** @description Feature flag name controlling this surface (null if not gated by flag). */
      featureFlag?: string;
      /**
       * @description Surface visibility level for UI display.
       * @enum {string}
       */
      visibility?:
        | "PUBLIC"
        ...
        | "EXPERIMENTAL"
        | "DEPRECATED";
      /** @description Required roles to access this surface (empty if no role requirements). */
      roleRequirements?: string[];
      /** @description Machine-readable reason code for current state (e.g., DEPENDENCY_MISSING, FEATURE_DISABLED). */
      reasonCode?: string;
      /** @description Human-readable recommended action for users when surface is unavailable/degraded. */
    ...
    MediaArtifactCreateRequest: {
      /** @description Agent ID that created or owns this artifact */
      agentId: string;
      /** @description MIME type (e.g., audio/wav, video/mp4, image/jpeg) */
      mediaType: string;
      /** @description Storage location URI for the media file */
      storageUri: string;
      /**
       * Format: int64
       ...
       */
      durationMs?: number;
      /** @description Tool ID that originated this artifact */
      originToolId?: string;
    ...
    MediaArtifact: {
      ...
      artifactId: string;
      /** @description Tenant ID that owns this artifact */
      tenantId: string;
      /** @description Agent ID that created or owns this artifact */
      agentId: string;
      /** @description MIME type (e.g., audio/wav, video/mp4, image/jpeg) */
    ...
    StorageProfile: {
      ...
      type:
        ...
        | "HDFS"
        | "LOCAL";
      /** @description Storage URI (redacted in responses unless authorized) */
      storageUri?: string;
      /** @description Access keys (write-only, never returned in GET) */
      accessKeys?: Record<string, never>;
      /**
    ...
    Connector: {
      ...
      residencyPolicy?: string;
      /** @description Sync schedule expression */
      schedule?: string;
      /** @description Destination collection for synced data */
      targetCollection?: string;
      /**
    ...
    ConnectorSchemaPreview: {
      connectorId?: string;
      /** @description Inferred schema as JSON object */
...
export interface operations {
  ...
  apiV1EntitiesCollectionExportPost: {
    parameters: {
      query?: {
        /**
         * @deprecated
  ...
  apiV1MediaArtifactsGet: {
    parameters: {
      query?: {
        /** @description Filter by agent ID */
        agentId?: string;
        /** @description Filter by media type (e.g., audio/*, video/*, image/*) */
        mediaType?: string;
    ...
    requestBody?: never;
    responses: {
      /** @description List of media artifacts */
      200: {
        headers: {
          [name: string]: unknown;
        };
        content: {
          "application/json": {
            items?: components["schemas"]["MediaArtifact"][];
            count?: number;
          };
        };
      };
  ...
  apiV1MediaArtifactsPost: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["MediaArtifactCreateRequest"];
      };
    };
    responses: {
      /** @description Media artifact registered successfully */
      201: {
        headers: {
          [name: string]: unknown;
        };
  ...
  apiV1MediaArtifactsArtifactIdGet: {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    requestBody?: never;
    responses: {
      /** @description Media artifact details */
      200: {
        headers: {
          [name: string]: unknown;
        };
  ...
  apiV1MediaArtifactsArtifactIdDelete: {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    requestBody?: never;
    responses: {
      /** @description Media artifact deleted successfully */
      204: {
        headers: {
          [name: string]: unknown;
        };
  ...
  apiV1MediaArtifactsArtifactIdTranscribePost: {
    parameters: {
      query?: never;
      header?: never;
      path: {
  ...
  apiV1MediaArtifactsArtifactIdAnalyzePost: {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    requestBody?: {
      content: {
        "application/json": {
          /**
           * @description Type of vision analysis (e.g., OBJECT_DETECTION, CLASSIFICATION, SEGMENTATION)
    ...
    responses: {
      /** @description Vision analysis job queued */
      202: {
        headers: {
          [name: string]: unknown;
        };
  ...
  apiV1ConnectorsConnectionIdPut: {
    parameters: {
      query?: {
        /**
         * @deprecated
  ...
  apiV1ConnectorsConnectionIdDelete: {
    parameters: {
      query?: {
        /**
         * @deprecated
  ...
  apiV1StorageProfilesGet: {
    ...
    requestBody?: never;
    responses: {
      /** @description Storage profile list. */
      200: {
        headers: {
          [name: string]: unknown;
        };
  ...
  apiV1StorageProfilesProfileIdGet: {
    parameters: {
      query?: {
        /**
         * @deprecated
    ...
    requestBody?: never;
    responses: {
      /** @description Storage profile details. */
      200: {
        headers: {
          [name: string]: unknown;
        };
  ...
  apiV1StorageProfilesProfileIdPut: {
    parameters: {
      query?: {
        /**
         * @deprecated
    ...
    responses: {
      /** @description Storage profile updated. */
      200: {
        headers: {
          [name: string]: unknown;
        };
  ...
  apiV1StorageProfilesProfileIdDelete: {
    parameters: {
      query?: {
        /**
         * @deprecated
    ...
    requestBody?: never;
    responses: {
      /** @description Storage profile deleted. */
      204: {
        headers: {
          [name: string]: unknown;
        };
  ...
  apiV1StorageProfilesProfileIdMetricsGet: {
    parameters: {
      query?: {
        /**
         * @deprecated
    ...
    requestBody?: never;
    responses: {
      /** @description Storage profile metrics. */
      200: {
        headers: {
          [name: string]: unknown;
        };
        content: {
          "application/json": components["schemas"]["StorageProfileMetrics"];
        };
      };
      404: components["responses"]["NotFound"];
    };

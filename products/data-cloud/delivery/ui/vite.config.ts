...
const workspaceAliases = {
  ...
  "@ghatana/canvas/hybrid": path.resolve(
    __dirname,
    "../../../../platform/typescript/canvas/src/hybrid/index.ts",
  ),
  // DC-UX-050: add missing topology alias that was causing dev-console module resolution warnings
  "@ghatana/canvas/topology": path.resolve(
    __dirname,
    "../../../../platform/typescript/canvas/src/topology/index.ts",
  ),
  ...
  "@ghatana/domain-components/voice": path.resolve(
    __dirname,
    "../../../../platform/typescript/domain-components/src/voice/index.ts",
  ),
  "@ghatana/domain-components/nlp": path.resolve(
    __dirname,

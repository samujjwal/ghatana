...
export default [
          ...
          patterns: [
            {
              ...
              message:
                "Do not import launcher internals from the UI. Use generated API clients (lib/api/*) instead.",
            },
            {
              // Data Cloud backend planes (action, intelligence, data, event, governance)
              group: ["**/planes/**", "*/planes/**"],
              message:
                "Do not import Data Cloud plane internals from the UI. Use generated API clients (lib/api/*) instead.",
            },
            {
              // Extension plugins (postgres, kafka, etc.)
              group: ["**/extensions/plugins/**", "*/extensions/plugins/**"],
              message:
                "Do not import extension plugin code from the UI. Use generated API clients (lib/api/*) instead.",
            },
            {
              // Build outputs that should not be directly referenced
              group: ["**/build/generated/**"],
              message:
                "Do not import from build/generated directly. Use the generated SDK package instead.",
            },
          ],
        },
      ],
  ...
  // ─── TypeScript files — relax no-unused-vars (tsc handles it) ────────────
  {
    ...
    rules: {
      ...
      "no-undef": "off", // TypeScript resolves ambient and type-only names

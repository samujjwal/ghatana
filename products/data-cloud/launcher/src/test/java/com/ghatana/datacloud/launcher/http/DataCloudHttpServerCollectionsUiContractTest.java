 ...
 * @doc.pattern Test
 */
@DisplayName("DataCloudHttpServer – Collections UI Contract [GH-90000]")
class DataCloudHttpServerCollectionsUiContractTest extends DataCloudHttpServerTestBase {
    ...
    void setUp() throws Exception { // GH-90000
        ...
        ordersCollection = collectionEntity( // GH-90000
                ...
                42,
                "active",
                Instant.parse("2026-04-17T08:00:00Z [GH-90000]"),
                Instant.parse("2026-04-17T09:00:00Z [GH-90000]"));
        customersCollection = collectionEntity( // GH-90000
                ...
                12,
                "draft",
                Instant.parse("2026-04-16T08:00:00Z [GH-90000]"),
                Instant.parse("2026-04-16T09:00:00Z [GH-90000]"));
    }
    ...
    @Nested
    @DisplayName("GET /api/v1/entities/dc_collections [GH-90000]")
    class ListCollectionsTests {

        @Test
        @DisplayName("returns backend entity list shape expected by collectionsApi.list [GH-90000]")
        void returnsBackendEntityListShapeExpectedByCollectionsApi() throws Exception { // GH-90000
            when(client.query(anyString(), eq("dc_collections [GH-90000]"), any()))
            ...
            List<?> entities = (List<?>) body.get("entities [GH-90000]");
            ...
            assertThat(firstEntity) // GH-90000
                    ...
                    .containsKey("data [GH-90000]")
                    .containsEntry("createdAt", "2026-04-17T08:00:00Z") // GH-90000
                    .containsEntry("updatedAt", "2026-04-17T09:00:00Z"); // GH-90000
            @SuppressWarnings("unchecked [GH-90000]")
            Map<String, Object> firstEntityData = (Map<String, Object>) firstEntity.get("data [GH-90000]");
    ...
    @Nested
    @DisplayName("GET /api/v1/entities/dc_collections/:id [GH-90000]")
    class GetCollectionTests {

        @Test
        @DisplayName("returns backend entity detail shape expected by collectionsApi.get [GH-90000]")
        void returnsBackendEntityDetailShapeExpectedByCollectionsApi() throws Exception { // GH-90000
            when(client.findById(anyString(), eq("dc_collections [GH-90000]"), eq("orders [GH-90000]")))
            ...
            assertThat(body) // GH-90000
                    ...
                    .containsEntry("updatedAt", "2026-04-17T09:00:00Z"); // GH-90000
            @SuppressWarnings("unchecked [GH-90000]")
            Map<String, Object> entityData = (Map<String, Object>) body.get("data [GH-90000]");

    ...
    <View style={styles.container}>
      ...
      {expanded && (
        <View style={styles.actionsGrid}>
          <TouchableOpacity style={styles.actionItem} onPress={onBrowseModules}>
          ...
          <TouchableOpacity style={styles.actionItem} onPress={onViewEnrollments}>
          ...
          <TouchableOpacity style={styles.actionItem} onPress={onViewAchievements}>

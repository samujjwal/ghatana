...
export const fallingObjectsVacuumSim: SimulationManifest = {
    ...
    description: 'Drop objects of different masses in a vacuum or with adjustable air resistance to explore gravity and free fall.',
    domain: 'physics',
    version: 1,
    status: 'published',
...
export const projectileMotionSim: SimulationManifest = {
    ...
    description: 'Launch projectiles at different angles and velocities to understand parabolic motion.',
    domain: 'physics',
    version: 1,
    status: 'published',
...
export const enzymeKineticsSim: SimulationManifest = {
    ...
    description: 'Explore Michaelis-Menten kinetics and different types of enzyme inhibition using Lineweaver-Burk plots.',
    domain: 'chemistry',
    version: 1,
    status: 'published',
    ...
    tags: ['biochemistry', 'enzymes', 'inhibition', 'kinetics', 'lineweaver-burk'],
};
...
export const mitosisStagesSim: SimulationManifest = {
    ...
    description: 'Interactive drag-and-drop activity to sequence the stages of mitosis.',
    domain: 'biology',
    version: 1,
    status: 'published',
...
export const sortingVisualizerSim: SimulationManifest = {
    ...
    description: 'Step through sorting algorithms to understand how they work and compare their efficiency.',
    domain: 'cs',
    version: 1,
    status: 'published',
    ...
    entities: [
        {
            ...
            visual: { shape: 'rectangle', color: '#3b82f6', size: { width: 50, height: 100 } },
        },
        {
            id: 'bar-1',
            type: 'bar',
            ...
            visual: { shape: 'rectangle', color: '#3b82f6', size: { width: 50, height: 40 } },
        },
        {
            id: 'bar-2',
            type: 'bar',
            ...
            visual: { shape: 'rectangle', color: '#3b82f6', size: { width: 50, height: 160 } },
        },
        {
            id: 'bar-3',
            type: 'bar',
            ...
            visual: { shape: 'rectangle', color: '#3b82f6', size: { width: 50, height: 20 } },
        },
        {
            id: 'bar-4',
            type: 'bar',
            ...
            visual: { shape: 'rectangle', color: '#3b82f6', size: { width: 50, height: 180 } },
        },
    ],
    ...
    entities: [
        {
            ...
            properties: {},
            visual: { shape: 'circle', color: '#6b7280', size: { width: 20, height: 20 } },
        },
        {
            id: 'bob',
            type: 'pendulum_bob',
            ...
            visual: { shape: 'circle', color: '#8b5cf6', size: { width: 40, height: 40 } },
        },
    ],
...
export const allSimulationManifests: SimulationManifest[] = [
...
export const publishedSimulations = allSimulationManifests.filter(s => s.status === 'published');
export const draftSimulations = allSimulationManifests.filter(s => s.status === 'draft');
...
export const entityTemplates: EntityTemplate[] = [
    // Physics entities
    {
        ...
        visual: { shape: 'circle', color: '#3b82f6', size: { width: 40, height: 40 } },
    ...
    },
    {
        ...
        visual: { shape: 'rectangle', color: '#4b5563', size: { width: 100, height: 20 } },
    ...
    },
    {
        ...
        visual: { shape: 'circle', color: '#f97316', size: { width: 30, height: 30 } },
    ...
    },
    {
        ...
        visual: { shape: 'sprite', color: '#22c55e', size: { width: 80, height: 20 } },
    ...
    // Chemistry entities
    {
        ...
        visual: { shape: 'circle', color: '#6366f1', size: { width: 30, height: 30 } },
    ...
    },
    {
        ...
        visual: { shape: 'sprite', color: '#8b5cf6', size: { width: 60, height: 60 } },
    ...
    },
    {
        ...
        visual: { shape: 'rectangle', color: '#374151', size: { width: 150, height: 200 } },
    ...
    // Biology entities
    {
        ...
        visual: { shape: 'circle', color: '#ec4899', size: { width: 80, height: 80 } },
    ...
    },
    {
        ...
        visual: { shape: 'sprite', color: '#a855f7', size: { width: 20, height: 40 } },
    ...
    // CS entities
    {
        ...
        visual: { shape: 'rectangle', color: '#3b82f6', size: { width: 40, height: 100 } },
    ...
    },
    {
        ...
        visual: { shape: 'circle', color: '#10b981', size: { width: 50, height: 50 } },
    ...
    // UI entities
    {
        ...
        visual: { shape: 'rectangle', color: '#8b5cf6', size: { width: 120, height: 80 } },
    ...
    },
    {
        ...
        visual: { shape: 'rectangle', color: '#374151', size: { width: 150, height: 100 } },
    ...
    },
    {
        ...
        visual: { shape: 'circle', color: '#22c55e', size: { width: 60, height: 60 } },
    ...
    },
    {
        ...
        visual: { shape: 'rectangle', color: '#1f2937', size: { width: 300, height: 200 } },
    ...
    // General
    {
        ...
        visual: { shape: 'rectangle', color: 'transparent', size: { width: 100, height: 30 } },
    ...
    },
    {
        ...
        visual: { shape: 'rectangle', color: '#f59e0b', size: { width: 80, height: 40 } },

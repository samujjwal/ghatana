...
export const physicsFreeFallLU: LearningUnit = {
  ...
  intent: {
    problem:
      "Students believe heavier objects fall faster than lighter objects, even in a vacuum",
    motivation:
      "Critical for understanding gravity, free fall, and Galilean physics principles",
  ...
  evidence: [
    {
      ...
      description:
        "Compare predicted vs actual fall behavior to assess prediction accuracy",
      observables: [
        {
          name: "predicted_object",
          type: "enum",
          enumValues: ["bowling_ball", "feather", "same_time"],
        },
    ...
    },
    {
      ...
      description:
        "Ability to manipulate air resistance to achieve synchronized falling",
      observables: [
    ...
    },
    {
      ...
      observables: [
        ...
        { name: "word_count", type: "number" },
        {
          ...
          type: "enum",
          enumValues: ["force", "gravity", "acceleration", "mass"],
        },
      ],
    },
  ],
  ...
  tasks: [
    {
      ...
      evidenceRef: "E1",
      prompt:
        "A bowling ball (5kg) and a feather (0.01kg) are dropped from the same height in a VACUUM. Which hits the ground first?",
    ...
    },
    {
      ...
      prompt:
        "Adjust the air resistance slider until BOTH objects fall at the same rate.",
    ...
    },
    {
      ...
      evidenceRef: "E3",
      prompt:
        'Was your T1 prediction correct? Explain WHY mass does not affect fall rate in a vacuum. Use the words "force", "gravity", and "acceleration" in your answer.',
      minWords: 50,
      ...
      conditions: [
        {
          ...
          threshold: 2,
          description: "2+ high confidence wrong answers",
        },
      ],
    },
  },
  ...
  credential: {
    skillTags: [
      "physics.gravity",
      "physics.forces",
      "misconception.mass_affects_fall",
    ],
...
export const physicsProjectileMotionLU: LearningUnit = {
  ...
  intent: {
    problem:
      "Students believe projectile motion follows a V-shaped or linear path instead of a parabola",
    motivation:
      "Understanding parabolic motion is essential for physics, engineering, and sports science",
  ...
  evidence: [
    {
      ...
      type: "prediction_vs_outcome",
      description:
        "Compare predicted trajectory shape vs actual simulated path",
      observables: [
        {
          name: "predicted_shape",
          type: "enum",
          enumValues: ["parabola", "straight_line", "v_shape", "other"],
        },
        { name: "confidence_level", type: "number", unit: "1-3" },
        { name: "prediction_correct", type: "boolean" },
      ],
  ...
  tasks: [
    {
      ...
      evidenceRef: "E1",
      prompt:
        "A ball is launched at 45° angle. What shape will its path trace in the air?",
      confidenceRequired: true,
      options: [
        "Parabola (curved arc)",
        "Straight diagonal line",
        "V-shape (up then down)",
        "Horizontal line",
      ],
    ...
    },
    {
      ...
      evidenceRef: "E2",
      prompt:
        "Explain why a projectile follows a curved (parabolic) path. Mention what happens to horizontal and vertical motion separately.",
      minWords: 60,
...
export const chemistryEnzymeInhibitionLU: LearningUnit = {
  ...
  intent: {
    problem:
      "Students confuse competitive and non-competitive enzyme inhibition mechanisms",
    motivation:
      "Critical for understanding drug design, metabolism, and biochemical regulation",
    targetMisconceptions: [
      "inhibition_type_confusion",
      "km_vmax_misunderstanding",
    ],
  },
  ...
  evidence: [
    {
      ...
      observables: [
        {
          name: "predicted_inhibition_type",
          type: "enum",
          enumValues: [
            "competitive",
            "non_competitive",
  ...
  tasks: [
    {
      ...
      evidenceRef: "E1",
      prompt:
        "Given this Lineweaver-Burk plot showing: same y-intercept (1/Vmax) but different x-intercept (-1/Km). What type of inhibition is this?",
      confidenceRequired: true,
      options: [
    ...
    },
    {
      ...
      prompt:
        "Adjust the inhibitor concentration and type to match the target Lineweaver-Burk plot",
    ...
    },
    {
      ...
      evidenceRef: "E2",
      prompt:
        "Explain the molecular difference between competitive and non-competitive inhibition. Include where each inhibitor binds and how it affects Km and Vmax.",
      minWords: 80,
  ...
  assessment: {
    ...
    vivaTrigger: {
      conditions: [
        ...
        {
          type: "speed_anomaly",
          description: "Completed graph analysis too quickly",
        },
      ],
    },
  },
...
export const biologyMitosisLU: LearningUnit = {
  ...
  intent: {
    problem:
      "Students confuse the stages of mitosis and their distinguishing characteristics",
    motivation:
      "Understanding cell division is fundamental to biology, medicine, and cancer research",
  ...
  tasks: [
    {
      ...
      evidenceRef: "E1",
      prompt:
        "Look at this cell image. Chromosomes are lined up at the center of the cell. What stage is this?",
      confidenceRequired: true,
    ...
    },
    {
      ...
      prompt:
        "Drag the stages into the correct order: Prophase, Metaphase, Anaphase, Telophase",
    ...
    },
    {
      ...
      evidenceRef: "E3",
      prompt:
        "Describe what happens to chromosomes as a cell moves from Prophase through Telophase.",
      minWords: 40,
...
export const csSortingAlgorithmsLU: LearningUnit = {
  ...
  intent: {
    problem:
      "Students struggle to understand time complexity differences between sorting algorithms",
    motivation:
      "Algorithm analysis is fundamental to writing efficient software and passing technical interviews",
    targetMisconceptions: [
      "all_sorts_equal",
      "bubble_sort_efficient",
      "big_o_confusion",
    ],
  },
  ...
  tasks: [
    {
      ...
      evidenceRef: "E1",
      prompt:
        "For an array of 10,000 random elements, which algorithm will finish first?",
      confidenceRequired: true,
      options: [
        "Bubble Sort O(n²)",
    ...
    },
    {
      ...
      prompt:
        "Step through bubble sort on [5, 2, 8, 1, 9]. Click to advance each comparison and swap.",
    ...
    },
    {
      ...
      evidenceRef: "E2",
      prompt:
        "Explain why Merge Sort is faster than Bubble Sort for large arrays. Use Big-O notation in your answer.",
      minWords: 50,
    ...
    vivaTrigger: {
      conditions: [
        { type: "overconfident_wrong", threshold: 2 },
        {
          ...
          description: "Fast prediction but slow tracing",
        },
      ],
    },
  },
...
export const draftPendulumLU: LearningUnit = {
  ...
  intent: {
    ...
    motivation:
      "Understanding period independence is key for timekeeping and oscillation concepts",
      ...
      observables: [
        {
          ...
          type: "enum",
          enumValues: ["increases", "decreases", "no_change"],
        },
        { name: "confidence_level", type: "number", unit: "1-3" },
      ],
    },
  ...
  tasks: [
    {
      ...
      evidenceRef: "E1",
      prompt:
        "If you double the mass of a pendulum bob, what happens to the period?",
      confidenceRequired: true,
      options: [
        "Period increases",
        "Period decreases",
...
export const publishedLearningUnits = allLearningUnits.filter(
  (lu) => lu.status === "published",
);
export const draftLearningUnits = allLearningUnits.filter(
  (lu) => lu.status === "draft",
);

        ...
        >
          {tabs.map((tab) => (
            <button
              ...
              id={`${tab.id}-tab`}
              className={`px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border-b-2 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 whitespace-nowrap ${activeTab === tab.id

...
| @ghatana/tutorputor-simulation-engine  | libs/simulation-engine              | Unified simulation engine             | typecheck, test                         | FAIL                                                        |
| @ghatana/tutorputor-sim-renderer       | libs/sim-renderer                   | Renderer library                      | type-check, build                       | FAIL                                                        |
| @ghatana/tutorputor-ai-proxy           | libs/tutorputor-ai-proxy        | AI proxy API                          | type-check, build, test                 | FAIL                                                        |
| @ghatana/tutorputor-db                 | libs/tutorputor-db              | Prisma schema/migrations              | type-check, prisma:migrate:deploy, test | PARTIAL (type-check PASS, migrate FAIL in env)              |
| @ghatana/tutorputor-domain-loader      | tools/tutorputor-domain-loader   | Domain/template loading               | typecheck, build, test                  | FAIL                                                        |
...
| @ghatana/tutorputor-sim-sdk            | libs/tutorputor-sim-sdk         | SDK                                   | lint, build, test                       | FAIL                                                        |
...
| content-explorer               | services/content-explorer               | JVM app module                      | UNVERIFIED                                                       |

## Shared TS workspace packages used by Tutorputor

| Shared package    | Consumed by                                                              |
| ----------------- | ------------------------------------------------------------------------ |
| @ghatana/api      | libs/simulation-engine          |

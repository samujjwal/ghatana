...
export function createCredential(dto: IssueCredentialDTO): Credential {
    ...
    return {
        ...
        metadata: {
            ...
            ...(typeof dto.metadata.points === "number" ? { points: dto.metadata.points } : {}),
            ...
            ...(dto.metadata.customData ? { customData: dto.metadata.customData } : {}),
        },
        ...(dto.achievement ? {
            achievement: {
                ...(dto.achievement.simulationId ? { simulationId: dto.achievement.simulationId } : {}),
                ...(dto.achievement.simulationName ? { simulationName: dto.achievement.simulationName } : {}),
                ...(dto.achievement.domainPackId ? { domainPackId: dto.achievement.domainPackId } : {}),
                ...(typeof dto.achievement.score === "number" ? { score: dto.achievement.score } : {}),
                ...(typeof dto.achievement.maxScore === "number" ? { maxScore: dto.achievement.maxScore } : {}),
                ...(typeof dto.achievement.completionTime === "number" ? { completionTime: dto.achievement.completionTime } : {}),
                ...(typeof dto.achievement.attempts === "number" ? { attempts: dto.achievement.attempts } : {}),
        ...
        ...(dto.skill ? {
            skill: {
                ...
                ...(dto.skill.subDomain ? { subDomain: dto.skill.subDomain } : {}),
                endorsements: [],
                assessmentResults: [],
            },
        } : {}),
        ...(dto.certificate ? {
            certificate: {
                ...(dto.certificate.courseId ? { courseId: dto.certificate.courseId } : {}),
                ...(dto.certificate.courseName ? { courseName: dto.certificate.courseName } : {}),
                ...(dto.certificate.curriculum ? { curriculum: dto.certificate.curriculum } : {}),
                ...
                ...(dto.certificate.grade ? { grade: dto.certificate.grade } : {}),
                ...(typeof dto.certificate.hoursCompleted === "number" ? { hoursCompleted: dto.certificate.hoursCompleted } : {}),
            },
        } : {}),
        issuer: {

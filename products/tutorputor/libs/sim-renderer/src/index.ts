...
// Type guards
export {
    isDiscreteNodeEntity,
    isDiscreteEdgeEntity,
    isDiscretePointerEntity,
    isPhysicsBodyEntity,
    isPhysicsSpringEntity,
    isPhysicsVectorEntity,
    isPhysicsParticleEntity,
    isChemAtomEntity,
    isChemBondEntity,
    isChemMoleculeEntity,
    isChemReactionArrowEntity,
    isChemEnergyProfileEntity,
    isBioCellEntity,
    isBioOrganelleEntity,
    isBioCompartmentEntity,
    isBioEnzymeEntity,
    isBioSignalEntity,
    isBioGeneEntity,
    isMedCompartmentEntity,
    isMedDoseEntity,
    isMedInfectionAgentEntity,
} from "./types";

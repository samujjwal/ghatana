...
import { simulationEntitiesAtom, simulationPhysicsConfigAtom, simulationSelectionAtom, simulationPreviewModeAtom, selectedEntityAtom, canUndoAtom, canRedoAtom, historyStatusAtom, undoAtom, redoAtom, addEntityAtom, updateEntityAtom, deleteEntityAtom, clearAllEntitiesAtom, loadEntitiesAtom, } from '../state/atoms';
...
export function useSimulation() {
    ...
    // Add entity action
    const addEntity = useCallback((type, x, y) => {
    ...
    const loadManifest = useCallback((manifest) => {
        dispatchLoadEntities({
 ...
 * @doc.pattern Hook
 */
export function useSimulationKeyboardShortcuts() {
...
//# sourceMappingURL=useSimulation.js.map
 ...
 * @doc.pattern State
 */
export const simulationEntitiesAtom = atom([]);
/**
 * @doc.type atom
 ...
 * @doc.pattern State
 */
export const simulationPhysicsConfigAtom = atom(DEFAULT_PHYSICS_CONFIG);
/**
 * @doc.type atom
 ...
 * @doc.pattern State
 */
export const simulationSelectionAtom = atom({
    selectedId: null,
    multiSelect: [],
    isLocked: false,
});
 ...
 * @doc.pattern State
 */
export const simulationHistoryAtom = atom([
 ...
 * @doc.pattern State
 */
export const simulationHistoryIndexAtom = atom(0);
/**
 * @doc.type atom
 ...
 * @doc.pattern State
 */
export const simulationPreviewModeAtom = atom(false);
// Derived atoms
/**
 * @doc.type atom
 ...
 * @doc.pattern Action
 */
export const addEntityAtom = atom(null, (get, set, entity) => {
    const entities = get(simulationEntitiesAtom);
 ...
 * @doc.pattern Action
 */
export const updateEntityAtom = atom(null, (get, set, update) => {
    const entities = get(simulationEntitiesAtom);
    const selection = get(simulationSelectionAtom);
    const newEntities = entities.map((e) => e.id === update.id ? { ...e, ...update.changes } : e);
    set(simulationEntitiesAtom, newEntities);
 ...
 * @doc.pattern Action
 */
export const deleteEntityAtom = atom(null, (get, set, id) => {
    const entities = get(simulationEntitiesAtom);
 ...
 * @doc.pattern Action
 */
export const loadEntitiesAtom = atom(null, (_get, set, data) => {

...
async function seedTenant() {
  ...
  await prisma.tenantSettings.upsert({
    ...
    create: {
      ...
      enabledDomainPacks: JSON.stringify(["math", "science", "tech", "engineering", "medicine", "health", "business", "management", "economics", "computer_science", "interdisciplinary"]),
...
async function seedModules() {
  ...
  const modules = [
    ...
    {
      id: "module-eng-001",
      slug: "intro-engineering",
      title: "Introduction to Engineering",
      description: "Fundamentals of engineering design and analysis",
      domain: "ENGINEERING",
      difficulty: "INTRO",
    ...
    },
    {
      ...
      description: "Core concepts of business management",
      domain: "BUSINESS",
      difficulty: "INTRO",
      estimatedTimeMinutes: 60,
    ...
    },
    {
      ...
      tags: ["economics", "markets", "supply-demand"],
      status: "PUBLISHED",
    },
    // Draft modules
    {

...
import { KONVA_CAPABILITIES, registerRenderingAdapter, } from './renderingAdapter';
/**
 * Konva rendering adapter for physics entities
 */
export class KonvaRenderingAdapter {
    backend = 'konva';
...
//# sourceMappingURL=konvaAdapter.js.map
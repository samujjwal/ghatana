...
export type SimulationId = string & {
    readonly __simulationId: unique symbol;
};
export type SimEntityId = string & {
    readonly __simEntityId: unique symbol;
};
export type SimStepId = string & {
    readonly __simStepId: unique symbol;
};
 ...
 */
export type EasingFunction = "linear" | "easeIn" | "easeOut" | "easeInOut" | "easeInQuad" | "easeOutQuad" | "easeInOutQuad" | "easeInCubic" | "easeOutCubic" | "easeInOutCubic" | "easeInElastic" | "easeOutElastic" | "easeInBounce" | "easeOutBounce" | "spring";
/**
 ...
 */
export type SimEntity = SimEntityBase | DiscreteNodeEntity | DiscreteEdgeEntity | DiscretePointerEntity | PhysicsBodyEntity | PhysicsSpringEntity | PhysicsVectorEntity | PhysicsParticleEntity | EconStockEntity | EconFlowEntity | EconAgentEntity | ChemAtomEntity | ChemBondEntity | ChemMoleculeEntity | ChemReactionArrowEntity | ChemEnergyProfileEntity | BioCellEntity | BioOrganelleEntity | BioCompartmentEntity | BioEnzymeEntity | BioSignalEntity | BioGeneEntity | MedCompartmentEntity | MedDoseEntity | MedInfectionAgentEntity;
/**
 ...
 */
export type SimAction = CreateEntityAction | RemoveEntityAction | MoveEntityAction | HighlightAction | CompareAction | SwapAction | SetValueAction | AnnotateAction | SetInitialVelocityAction | ApplyForceAction | ConnectSpringAction | ReleaseAction | SetGravityAction | UpdateFlowRateAction | SetStockValueAction | SpawnAgentAction | DisplayChartAction | CreateBondAction | BreakBondAction | RearrangeAction | HighlightAtomsAction | SetReactionConditionsAction | DisplayFormulaAction | ShowEnergyProfileAction | DiffuseAction | TransportAction | TranscribeAction | TranslateAction | MetaboliseAction | GrowDivideAction | AbsorbAction | EliminateAction | SpreadDiseaseAction | SignalAction;
...
export type DomainMetadata = {
    ...
    domain: "CHEMISTRY";
    chemistry: ChemistryMetadata;
} | {
    domain: "BIOLOGY";
    biology: BiologyMetadata;
} | {
    domain: "MEDICINE";
 ...
 */
export type IntentType = "add_entity" | "remove_entity" | "modify_entity" | "add_step" | "remove_step" | "modify_step" | "change_speed" | "change_visual" | "add_annotation" | "change_domain_config" | "explain" | "clarify" | "undo" | "redo" | "unknown";
/**

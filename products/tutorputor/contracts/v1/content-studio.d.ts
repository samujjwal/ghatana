 ...
 */
import type { Claim, Evidence, TaskType } from "./learning-unit";
...
export type AIOperation = 'generate_claims' | 'generate_evidence' | 'generate_tasks' | 'adapt_grade' | 'enhance_accessibility' | 'validate_alignment' | 'suggest_improvements';
/**
...
//# sourceMappingURL=content-studio.d.ts.map
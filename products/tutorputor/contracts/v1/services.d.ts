import type { DashboardSummary, ModuleSummary, ModuleDetail, Enrollment, TutorResponsePayload, TenantId, UserId, ModuleId, EnrollmentId, Assessment, AssessmentSummary, AssessmentId, AssessmentAttempt, AssessmentAttemptId, AssessmentGenerationInput, AssessmentGenerationResult, ModuleDraftInput, ModuleDraftPatch, AnalyticsSummary, AdvancedAnalyticsSummary, StudentRiskIndicator, ModuleDifficultyHeatmap, UsageAnalytics, LearningEventInput, MarketplaceListing, MarketplaceListingId, LearningPath, LearningPathRecommendation, PathwayConstraints, Classroom, ClassroomId, TeacherDashboardSummary, ClassroomProgress, Thread, ThreadId, ThreadStatus, Post, PostId, UserRole, SimulationLaunchToken, CheckoutSession, CheckoutSessionId, Purchase, LTIValidationResult, LTIDeepLinkingContent, SimulationTemplate, SimulationTemplateInput, SimulationTemplateUpdate, SimulationTemplateStatus } from "./types";
import type { ParsedIntent } from "./simulation/types";
export interface ContentService {
    getModuleBySlug(tenantId: TenantId, slug: string, userId?: UserId): Promise<{
        module: ModuleDetail;
...
export interface LearningService {
    ...
    enrollInModule(tenantId: TenantId, userId: UserId, moduleId: ModuleId): Promise<Enrollment>;
    updateProgress(args: {
        tenantId: TenantId;
...
export interface AssessmentService {
    ...
    generateAssessmentItems(args: AssessmentGenerationInput & {
        userId: UserId;
...
import type { IdentityProviderConfig, SsoUserLink, SsoLoginRequest, SsoLoginResult, RoleMappingConfig, PaginatedResult, PaginationArgs, UserSummary } from "./types";
/**
...
export interface SsoService {
    ...
    }): Promise<PaginatedResult<SsoUserLink & {
        user: UserSummary;
    }>>;
    /**
...
import type { DataExportRequest, DataDeletionRequest, AuditEvent, DateRange } from "./types";
/**
...
import type { StudyGroup, StudyGroupVisibility, StudyGroupMember, StudyGroupRole, StudyGroupJoinRequest, StudyGroupInvite, StudySession, StudySessionType, SessionRsvp, Forum, ForumScope, ForumTopic, ForumPost, ReactionType, TutorProfile, TutoringRequest, TutoringSession, TutoringReview, ChatRoom, ChatMessage, SharedNote, SocialActivity, SocialNotification } from "./social";
/**
...
import type { VRLab, VRLabId, VRScene, VRSceneId, VRSession, VRSessionId, VRSessionStatus, VRAsset, VRAssetId, VRLabAnalytics, VRMultiplayerSession, VRInteractable, VRLabObjective, VRDeviceType, VRInteractionLog, VRPerformanceMetrics, CreateVRLabRequest, UpdateVRLabRequest, CreateVRSceneRequest, StartVRSessionRequest, UpdateVRSessionRequest, VRLabListParams } from './vr-labs';
/**
...
import type { SubscriptionId, PaymentMethodId, InvoiceId, TransactionId, SubscriptionPlan, Subscription, BillingInterval, PaymentMethod, PaymentMethodType, BillingAddress, Invoice, PaymentTransaction, SubscriptionUsage, SubscriptionChangePreview, PaymentWebhookEvent } from "./types";
/**
 * @doc.type interface
...
import type { LtiPlatformId, LtiContextId, LtiPlatform, LtiLaunchContext, LtiUserClaims, LtiDeepLinkingRequest, LtiContentItem, LtiScore, LtiMember, LtiSession, LtiGradePassbackResult, LtiLineItem } from "./types";
/**
 * @doc.type interface

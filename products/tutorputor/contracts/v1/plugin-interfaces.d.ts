...
export type PluginType = 'ingestor' | 'evidence_processor' | 'authoring_tool' | 'asset_provider' | 'notifier';
...
export interface EvidenceProcessor {
     ...
     */
    process(context: ProcessingContext, evidence: EvidenceEvent): Promise<ProcessingResult>;
    /**
...
export type Plugin = EvidenceProcessor | Ingestor | AssetProvider | AuthoringTool | Notifier;

...
export type ModuleId = string & {
    readonly __moduleId: unique symbol;
};
export type EnrollmentId = string & {
    readonly __enrollmentId: unique symbol;
};
export type AssessmentId = string & {
    readonly __assessmentId: unique symbol;
};
export type AssessmentItemId = string & {
    readonly __assessmentItemId: unique symbol;
};
export type AssessmentAttemptId = string & {
    readonly __assessmentAttemptId: unique symbol;
};
export type ModuleRevisionId = string & {
    readonly __moduleRevisionId: unique symbol;
};
export type MarketplaceListingId = string & {
    readonly __marketplaceListingId: unique symbol;
};
...
export type ContentBlockType = "text" | "rich_text" | "interactive_visualization" | "video" | "image" | "simulation" | "vr_simulation" | "example" | "exercise" | "assessment_item_ref" | "ai_tutor_prompt";
/**
...
export type SimulationDomain = "CS_DISCRETE" | "PHYSICS" | "ECONOMICS" | "CHEMISTRY" | "BIOLOGY" | "MEDICINE" | "ENGINEERING" | "MATHEMATICS";
export type SimulationTemplateStatus = "DRAFT" | "PUBLISHED" | "ARCHIVED";
export type SimulationTemplateDifficulty = "BEGINNER" | "INTERMEDIATE" | "ADVANCED" | "EXPERT";
export type SimulationTemplateLicense = "FREE" | "CC_BY" | "CC_BY_SA" | "CC_BY_NC" | "PROPRIETARY";
...
export type AssessmentItemType = "multiple_choice_single" | "multiple_choice_multi" | "short_answer" | "code" | "free_response";
...
export type AssessmentAttemptStatus = "IN_PROGRESS" | "SUBMITTED" | "GRADED" | "EXPIRED";
...
export declare const ASSESSMENT_NOT_IMPLEMENTED_CODE: "ASSESSMENT_NOT_IMPLEMENTED";
export type LearningEventType = "module_viewed" | "module_completed" | "assessment_started" | "assessment_completed" | "ai_tutor_message";
...
export type LearningPathId = string & {
    readonly __learningPathId: unique symbol;
};
export type LearningPathNodeId = string & {
    readonly __learningPathNodeId: unique symbol;
};
...
export type ClassroomId = string & {
    readonly __classroomId: unique symbol;
};
...
export type ThreadId = string & {
    readonly __threadId: unique symbol;
};
export type PostId = string & {
    readonly __postId: unique symbol;
};
export type HelpRequestId = string & {
    readonly __helpRequestId: unique symbol;
};
...
export type BadgeId = string & {
    readonly __badgeId: unique symbol;
};
...
export type CheckoutSessionId = string & {
    readonly __checkoutSessionId: unique symbol;
};
export type PurchaseId = string & {
    readonly __purchaseId: unique symbol;
};
 ...
 */
export type OfflineMutationType = "progress_update" | "assessment_attempt" | "ai_tutor_query" | "learning_event" | "thread_post" | "reaction";
/**
 ...
 * SSO error codes.
 */
export type SsoErrorCode = "provider_not_found" | "provider_disabled" | "domain_not_allowed" | "token_verification_failed" | "user_provisioning_failed" | "link_already_exists" | "configuration_error" | "network_error";
/**
 ...
 * Audit event actions.
 */
export type AuditAction = "data_export_requested" | "data_export_completed" | "data_deletion_requested" | "data_deletion_completed" | "sso_config_created" | "sso_config_updated" | "sso_config_deleted" | "role_assigned" | "role_revoked" | "user_login" | "user_logout" | "tenant_settings_updated";
/**
...
export type StudyGroupId = string & {
    readonly __studyGroupId: unique symbol;
};
/**
...
export type SubscriptionId = string & {
    readonly __subscriptionId: unique symbol;
};
export type PaymentMethodId = string & {
    readonly __paymentMethodId: unique symbol;
};
export type InvoiceId = string & {
    readonly __invoiceId: unique symbol;
};
export type TransactionId = string & {
    readonly __transactionId: unique symbol;
};
/**
 ...
 * Subscription status.
 */
export type SubscriptionStatus = "active" | "trialing" | "past_due" | "canceled" | "paused" | "incomplete" | "incomplete_expired";
/**
 * Payment method type.
 */
...
export interface PaymentWebhookEvent {
    id: string;
    type: "subscription.created" | "subscription.updated" | "subscription.deleted" | "invoice.created" | "invoice.paid" | "invoice.payment_failed" | "payment_method.attached" | "payment_method.detached" | "customer.subscription.trial_will_end";
    data: Record<string, unknown>;
    stripeEventId: string;
    processedAt?: string;
    createdAt: string;
}
export type LtiPlatformId = string & {
    readonly __ltiPlatformId: unique symbol;
};
export type LtiDeploymentId = string & {
    readonly __ltiDeploymentId: unique symbol;
};
export type LtiContextId = string & {
    readonly __ltiContextId: unique symbol;
};
export type LtiResourceLinkId = string & {
    readonly __ltiResourceLinkId: unique symbol;
};
/**
 ...
 * LTI 1.3 roles.
 */
export type LtiRole = "http://purl.imsglobal.org/vocab/lis/v2/membership#Learner" | "http://purl.imsglobal.org/vocab/lis/v2/membership#Instructor" | "http://purl.imsglobal.org/vocab/lis/v2/membership#Administrator" | "http://purl.imsglobal.org/vocab/lis/v2/membership#ContentDeveloper" | "http://purl.imsglobal.org/vocab/lis/v2/membership#Mentor";
/**

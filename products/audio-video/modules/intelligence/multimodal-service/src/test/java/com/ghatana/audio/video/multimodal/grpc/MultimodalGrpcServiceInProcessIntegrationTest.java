...
class MultimodalGrpcServiceInProcessIntegrationTest {
    ...
    void analyzeVideoWithAudioOrchestratesFusion() throws Exception {
            ...
            com.ghatana.audio.video.multimodal.engine.VideoAudioResult.builder()
                ...
                .videoResult(com.ghatana.audio.video.multimodal.engine.VisualResult.builder()
                    ...
                    .frameResults(List.of(
                        com.ghatana.audio.video.multimodal.engine.FrameResult.builder()
                            .frameNumber(1)
                            .timestampMs(100)
                            .detections(List.of(
                                com.ghatana.audio.video.multimodal.engine.DetectionResult.builder()
                                    .className("person")
                                    .confidence(0.95)
                                    .build()
                            ))
        ...
        assertThat(response.getFrameAnalyses(0).getDetectionsCount()).isEqualTo(1);
        assertThat(response.getFrameAnalyses(0).getDetections(0).getClassName()).isEqualTo("person");
    }

...
class VisionModelEngineTest {
    ...
    class RealDetectorDelegation {
        ...
        void classifyFallsBackWhenCapabilityAbsent() { 
        ...
        void uninitializedDetectorUsesFallback() { 
            ...
            assertThatCode(() -> realEngine.classify(SAMPLE_IMAGE)).doesNotThrowAnyException(); 
            assertThatCode(() -> realEngine.detectFaces(SAMPLE_IMAGE)).doesNotThrowAnyException(); 
            assertThatCode(() -> realEngine.extractText(SAMPLE_IMAGE)).doesNotThrowAnyException(); 
        }
    }

 ...
 * @doc.pattern Test
 */
@DisplayName("OcrService [GH-90000]")
class OcrServiceTest {
    ...
    @Nested
    @DisplayName("extract() [GH-90000]")
    class Extract {

        @Test
        @DisplayName("returns only regions above the confidence threshold [GH-90000]")
        void extract_filtersLowConfidence() { // GH-90000
            ...
            assertThat(regions.get(0).text()).isEqualTo("Hello World [GH-90000]");
        }

        @Test
        @DisplayName("default threshold of 0.70 filters low-confidence region [GH-90000]")
        ...
        @Test
        @DisplayName("threshold of 0.0 includes all regions [GH-90000]")
    ...
    @Nested
    @DisplayName("extractText() [GH-90000]")
    class ExtractText {

        @Test
        @DisplayName("concatenates recognised text regions with newlines [GH-90000]")
        void extractText_concatenatesRegions() { // GH-90000
            ...
            assertThat(text).contains("Hello World [GH-90000]").contains("Low confidence [GH-90000]");
        }

        @Test
        @DisplayName("returns empty string for image with no regions above threshold [GH-90000]")
    ...
    @Nested
    @DisplayName("TextRegion [GH-90000]")
    class TextRegionTests {
        ...
        @Test
        @DisplayName("readingOrder < 0 throws IllegalArgumentException [GH-90000]")

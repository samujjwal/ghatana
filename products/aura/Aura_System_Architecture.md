...
- **Consent Management** — per-scope, revocable consents tracked in the database; every sensitive mutation validates consent before processing
...
- **Privacy Controls** — data minimization, retention policies, right-to-deletion workflows
...
- Consent required before any personal data processing

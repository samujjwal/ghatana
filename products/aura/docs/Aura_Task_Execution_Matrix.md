...
| `S08-T05` | Complete invite beta prep | Finalize cohort selection, support process, privacy review, counsel review of consent/notice language, trust checks, and launch checklist for the external invite cohort | feature flags, support playbooks, governance artifacts, `docs/Aura_GTM_Strategy.md`, `docs/Aura_24_Month_Strategy.md`, `docs/Aura_Data_Architecture.md` | Invite beta gate criteria are approved, consent and notice copy are signed off, and launch instrumentation is live |
...
| `S10-T04` | Perform a privacy and trust UX pass | Audit disclosures, controls, low-confidence handling, and consent/trust copy against the trust contract and counsel-reviewed notice language | `apps/web`, `packages/ui`, governance copy artifacts, `docs/Aura_UI_UX_Blueprint.md`, `docs/Aura_Consumer_Value_Operating_Model.md` | Critical trust surfaces pass content, accessibility, control, and notice-language checks |
...
| `S12-T03` | Run launch readiness review | Perform the final go/no-go review across product, trust, privacy, performance, support, and consent-policy readiness | PRD, GTM docs, strategy docs, dashboards, launch checklist artifacts, governance sign-off artifacts | All blockers are closed or explicitly waived by named owners, and launch uses approved consent/notice language |

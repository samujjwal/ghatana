...
| Product outcomes         | Labeled      | Saves, conversions, returns where available |
...
| Metric                       | Target                                              |
| ---------------------------- | --------------------------------------------------- |
| Click-through rate (CTR)     | Statistically significant lift vs. baseline         |
| Save rate                    | ≥ 5% improvement vs. previous model version         |
| Conversion lift              | Positive directional improvement                    |
| Explanation helpfulness rate | ≥ 60% of users who open explanation rate it helpful |
| Hide / dismiss rate          | No regression vs. previous model version            |

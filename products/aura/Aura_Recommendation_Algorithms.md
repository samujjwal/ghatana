...
| -------------------------- | ------------------------------------------------------------------ | ---------------------------------------------------------- |
| Recommendation CTR         | Click-through rate on recommendation cards                         | Tracked per cohort                                         |
| Save rate                  | Saves generated per recommendation served                          | Tracked per cohort                                         |
| Dismiss rate               | Dismissals indicate poor fit                                       | Alert if > 30% for any segment                             |
| Conversion rate            | Purchases per recommendation click                                 | Business metric                                            |
...
| Metric                | Rationale                                                             |
| --------------------- | --------------------------------------------------------------------- |
| Recommendation CTR    | Immediate engagement signal                                           |
| Save rate             | Strong positive intent signal                                         |
| Conversion lift       | Business outcome — purchases attributed to Aura recommendations       |

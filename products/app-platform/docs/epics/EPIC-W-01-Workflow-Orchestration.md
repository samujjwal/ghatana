...
- **New Entities:**
  - `WorkflowDefinition`: `{ workflow_id: String, version: Int, dsl: JSON, created_at: CalendarDate, status: Enum }`
  - `WorkflowInstance`: `{ instance_id: UUID, workflow_id: String, version: Int, status: Enum, started_at: CalendarDate, completed_at: CalendarDate, current_step: String, context: JSON }`
  - `HumanTask`: `{ task_id: UUID, instance_id: UUID, assignee: String, deadline: CalendarDate, status: Enum, payload: JSON }`
  ...
  - `WorkflowValueCatalogRef`: `{ catalog_key: String, version: Int, scope: Enum, effective_at: CalendarDate }`
- **Multi-Calendar Fields:** `created_at`, `started_at`, `completed_at`, `deadline` use `CalendarDate` (K-15 enriched).
...
| Payload           | `{ "instance_id": "...", "workflow_id": "client_onboarding", "version": 3, "initiator": "...", "timestamp": "2025-03-02T10:30:00Z", "calendar_date": {} }` |

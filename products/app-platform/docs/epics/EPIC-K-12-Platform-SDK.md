...
- **New Entities:** N/A
- **Multi-Calendar Fields:** The SDK exposes the `CalendarDate` type (from K-15) and helper methods for multi-calendar date operations to all domain modules.
...
| Multi-Calendar Correctness | SDK provides `CalendarDate` utilities via K-15 `CalendarClient`         |

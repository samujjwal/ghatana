...
- **New Entities:**
  - `PackMetadata`: `{ pack_id: String, type: Enum, version: String, author: String, description: String, platform_min_version: String, platform_max_version: String, dependencies: List<String>, status: Enum, certified_at: CalendarDate }`
  - `PackCertification`: `{ certification_id: UUID, pack_id: String, version: String, test_results: JSON, benchmark_results: JSON, security_scan_results: JSON, reviewer: String, approved_at: CalendarDate }`
...
- **Multi-Calendar Fields:** `certified_at`, `approved_at`, `deprecated_at` use `CalendarDate` (K-15 enriched).
...
| Payload           | `{ "pack_id": "...", "version": "...", "type": "T3", "author": "...", "certified_by": "...", "timestamp": "2025-03-02T10:30:00Z" }` |

...
- **New Entities:**
  ...
  - `ConfigPack`: `{ pack_id: String, type: Enum (GLOBAL, JURISDICTION, etc.), context_key: String, payload: JSON, effective_date: CalendarDate, status: Enum }`
  - `ResolvedConfigCache`: `{ cache_key: String, payload: JSON, expires_at: Timestamp }`
- **Multi-Calendar Fields:** `effective_date` in `ConfigPack` uses `CalendarDate` (K-15 enriched) to support jurisdiction-native date display.
...
| Payload           | `{ "pack_id": "...", "type": "JURISDICTION", "context_key": "NP", "effective_date": { "bs": "2082-11-17", "gregorian": "2026-03-01" }, "timestamp": "2026-03-01T00:00:00Z" }` |

...
> This document describes the **Capital Markets (Siddhanta)** domain pack and its Nepal-specific configuration. It is NOT a Platform Kernel (AppPlatform) specification. Generic platform architecture lives in the `epics/`, `lld/`, and `adr/` directories.

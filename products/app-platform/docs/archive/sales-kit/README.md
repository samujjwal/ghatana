...
This folder is the indexed entry point for external-facing proposal material.

It does not create a second source of truth.

The canonical content remains in the root `project-files/` documents. This index groups the approved customer-facing artifacts into one place so they can be used as a sales-ready set.
...
5. Use the tailored profile insert when the prospect fits a specific Nepal buyer profile:
...
6. Use the named-prospect customization assets when verified prospect context is available:
...
- [Mid_Sized_Merchant_Banker_Proposal_Insert.md](./Mid_Sized_Merchant_Banker_Proposal_Insert.md): tailored profile for a realistic merchant banker prospect
- [Listed_Issuer_Frequent_Corporate_Actions_Proposal_Insert.md](./Listed_Issuer_Frequent_Corporate_Actions_Proposal_Insert.md): tailored profile for a listed issuer with recurring corporate-action activity
- [Named_Prospect_Insert_Template.md](./Named_Prospect_Insert_Template.md): safe customization template for real named prospects
- [Prospect_Context_Capture_Checklist.md](./Prospect_Context_Capture_Checklist.md): checklist for collecting safe prospect-specific facts

    ...
    const rules: BusinessRuleReference[] = [
      {
        ...
        dependencies: [
          "@siddhanta/ml-models",
          "@siddhanta/financial-calculators",
        ],
        testCases: [
          {
    ...
    "AccountOpened": {
      ...
      "properties": {
        ...
        "timestamp": {
          "type": "string",
          "format": "date-time",
          "description": "UTC ISO-8601 canonical timestamp (required)"
        },
        "calendar_date": {
          "type": ["object", "null"],
          "description": "Optional CalendarDate map (K-15 enriched, e.g. {\"bs\": \"2081-11-18\"})"
        },
        "data": {
          "type": "object",
          "properties": {
...
describe("Banking Domain Rules", () => {
  describe("Credit Scoring", () => {
    test("should approve loan for excellent credit", async () => {
      ...
      const result = await evaluateRule("banking.credit.scoring", {
        applicant,
      });
  ...
  describe("Fraud Detection", () => {
    test("should flag suspicious large transaction", async () => {
      ...
      const result = await evaluateRule("banking.fraud.detection", {
        transaction,
      });
      expect(result.allow).toBe(false);

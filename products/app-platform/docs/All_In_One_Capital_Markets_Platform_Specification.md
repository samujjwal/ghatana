...
This document defines the complete, jurisdiction-agnostic architecture for a modular, regulator-grade, all-in-one capital markets platform. It is designed around two governing principles:

1. **Generic Core, Infinite Jurisdictions:** No core rewrites, ever.
2. **AI as Substrate (Principle 17):** AI/ML workflows are fully pervasive, intercepting events and overriding business logic natively at the core, not as bolt-on features. K-09 acts as the mandatory intermediary for ALL AI/ML inference. Every module, subsystem, and pack is AI-native by design.

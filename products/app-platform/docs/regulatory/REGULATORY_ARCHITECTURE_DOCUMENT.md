...
AuditRecord[N] = {
  ...
  before_state: JSON,
  after_state: JSON,
  timestamp: Timestamp,           // UTC ISO-8601 (required)
  calendar_date: CalendarDate | null, // K-15 enriched (optional)
...
deny[msg] if {
  ...
  input.order.timestamp < data.insider_lists_expiry[input.instrument.issuer_id]

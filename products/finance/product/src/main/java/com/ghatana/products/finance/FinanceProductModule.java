...
public final class FinanceProductModule implements KernelModule {
    ...
    public void initialize(KernelContext context) {
        ...
        // Initialize finance product shell
        this.productShell = new FinanceProductShell(context);

        // Initialize Backend-for-Frontend
        this.bff = new FinanceBFF(context);

        // Initialize all domain modules
        this.omsModule = new OmsDomainModule();
        ...
        this.pricingModule = new PricingDomainModule();
        this.reconciliationModule = new ReconciliationDomainModule();
        this.referenceDataModule = new ReferenceDataDomainModule();
        this.regulatoryReportingModule = new RegulatoryReportingDomainModule();
        this.sanctionsModule = new SanctionsDomainModule();
        this.surveillanceModule = new SurveillanceDomainModule();
    ...
    public HealthStatus getHealthStatus() {
        try {
            ...
            // Check all domain modules health

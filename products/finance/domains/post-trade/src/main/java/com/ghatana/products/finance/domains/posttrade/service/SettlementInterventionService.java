...
public class SettlementInterventionService {
    ...
    public Promise<String> triggerIntervention(String tradeId, double riskScore, String shapFeatures) {
        return Promise.ofBlocking(executor, () -> {
            ...
            audit.emit(AuditEvent.builder()
                    .tenantId(tradeId).eventType("INTERVENTION_TRIGGERED")
                    .resourceType("SETTLEMENT").resourceId(tradeId)
                    .detail("action", action).detail("shap", topFeature).detail("score", riskScore)
                    .build());
    ...
    public Promise<Void> recordManagerOverride(String interventionId, String managerId,
        ...
        return Promise.ofBlocking(executor, () -> {
            ...
            audit.emit(AuditEvent.builder()
                    .tenantId(managerId).eventType("MANAGER_OVERRIDE")
                    .resourceType("INTERVENTION").resourceId(interventionId)

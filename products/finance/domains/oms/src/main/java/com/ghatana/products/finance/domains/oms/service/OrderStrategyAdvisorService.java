...
public class OrderStrategyAdvisorService {
    ...
    public StrategyRecommendation recommend(String orderId, String clientId, String instrumentId,
        ...
        auditPort.emit(AuditEvent.builder()
                ...
                .resourceType("ORDER")
                .resourceId(orderId)
                .detail("strategy", rec.suggestedStrategy().name())
                .detail("confidence", rec.confidence())
                .detail("rationale", rec.shapRationale())
                .build());
    ...
    public void recordOverride(String orderId, String clientId,
        ...
        auditPort.emit(AuditEvent.builder()
                .tenantId(clientId)
                .eventType("STRATEGY_OVERRIDE")
                .resourceType("ORDER")
                .resourceId(orderId)
                .detail("recommended", recommendedStrategy)
                .detail("chosen", chosenStrategy)
                .detail("reason", overrideReason)
                .build());

...
public class ApprovalWorkflowService {
    ...
    public Promise<Order> approve(String orderId, String approverId, String notes) {
        return Promise.ofBlocking(executor, () -> {
            Order updated = lifecycleService.transition(orderId, OrderStatus.APPROVED, null).getResult();
    ...
    public Promise<Order> reject(String orderId, String approverId, String reason) {
        return Promise.ofBlocking(executor, () -> {
            Order updated = lifecycleService.transition(orderId, OrderStatus.REJECTED, reason).getResult();
            eventBusPort.publish(new ApprovalDecisionEvent(
    ...
    public Promise<List<Order>> getPendingApprovalQueue(String approverId) {
        return Promise.ofBlocking(executor, () ->
                orderStore.findPendingApproval(approverId).getResult());
    }

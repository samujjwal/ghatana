package com.ghatana.products.finance.domains.pricing.service;
...
public class PriceChallengeService {
    ...
    public Promise<Void> accept(String challengeId, String analystId) {
        return Promise.ofBlocking(executor, () -> {
            ...
            auditPort.emit(AuditEvent.builder()
                    .tenantId(analystId).eventType("PRICE_CHALLENGE_ACCEPT")
                    .resourceType("PRICE_CHALLENGE").resourceId(challengeId)
                    .detail("action", "ACCEPT").detail("reason", "Price accepted as-is")
                    .build());
    ...
    public Promise<Void> override(String challengeId, String submitterId,
        ...
        return Promise.ofBlocking(executor, () -> {
            ...
            auditPort.emit(AuditEvent.builder()
                    .tenantId(submitterId).eventType("PRICE_CHALLENGE_OVERRIDE_SUBMITTED")
                    .resourceType("PRICE_CHALLENGE").resourceId(challengeId)
                    .detail("action", "OVERRIDE_SUBMITTED").detail("reason", reason)
                    .detail("oldPrice", ch.flaggedPrice()).detail("newPrice", newPrice)
                    .build());
    ...
    public Promise<Void> approveOverride(String challengeId, String approverId) {
        return Promise.ofBlocking(executor, () -> {
            ...
            auditPort.emit(AuditEvent.builder()
                    .tenantId(approverId).eventType("PRICE_CHALLENGE_OVERRIDE_APPROVED")
                    .resourceType("PRICE_CHALLENGE").resourceId(challengeId)
                    .detail("action", "OVERRIDE_APPROVED").detail("reason", req.reason())
                    .detail("newPrice", req.newPrice())
                    .build());

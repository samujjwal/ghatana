package com.ghatana.products.finance.domains.referencedata.adapter;

import java.sql.Date;

import com.ghatana.products.finance.domains.referencedata.domain.EntityRelationship;
import com.ghatana.products.finance.domains.referencedata.domain.EntityType;
...
public class PostgresEntityStore implements EntityStore {
     ...
     */
    @Override
    public Promise<List<UUID>> findAllDescendantIds(UUID rootEntityId) {
        return Promise.ofBlocking(executor, () -> {
    ...
    private void bindEntity(PreparedStatement ps, MarketEntity e) throws SQLException {
        ...
        ps.setString(10, e.metadata() != null ? e.metadata().toString() : "{}");
    }

...
/**
 * Unit tests for ReferenceDataDomainModule.
 *
 * @doc.type test
 * @doc.purpose Verify Reference Data domain module behavior
 * @author Ghatana Finance Team
 * @since 1.0.0
 */
@DisplayName("Reference Data Domain Module Tests")
class ReferenceDataDomainModuleTest {

    private ReferenceDataDomainModule module;
    private KernelContext mockContext;

    @BeforeEach
    void setUp() {
        module = new ReferenceDataDomainModule();
    ...
    void shouldReturnCorrectModuleId() {
        assertThat(module.getModuleId()).isEqualTo("finance-reference-data");
    }

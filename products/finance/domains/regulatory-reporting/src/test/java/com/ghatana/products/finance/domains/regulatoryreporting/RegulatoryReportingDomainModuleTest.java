...
/**
 * Unit tests for RegulatoryReportingDomainModule.
 *
 * @doc.type test
 * @doc.purpose Verify Regulatory Reporting domain module behavior
 * @author Ghatana Finance Team
 * @since 1.0.0
 */
@DisplayName("Regulatory Reporting Domain Module Tests")
class RegulatoryReportingDomainModuleTest {

    private RegulatoryReportingDomainModule module;
    private KernelContext mockContext;

    @BeforeEach
    void setUp() {
        module = new RegulatoryReportingDomainModule();
    ...
    void shouldReturnCorrectModuleId() {
        assertThat(module.getModuleId()).isEqualTo("finance-regulatory-reporting");
    }

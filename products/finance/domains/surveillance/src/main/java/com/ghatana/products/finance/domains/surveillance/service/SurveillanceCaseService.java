...
public class SurveillanceCaseService {
    ...
    public Promise<SurveillanceCase> openCase(List<String> alertIds, String subjectClient,
        ...
        return Promise.ofBlocking(executor, () -> {
            ...
            auditPort.emit(AuditEvent.builder()
                    .tenantId(assignedAnalyst).eventType("CASE_OPENED")
    ...
    public Promise<SurveillanceCase> transitionCase(String caseId, CaseStatus toStatus,
        ...
        return Promise.ofBlocking(executor, () -> {
            ...
            auditPort.emit(AuditEvent.builder()
                    .tenantId(analystId).eventType("CASE_TRANSITION")
                    .resourceType("CASE").resourceId(caseId)
                    .detail("from", sc.status().name()).detail("to", toStatus.name())
                    .build());
    ...
    public Promise<SurveillanceCase> closeCase(String caseId, CaseOutcome outcome,
        ...
        return Promise.ofBlocking(executor, () -> {
            ...
            auditPort.emit(AuditEvent.builder()
                    .tenantId(analystId).eventType("CASE_CLOSED")
                    .resourceType("CASE").resourceId(caseId)
                    .detail("outcome", outcome.name())
                    .build());

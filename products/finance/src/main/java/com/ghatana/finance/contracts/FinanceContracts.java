...
public class FinanceContracts {
    ...
    public static final KernelContract FRAUD_DETECTION_AUTONOMOUS = GenericDomainContract.builder()
        ...
        .metadata(Map.ofEntries(
            Map.entry("agent_type", "fraud_detection"),
            Map.entry("agentType", "PROBABILISTIC"),
            Map.entry("autonomy_level", "MEDIUM"),
            Map.entry("human_review", "conditional"),
            Map.entry("review_criteria", "fraud_score>0.8"),
            Map.entry("ai_governed", "true"),
            Map.entry("model_approval", "required"),
            Map.entry("modelId", "fraud-risk-v1"),
            Map.entry("explainability", "true"),
            Map.entry("explanation_format", "feature_importance"),
            Map.entry("decision_logging", "true"),
            Map.entry("capabilities", "detect_fraud,assess_risk,analyze_transaction")
        ))
        .build();
    ...
    public static final KernelContract REGULATORY_REPORTING_API = GenericDomainContract.builder()
        ...
        .metadata(Map.of(
            ...
            "basePath", "/api/v1/regulatory-reports/submissions",

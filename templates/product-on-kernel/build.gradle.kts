...
dependencies {
    ...
    // api(project(":platform:shared-services:data-cloud-kernel-bridge"))
    // api(project(":platform:shared-services:aep-kernel-bridge"))
    // api(project(":platform:shared-services:yappc-kernel-bridge"))

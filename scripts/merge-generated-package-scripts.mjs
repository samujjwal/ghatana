...
const GENERIC_SCRIPTS = new Set([
  ...
  'check:gradlew-portability',
  'check:gradle-wrapper-script-usage',
  ...
  'check:phr-apps-build',
  'check:phr-backend-build',
  'check:phr-mobile-phi-storage',
  ...
  'check:phr-route-contract',
  'check:phr-route-contract-drift',
  'check:phr-mobile-dto-contract',
  'check:phr-ia-coverage',
  ...
  'plan:kernel-implementation-waves',
  'run:kernel-implementation-waves',
  'check:wave2-product-quality-scorecard',
  ...
  'check:release-profile-local-targets',
  'check:product-family-asset-registry',
  ...
  'check:data-cloud-active-module-evidence',
  'check:action-plane-boundaries',
  'check:agent-capability-duplicates',
  'check:agent-runtime-test-excludes',
  'check:evidence-run-metadata',
  ...
  'check:atomic-workflow-failure-injection',
  'check:atomic-workflow-proof',
  ...
  'check:data-cloud-release-evidence',
